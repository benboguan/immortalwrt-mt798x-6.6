...
#if defined(MT7986) || defined(MT7916) || defined(MT7981) || defined(MT7990) || defined(MT7992) || defined(MT7993)
...
/* PMKID Structures */
typedef UCHAR NDIS_802_11_PMKID_VALUE[LEN_PMKID];
#define INVALID_PMKID_IDX	-1
#define PMKID_NOT_EXIST_FOR_STA -2
...
typedef struct _AP_BSSID_INFO {
	NDIS_802_11_MAC_ADDRESS own_mac;
	NDIS_802_11_MAC_ADDRESS peer_mac;
	NDIS_802_11_PMKID_VALUE PMKID;
	UCHAR PMK[LEN_MAX_PMK];
	ULONG RefreshTime;
	BOOLEAN is_ft;
	BOOLEAN Valid;
	BOOLEAN is_mlo_connect;
	ULONG cache_period;
...
struct {
	ULONG Num;
	RT_COUNTER_TXBF Entry[0/*MAX_LEN_OF_MAC_TABLE*/];
...
typedef struct _RT_LLTD_ASSOICATION_TABLE {
	unsigned int Num;
	RT_LLTD_ASSOICATION_ENTRY Entry[0]; /* MAX_LEN_OF_MAC_TABLE */
