...
static const struct apcfg_parameters apcfg_for_peak = {
	...
	.ba_en = 1, /*HT_AutoBA*/
	.ba_rx_wsize = BA_WIN_SZ_512, /*HT_BAWinSize*/
	.ba_tx_wsize = BA_WIN_SZ_512, /*HT_BAWinSize*/
	.ht_gi = 1, /*HT_GI*/
	.ht_stbc = 1, /*HT_STBC*/
	.ht_ldpc = 1, /*HT_LDPC*/
	.bRdg = 1, /*HT_RDG*/
...
VOID Air_Monitor_Pkt_Report_Action(RTMP_ADAPTER *pAd, UINT16 wcid, struct _RX_BLK *pRxBlk);
#endif /* AIR_MONITOR */

#ifdef DOT11_EHT_BE
INT	set_pp_enable_proc(
	IN RTMP_ADAPTER	*pAd,
	IN RTMP_STRING * arg);
#endif
...
INT	Set_ActionMon_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif
...
static INT Show_Rate_Report_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif
...
INT Set_McastRate(RTMP_ADAPTER * pAd, RTMP_STRING * arg);
...
#ifdef EAP_STATS_SUPPORT
static INT Set_StaPowerOffDetect_Proc(struct _RTMP_ADAPTER *pAd, char *arg);
#endif
...
INT set_sw_fr_tbl_idx_bw(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif /* SW_CONNECT_SUPPORT */


struct PRIV_SET_PROC RTMP_PRIVATE_AP_SUPPORT_PROC[] = {
	...
	{"pp_enable",				set_pp_enable_proc},
	{"pp_mu_ctrl",				set_pp_mu_ctrl_proc},
	{"change_pp_cap",			change_pp_cap_proc},
#endif
#endif
	...
	{"MaxChSwitchTime",				Set_MaxChSwitchTime_Proc},
#ifdef CONFIG_EAP_QUICK_CHANNEL_SWITCH_WITHOUT_CSA
	{"QuickChSwitch",			Set_QuickChSwitch_Proc},
#endif
	...
	{"TxPwrBackoff",				Set_Idc_TxPwrBackOff},
#endif
...
#ifdef PEAK_ENHANCE
	{"Txoppeaktpen",                Set_peak_adjust_enable_Proc},
	{"Txoppeaktpaifsn",             Set_peak_adjust_aifsn_Proc},
	{"Txoppeaktprxavglen",          Set_peak_adjust_rx_avg_len_th_Proc},
	{"PeakTpRxLowBoundTh",          Set_peak_adjust_rx_low_bound_th_Proc},
	{"PeakTpRxHigherBoundTh",       Set_peak_adjust_rx_high_bound_th_Proc},
	{"SimAvgRxPktLen",              Set_peak_adjust_sim_avg_rx_pkt_len},
	{"SimAvgTxPktLen",              Set_peak_adjust_sim_avg_tx_pkt_len},
	{"SimTxCount",                  Set_peak_adjust_sim_tx_count},
	{"TxopTxPktLenTh",              Set_peak_adjust_tx_pkt_len_th_Proc},
	{"TxopTxCountTh",               Set_peak_adjust_tx_count_th_Proc},
	{"TxopAdjustInfo",              show_peak_adjust_ctrl_info},
#endif /* PEAK_ENHANCE */
	{"MbssMaxStaNum",					Set_AP_PerMbssMaxStaNum_Proc},
#ifdef ACTION_MONITOR_SUPPORT
	{"ActionMonitor",						Set_ActionMon_Proc},
#endif
#if defined(MBSS_AS_WDS_AP_SUPPORT) || defined(APCLI_AS_WDS_STA_SUPPORT)
	{"wds",							Set_Wds_Proc},
#endif
...
#ifdef FORCE_NULL_TX
	{"ForceNullTx",					Set_ForceNullTx_Proc},
#endif
#ifdef TXRX_STAT_SUPPORT
	...
	{"AckCnt",                      Set_AckCnt_Enable_Proc},
	{"BarRetry",					Set_Bar_Retry_Proc},
	...
	{"PhyIcs_EventOn",              Set_PhyIcs_Event_Proc},
	...
	{"DfsZwCert",		    Set_DfsZeroWaitCert_Proc},
	...
	{"ATECFGONOFF", SetATECfgOnOffProc},
	{"ATECHANNEL", SetATEChannel},
	{"ATEPKTTXTIME", set_ate_pkt_tx_time},
	{"ATERXSTATRESET", set_ate_rx_stat_reset},
	{"ATETXPOW", SetATETxPower0},
	{"ATECHOFFSET", SetATEChPowerOffset},
	{"ATECVTOFFSET", SetATECvtPowerOffset},
	...
	*/
	...
	{"IgmpCfgPerBandSize",			Set_IgmpSn_CfgPerBandSize_Proc},
	...
	{"IgmpMwdsCloneEnable",			Set_IgmpSn_Allow_Mwds_Clone_Enable_Proc},
#endif /* IGMP_SNOOP_SUPPORT */
#ifdef CONFIG_AP_SUPPORT
#ifdef CONFIG_RA_PHY_RATE_SUPPORT
	{"mgmtrate",				set_mgmt_rate_proc},
	{"highprirate",				set_high_pri_rate_proc},
...
#endif
#ifdef DOT11_EHT_BE
	{"ehtsuprateset",				set_ehtsuprateset_proc},
#endif
	...
	{"TxBfProfileTagPartialBw", set_txbf_prof_tag_partial_bw},
...
#else
	{"FixedRate",				UniCmdRAFixedRateProc},
	{"FixedRateUl", 			UniCmdRAFixedRateUlProc},
	{"AutoRate",				UniCmdRAAutoRateProc},
#endif
...
#ifdef SW_CONNECT_SUPPORT
	{"SwFixedRate",                 set_sw_fr_tbl_idx_bw},
#endif /* SW_CONNECT_SUPPORT */
	...
	{"efuseWrite",					set_eFuseWrite_Proc},
#ifdef CONFIG_ATE
	...
	{"NoiseFloorCmd",               set_noise_floor_cmd},
	{"fwlog", set_fw_log},
	{"hostlog", set_host_log},
	{"hostdumpoffset", set_host_dump_offset},
	{"fw_dbg", set_fw_dbg},
	...
	{"rlmMdvtInfo",                    set_muru_mdvt_flow_info},
#ifdef DABS_QOS
	...
	{"set_pqs_manual_scs",					set_pqs_manual_scs},
	{"disable_contention_tx",				set_disable_contention_tx},
#ifdef WIFI_UNIFIED_COMMAND
	{"set_test_mode_tbrx_config",			set_test_mode_tbrx_config},
#endif /* WIFI_UNIFIED_COMMAND */
#endif
	...
	*/
	...
	{"SCSInfo",	ShowSCSinfo_ver2_proc}, /*For SCS_VER2*/
#ifdef WIFI_UNIFIED_COMMAND
	{"SCSEnable", UNI_Set_SCSEnable_Proc},
	{"SCSpdrange", UNI_Set_SCSPdThrRange_Proc},
	{"SCSdata", UNI_SendSCSDataProc},
	{"SCSaddr", UNI_GetScsGloAddr},
#endif /*  WIFI_UNIFIED_COMMAND */
...
#endif /* BAND_STEERING */
#ifdef WIFI_UNIFIED_COMMAND
	{"RASandBoxCtrl",	UniCmdRASandBoxCtrlProc},
#endif
	{"raOption",	SetRaOption},
	...
	{"osu", 		Set_Osu_Enable},
#endif
	{"time_sync", set_time_sync_trigger},
	{"ser", set_ser},
#ifdef CONFIG_TX_DELAY
	...
	{"ba_winsize", set_ba_winsize},
	{"clear_keyloc", clear_keyloc},
#ifdef CONFIG_SPECIAL_RPS_SUPPORT
	{"srps", set_special_rps},
#endif /* CONFIG_SPECIAL_RPS_SUPPORT */
#ifdef CUT_THROUGH
	...
	{"ApcliRandomMacEnable",  Set_RandomMacEnable_Proc},
	{"ApcliSeqNum_set",  Set_SequenceNum_Proc},
#endif
	...
	{"ie_filter_op", ie_filter_oper_proc},
	{"ie_filter_rule", ie_filter_rule_proc},
#ifdef DOT11_HE_AX
	...
	{"srcfgsrrateoffset", SetSrCfgSrRateOffset},
...
#ifdef WIFI_UNIFIED_COMMAND
	{"CSREnable", SetCsrEnable},
	{"CSRCoordAPInfoRst", SetCsrCoordAPInfoRst},
	{"CSRCoordAPUpdMode", SetCsrCoordAPUpdateMode},
	{"CSRCoordAPInfo", SetCsrCoordAPInfo},
	{"CSRFixNofiyPwr", SetCsrFixNofiyPwr},
	{"CSRFixRate", SetCsrFixRate},
	{"CSRStaInfoRst", SetCsrCoordAPInfoRst},
	{"CSRStaUpdMode", SetCsrStaUpdateMode},
	{"CSRStaInfo", SetCsrStaInfo},
#endif/*WIFI_UNIFIED_COMMAND*/
...
#endif /* DPP_SUPPORT */
#ifdef QOS_R1
	{"QoSEnable",			Set_QoSEnable_Proc},
	{"QoSTriggerFrame",		QoS_TriggerFrame_RDUT_Test},
#ifdef QOS_R2
	{"DSCPPolicyEnable",		Set_DSCPPolicyEnable_Proc},
	{"QoSMgmtCapa",			Set_QoSMgmtCapa_Proc},
	{"QosMapCapa",			Set_QoSMapCapa_Proc},
#ifdef MAP_R5
	{"reset_dscp2up_tbl",		Reset_Dscp2Up_TBL_Proc},
#endif
#endif
	...
	{"AFCtest",		afc_test_mode},
	{"AFCBeaconBW",		afc_set_beacon_bw},
	{"afcparams",		afc_cmd_set_afc_params},
	{"afcevents",		set_afc_event},
	{"AfcDeviceType",	set_afc_device_type},
	{"AfcSpectrumType",	set_afc_spectrum_type},
	{"AfcFreqrange",	set_afc_freq_range},
	{"AfcOpClass131",	set_afc_op_class131},
	{"AfcOpClass132",	set_afc_op_class132},
	{"AfcOpClass133",	set_afc_op_class133},
	{"AfcOpClass134",	set_afc_op_class134},
	{"AfcOpClass136",	set_afc_op_class136},
	{"AfcOpClass137",	set_afc_op_class137},
#endif /*CONFIG_6G_AFC_SUPPORT*/
#ifdef WIFI_UNIFIED_COMMAND
	{"mloagctx", Set_MloAgcTx_Proc},
	{"mloagctrig", Set_MloAgcTrig_Proc},
	{"mlooption", Set_MloOptionCtrl_Proc},
#endif /* WIFI_UNIFIED_COMMAND */
#ifdef PRE_CFG_SUPPORT
	{"precfg_peer", Set_PreCfg_Peer_Proc},
	{"precfg_nego_param", Set_PreCfg_Negotiation_Param_Proc},
...
#ifdef CONFIG_WIFI_SYSDVT
#ifdef WIFI_UNIFIED_COMMAND
	{"adm_dvt_cmd",	set_adm_dvt_cmd},
#endif
#endif
#ifdef DOT11_EHT_BE
	{"eml_oper_trig", trigger_eml_oper_notification_proc},
#endif /*DOT11_EHT_BE*/
#ifdef CONFIG_AP_SUPPORT
#ifdef DOT11_EHT_BE
	{"crit_upd", set_trigger_crit_upd_proc},
	{"apmld", set_ap_mld_proc},
	{"link_recomm", set_ap_mld_link_recomm_proc},
	{"at2lm", set_ap_at2lm_proc},
	{"nt2lm", set_ap_nt2lm_proc},
	{"mlr", set_ap_reconfig_rm_link_proc},
#endif /* DOT11_EHT_BE */
#endif /* CONFIG_AP_SUPPORT */
	{"testmode_en", set_testmdoe_en_proc},
	{"tx_null", set_tx_null_proc},
#ifdef CONFIG_6G_SUPPORT
	{"lpi_en", Set_Lpi_en},
#endif /* CONFIG_6G_SUPPORT */
	{"probe_max_cnt", Set_Max_ProbeRspCnt},
#ifdef MLR_SUPPORT
	{"MLREnable", set_mlr_ctl},
	{"MLRVer", set_mlr_ver},
	{"MLRForceState", set_mlr_force_state},
#endif /* MLR_SUPPORT */
#ifdef CONFIG_FAST_NAT_SUPPORT
	{"ForceSwPath", set_force_swpath},
	{"whnat_en", set_whnat_en_proc},
#endif
	{"rro_bypass", set_rro_bypass_proc},
#ifdef DFS_SLAVE_SUPPORT
	{"DfsSlaveEn", set_dfs_slave_en_proc},
	{"SlaveSkipStaDisc", set_slave_sta_disc_skip_proc},
#endif /* DFS_SLAVE_SUPPORT */
	{"bcnbpcc_dbg", bcn_bpcc_dbg},
	{"Reconf_flow", MBSS_Reconfig_flow_proc},
	{"assoc_record", set_assoc_record_proc},
	{"sta_keepalive", Set_StationKeepAlive},
#ifdef BCN_EXTCAP_VAR_LEN
	{"BcnExtCapLen", set_BeaconExtCapLength_proc},
#endif
#ifdef EPCS_SUPPORT
	{"queryEpcs", Query_Epcs_Entry_Proc},
#endif
	{"freq_meter", SetFreqMeter},
	{NULL,}
};

INT show_device_list_info(PRTMP_ADAPTER pAd, char *arg)
{
	physical_device_show_information();
	return TRUE;
}

INT Show_ScanTable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	for (i = 0; i < ScanTab->BssNr; i++) {
		...
		/* Title log */
		MTWF_PRINT("%-4s%-4s%-20s%-33s", "NO", "CH", "BSSID", "SSID");
#ifdef FTM_SUPPORT
		MTWF_PRINT("%-8s%-8s", "FTM-R", "FTM-I");
#endif /* FTM_SUPPORT */
		MTWF_PRINT("%-23s\n", "Security");
		/* Title log end */

		/* NO, CH, BSSID, SSID */
		MTWF_PRINT("%-4d%-4d%02x:%02x:%02x:%02x:%02x:%02x   %-33s",
			i, pBss->Channel,
			pBss->Bssid[0],
			pBss->Bssid[1],
			pBss->Bssid[2],
...
#ifdef FTM_SUPPORT
		MTWF_PRINT("%-8d%-8d",
			pBss->ExtCapInfo.ftm_resp, pBss->ExtCapInfo.ftm_init);
#endif /* FTM_SUPPORT */
		/* Security */
		MTWF_PRINT("%s/%s\n",
			GetAuthModeStr(pBss->AKMMap), GetEncryModeStr(pBss->PairwiseCipher));
	}
	return TRUE;
}

struct PRIVATE_SHOW_PROC RTMP_PRIVATE_AP_SHOW_SUPPORT_PROC[] = {
	{"scan_table",			Show_ScanTable_Proc},
	...
	{"hwifi_dbg_cmd", show_hwifi_dbgcmd_proc},
#if defined(DOT11_HE_AX) && defined(FIXED_HE_GI_SUPPORT)
	...
	{"rate_report",			Show_Rate_Report_Proc},
#endif
	...
	{"wtbl",				show_wtbl_proc},
	{"wtbl_mlo_omac",		show_wtbl_mlo_omac_proc},
	...
	{"wifisysinfo",	 Show_WifiSysInfo_Proc},
#ifdef CONFIG_TP_DBG
...
#endif /* IGMP_SNOOP_SUPPORT */
#ifdef CONFIG_RA_PHY_RATE_SUPPORT
	{"mgmtrate",			show_mgmtrate},
	{"highprirate",			show_high_pri_rate},
#endif /* CONFIG_RA_PHY_RATE_SUPPORT */
#ifdef MCAST_RATE_SPECIFIC
	...
	{"ATECFGONOFF", ShowATECfgOnOffProc},
	{"ATERXSTAT", ShowATERxStat},
	{"ATERXSWCNT", ShowATERxSwCount},
#endif
...
#ifdef CFG_SUPPORT_FALCON_SR
	{"srcap", ShowSrCap},
	{"sresren", ShowSrCapEsrEn},
	{"srnonsrgen", ShowSrCapNonSrgEn},
	{"srapclimode", ShowSrApCliMode},
	{"srpara", ShowSrPara},
	{"srind", ShowSrInd},
	{"srinfo", ShowSrInfo},
	{"srcond", ShowSrCond},
	...
	{"srcfgsrrateoffset", ShowSrRateOffset},
	{"srcnt", ShowSrCnt},
	{"srsd", ShowSrSd},
	...
	{"srcfgsrsupportmode", ShowSrCfgSrSupportMode},
	{"srtxcount", ShowSrTxCount},
#ifdef WIFI_UNIFIED_COMMAND
	{"CSREnable", ShowCsrEnable},
	{"CSRCoordAPUpdMode", ShowCsrCoordApUpdMode},
	{"CSRCoordAPInfo", ShowCsrCoordApInfo},
	{"CSRInfo", ShowCsrInfo},
	{"CSREventCnt", ShowCsrEventCnt},
	{"CSRFixNofiyPwr", ShowCsrFixNofiyPwr},
	{"CSRFixRate", ShowCsrFixRate},
	{"CSRStaUpdMode", ShowCsrStaUpdMode},
	{"CSRStaInfo", ShowCsrStaInfo},
#endif/* WIFI_UNIFIED_COMMAND*/
#endif /* CFG_SUPPORT_FALCON_SR */
	{"aidinfo", show_aid_info},
	{"wfdma_dump", Show_WFDMA_Proc},
	...
	{"afcSkipChannel",	afc_cmd_show_skip_channel},
#endif /*CONFIG_6G_AFC_SUPPORT*/
#ifdef DOT11_EHT_BE
	{"eht_config",	show_eht_config},
	{"mldinfo", show_mld_info},
#endif /* DOT11_EHT_BE */
#ifdef CONFIG_AP_SUPPORT
	{"bssmngr", show_bss_mngr_info},
	{"bsstidmap", show_bss_tidmap_info},
#endif
	{"device_list", show_device_list_info},
	{"phy_stat_dbg", Show_Phy_State_Dbg_Info},
#ifdef WIFI_UNIFIED_COMMAND
	{"mldrec", Show_mldRec_Proc},
#endif/* WIFI_UNIFIED_COMMAND*/
	{"mac_cap", show_mac_cap_Proc},
#ifdef BCN_PROTECTION_SUPPORT
	{"BcnProtDbgInfo", show_bcn_prot_dbg_info},
#endif /* BCN_PROTECTION_SUPPORT */
#ifdef DFS_SLAVE_SUPPORT
	{"DfsSlaveInfo", show_slave_info_proc},
#endif /* DFS_SLAVE_SUPPORT */
	{"Reconf_flow", MBSS_Reconfig_flow_info},
	{"assoc_dump", show_assoc_pkt},
	{"sta_keepalive", Show_StationKeepAlive},
	{"list_workq", physical_device_workq_show_info},
	{"channelprioinfo", ShowChPrioInfo},
	{NULL,}

};

struct PRIV_SET_PROC *PRTMP_PRIVATE_AP_SET_PROC = RTMP_PRIVATE_AP_SUPPORT_PROC;
struct PRIVATE_SHOW_PROC *PRTMP_PRIVATE_AP_SHOW_PROC = RTMP_PRIVATE_AP_SHOW_SUPPORT_PROC;
	...
	IN RTMP_IOCTL_INPUT_STRUCT *pIoctlCmdStr)
{
	...
	while ((this_char = strsep((char **)&tmp, "\0")) != NULL) {
...
#ifdef WDS_SUPPORT
				if (ifIndex >= 0 && ifIndex < MAX_WDS_ENTRY)
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"\n\n********** WARNING: iwpriv command set %s needs to be replaced with correct NL80211_CMD_ID **********\n\n", this_char);
#endif

		for (PRTMP_PRIVATE_AP_SET_PROC = RTMP_PRIVATE_AP_SUPPORT_PROC; PRTMP_PRIVATE_AP_SET_PROC->name; PRTMP_PRIVATE_AP_SET_PROC++) {
			if (rtstrcasecmp(this_char, PRTMP_PRIVATE_AP_SET_PROC->name) == TRUE) {
				if (!PRTMP_PRIVATE_AP_SET_PROC->set_proc(pAd, value)) {
		...
		if (PRTMP_PRIVATE_AP_SET_PROC->name == NULL) {
			/*Not found argument */
			Status = -EINVAL;
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "IOCTL::(iwpriv) Command not Support [%s=%s]\n", this_char,
					 value);
			break;
		}
	}
	...
	IN RTMP_IOCTL_INPUT_STRUCT *pIoctlCmdStr)
{
	...
	while ((this_char = strsep((char **)&tmp, ",")) != NULL) {
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Before check, this_char=%s\n", this_char);
		value = strchr(this_char, '=');
...
#ifdef RT_CFG80211_SUPPORT
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"\n\n********** WARNING: iwpriv command show %s needs to b replaced with correct NL80211_CMD_ID **********\n\n", this_char);
#endif
		...
		for (PRTMP_PRIVATE_AP_SHOW_PROC = RTMP_PRIVATE_AP_SHOW_SUPPORT_PROC; PRTMP_PRIVATE_AP_SHOW_PROC->name;
			...
			if (rtstrcasecmp(this_char, PRTMP_PRIVATE_AP_SHOW_PROC->name) == TRUE) {
				if (!PRTMP_PRIVATE_AP_SHOW_PROC->set_proc(pAd, value)) {
					/*FALSE:Set private failed then return Invalid argument */
					Status = -EINVAL;
				}
	...
	IN RTMP_IOCTL_INPUT_STRUCT * wrq)
{
	...
	INT i;
	char *msg;
	UINT16 max_asso_num = GET_MAX_UCAST_NUM(pAd);
	UINT msg_len = max_asso_num * ASSO_MAC_LINE_LEN;

	os_alloc_mem(NULL, (UCHAR **)&msg, msg_len);

	if (msg == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Alloc memory failed\n");
		return;
	}
	...
	for (i = 0; i < max_asso_num; i++) {
		...
		if ((IS_ENTRY_CLIENT(pEntry) || (IS_ENTRY_PEER_AP(pEntry) || IS_ENTRY_REPEATER(pEntry)))
			...
			snprintf(msg + strlen(msg), msg_len - strlen(msg), "%-6s", get_bw_str(pEntry->HTPhyMode.field.BW, BW_FROM_OID));
#ifdef DOT11_VHT_AC
	...
	if (copy_to_user(wrq->u.data.pointer, msg, wrq->u.data.length))
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "%s", msg);
...
VOID restart_ap(void *wdev_obj)
{
	...
	if (wifi_sys_linkdown(wdev) != TRUE) {
		MTWF_DBG(NULL, DBG_CAT_INTF, CATINTF_UP, DBG_LVL_ERROR, "linkdown fail.\n");
		return;
	}

	if (wifi_sys_close(wdev) != TRUE) {
		MTWF_DBG(NULL, DBG_CAT_INTF, CATINTF_UP, DBG_LVL_ERROR, "close fail.\n");
		return;
	}

	if (wifi_sys_open(wdev) != TRUE) {
		MTWF_DBG(NULL, DBG_CAT_INTF, CATINTF_UP, DBG_LVL_ERROR, "open fail.\n");
		return;
	}

	if (wifi_sys_linkup(wdev, NULL) != TRUE) {
		MTWF_DBG(NULL, DBG_CAT_INTF, CATINTF_UP, DBG_LVL_ERROR, "linkup fail.\n");
		return;
	}
...
#endif
	UpdateBeaconHandler(wdev->sys_handle, wdev, BCN_REASON(BCN_UPDATE_IE_CHG));
}

#ifdef QOS_R1
void qos_set_dscp2up_mapping(PRTMP_ADAPTER pAd, BSS_STRUCT *pMbss)
{
	pAd->cp_support_off_by_qos_map = FALSE;
#ifdef DSCP_PRI_SUPPORT
	...
	IN INT cmd)
{
	...
	case OID_GET_CURRENT_RSSI:
	{
		...
		if ((pObj->ioctl_if_type != INT_APCLI) || (ifIndex >= MAX_APCLI_NUM) || !VALID_MBSS(pAd, ifIndex)) {
		...
		for (i = 1; VALID_UCAST_ENTRY_WCID(pAd, i); i++) {
			...
			if (IS_VALID_ENTRY(pEntry)) {
				MTWF_DBG(pAd, DBG_CAT_MLME, CATMLME_WTBL, DBG_LVL_INFO, MACSTR" ", MAC2STR(pEntry->Addr));
				MTWF_DBG(pAd, DBG_CAT_MLME, CATMLME_WTBL, DBG_LVL_INFO, "%d\n", pEntry->CurRssi);
	...
	case OID_SET_VENDOR10_RSSI:
	{
		...
		if (wrq->u.data.length != sizeof(BOOLEAN))
			...
			if (RX_MV_MODE & mac_val)
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "Current Alg Respond Frame Alg %d\n", mac_val);
			else
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "Current Alg Respond Frame/Data Alg %d\n", mac_val);

			if (IS_VENDOR10_RSSI_VALID(wdev) && !(RX_MV_MODE & mac_val)) {
				mac_val |= RX_MV_MODE;
				MAC_IO_WRITE32(pAd, WTBL_OFF_RMVTCR, mac_val);
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "New Alg Respond Frame/Data %d\n", mac_val);
			} else if ((IS_VENDOR10_RSSI_VALID(wdev) == FALSE) && (RX_MV_MODE & mac_val)) {
				mac_val &= ~RX_MV_MODE;
				MAC_IO_WRITE32(pAd, WTBL_OFF_RMVTCR, mac_val);
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "New Alg Respond Frame %d\n", mac_val);
			}
		}
	}
	break;
	...
	case OID_802_11_CURRENT_CHANNEL_INFO:
	{
		...
		Rsp.tx_time = pAd->Ch_Stats.Tx_Time;
		Rsp.rx_time = pAd->Ch_Stats.Rx_Time;
		Rsp.obss_time = pAd->Ch_Stats.Obss_Time;
		Rsp.channel_busy_time = pAd->Ch_BusyTime;
	...
	case OID_802_11_DEAUTHENTICATION:
	{
		...
		if (wrq->u.data.length > sizeof(Elem->Msg))
			wrq->u.data.length = sizeof(Elem->Msg);
	...
	case OID_802_11R_MDID:
		if (wrq->u.data.length != FT_MDID_LEN)
			...
			UCHAR apidx = pObj->ioctl_if;
			if (apidx < MAX_BEACON_NUM) {
				if (wrq->u.data.length > ARRAY_SIZE(pAd->ApCfg.MBSSID[apidx].wdev.FtCfg.FtMdId))
					wrq->u.data.length = ARRAY_SIZE(pAd->ApCfg.MBSSID[apidx].wdev.FtCfg.FtMdId);
	...
	case OID_802_11R_R0KHID:
		if (wrq->u.data.length <= FT_ROKH_ID_LEN)
			...
			if (apidx < MAX_BEACON_NUM) {
				if (wrq->u.data.length > ARRAY_SIZE(pAd->ApCfg.MBSSID[apidx].wdev.FtCfg.FtR0khId))
					wrq->u.data.length = ARRAY_SIZE(pAd->ApCfg.MBSSID[apidx].wdev.FtCfg.FtR0khId);
				...
				MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_FT, DBG_LVL_INFO,
					"Set::OID_802_11R_OID_802_11R_R0KHID(=%s) Len=%d\n",
	...
	case RT_SET_APD_PID: {
		...
		if (copy_from_user(&apd_pid, wrq->u.data.pointer, wrq->u.data.length))
			...
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "RT_SET_APD_PID::(ApdPid=%lu)\n", apd_pid);
		}
	}
	break;
	...
	case RT_OID_WSC_SET_CON_WPS_STOP: {
		...
		if (wrq->u.data.length != sizeof(WSC_UPNP_CTRL_WSC_BAND_STOP)) {
			Status = EINVAL;
			break;
		}
		...
		if (pWscUpnpBandStop) {
			...
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
				"CON_WPS BAND_STOP_CMD From[%s], isApCli[%d], is2gBand[%d]\n",
			...
			if (pWscUpnpBandStop->isApCli) {
				...
				for (i = 0; i < MAX_APCLI_NUM; i++) {
					...
					MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
						"CON_WPS FROM IOCTL: Stop the %s WPS, state [%d]\n",
				...
				if ((pWpsCtrl->WscConfMode != WSC_DISABLE) &&
					...
					MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "FROM IOCTL CON_WPS[%d]: Stop the AP Wsc Machine\n", apidx);
	...
	case RT_OID_WSC_EAPMSG: {
		...
		struct wifi_dev *wdev;
			...
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
				"WSC::RT_OID_WSC_EAPMSG, wrq->u.data.length=%d, ioctl_if=%d\n",
				wrq->u.data.length, pObj->ioctl_if);

			if (wrq->u.data.length < sizeof(RTMP_WSC_U2KMSG_HDR)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"invalid value!\n");
				Status = -EINVAL;
				break;
			...
			os_alloc_mem(pAd, (UCHAR **)&pUPnPMsg, msgLen + 1);
			if (pUPnPMsg == NULL) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			...
			NdisZeroMemory(pUPnPMsg, msgLen + 1);
			...
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
				"RT_OID_WSC_EAPMSG++++++++\n\n");
			HeaderLen = sizeof(RTMP_WSC_U2KMSG_HDR);
		...
		if (wrq->u.data.length > 0) {
			...
			if (pWscUfdFileName) {
				...
				if (copy_from_user(pWscUfdFileName, wrq->u.data.pointer, wrq->u.data.length))
					...
					MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
						"RT_OID_WSC_READ_UFD_FILE (WscUfdFileName=%s)\n", pWscUfdFileName);
					...
					if (pWscCtrl->WscConfStatus == WSC_SCSTATE_UNCONFIGURED) {
						...
						MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR,
							"RT_OID_WSC_READ_UFD_FILE: AP is configured.\n");
						Status = -EINVAL;
					}
				}
	...
	case RT_OID_WSC_UUID:
		...
		if (wrq->u.data.length == (UUID_LEN_STR - 1)) {
			...
			for (ii = 0; ii < 16; ii++)
				MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "%02x",
	...
	case OID_SET_SSID:
		...
		if (wrq->u.data.length <= MAX_LEN_OF_SSID) {
			...
			if (pObj->ioctl_if_type == INT_APCLI) {
				...
				if (wrq->u.data.length > ARRAY_SIZE(pApCliEntry->CfgSsid))
					wrq->u.data.length = ARRAY_SIZE(pApCliEntry->CfgSsid);
			...
			if (ifIndex < MAX_BEACON_NUM) {
				...
				if (wrq->u.data.length > ARRAY_SIZE(pMbss->Ssid))
					wrq->u.data.length = ARRAY_SIZE(pMbss->Ssid);
				...
				}
				{
					...
					if (pAd->CommonCfg.need_fallback == 1 && pMbss->wdev.channel < 15) {
						MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
	...
	case OID_SET_PSK:
		{
			...
			BSS_STRUCT *pMbss;
			INT i;
			if (!VALID_MBSS(pAd, pObj->ioctl_if)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"Invalid idx %d\n", pObj->ioctl_if);
				return FALSE;
			}
			...
			if (wrq->u.data.length < ARRAY_SIZE(pSecConfig->PSK)) {
			...
			if (!IS_AKM_DPP(pSecConfig->AKMMap)) {
				...
				for (i = 0; ((i < MAX_PMKID_COUNT)
					|| (i < ARRAY_SIZE(pmkid_cache->BSSIDInfo))); i++) {
					if ((pmkid_cache->BSSIDInfo[i].Valid == TRUE)
						&& (MAC_ADDR_EQUAL(
							&pmkid_cache->BSSIDInfo[i].own_mac,
							pMbss->wdev.bssid))) {
						pmkid_cache->BSSIDInfo[i].Valid = FALSE;
						MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_WARN,
			...
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_INFO, "PSK = %s\n",
				pSecConfig->PSK);
#ifdef CONFIG_AP_SUPPORT
#ifdef WSC_AP_SUPPORT
			IF_DEV_CONFIG_OPMODE_ON_AP(pAd) {
				...
				if (pWscControl) {
					NdisZeroMemory(pWscControl->WpaPsk, sizeof(pWscControl->WpaPsk));
					pWscControl->WpaPskLen = 0;
					pWscControl->WpaPskLen = wrq->u.data.length;
					if (pWscControl->WpaPskLen > sizeof(pWscControl->WpaPsk)) {
						MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
							"Invalid psk len\n");
						Status = -EINVAL;
						break;
	...
	case OID_802_11_WEPDEFAULTKEYVALUE: {
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_INFO,
		...
		if (wrq->u.data.length > sizeof(NDIS_AP_802_11_KEY))
			wrq->u.data.length = sizeof(NDIS_AP_802_11_KEY);
	...
	case OID_802_DOT1X_MLME_EVENT:
		MTWF_DBG(pAd, DBG_CAT_MLME, CATMLME_DOT1X, DBG_LVL_DEBUG,
	...
	case OID_802_11_AUTHENTICATION_MODE: {
		...
		if (wrq->u.data.length != sizeof(NDIS_802_11_AUTHENTICATION_MODE))
			...
			MTWF_DBG(pAd, DBG_CAT_MLME, CATMLME_AUTH, DBG_LVL_INFO,
				"Set::OID_802_11_AUTHENTICATION_MODE (=0x%x)\n",
	...
	case OID_802_11_WEP_STATUS:
		if (wrq->u.data.length != sizeof(NDIS_802_11_WEP_STATUS))
			...
			EncryType = SecEncryModeOldToNew(WepStatus);
			{
				...
				APStartUp(pAd, pMbss, AP_BSS_OPER_SINGLE);
				MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_INFO,
					"Set::OID_802_11_WEP_STATUS (=0x%x)\n", EncryType);
			}
		}
	...
	case OID_802_11_SSID:
		...
		if (wrq->u.data.length != sizeof(NDIS_802_11_SSID))
			...
			if (Ssid.SsidLength > MAX_LEN_OF_SSID || Ssid.SsidLength == 0)
				Status = -EINVAL;
			else {
				...
				if (pSsidString) {
					...
					NdisZeroMemory((PCHAR)pAd->ApCfg.MBSSID[ifIndex].Ssid,
						   MAX_LEN_OF_SSID);
					strlcpy((PCHAR)pAd->ApCfg.MBSSID[ifIndex].Ssid,
						pSsidString
						, MAX_LEN_OF_SSID);
	...
	case OID_802_11_PASSPHRASES: {
		...
		if (wrq->u.data.length > sizeof(tmpPSK))
			wrq->u.data.length = sizeof(tmpPSK);
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_VENDOR, DBG_LVL_INFO,
			"Set::OID_802_11_PASSPHRASE\n");

		if (tmpPSK.WPAKeyLen > ARRAY_SIZE(tmpPSK.WPAKey))
			tmpPSK.WPAKeyLen = ARRAY_SIZE(tmpPSK.WPAKey);

		for (i = 0 ; i < tmpPSK.WPAKeyLen ; i++)
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_VENDOR, DBG_LVL_INFO, "%c", tmpPSK.WPAKey[i]);
		...
		if (retval == FALSE)
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_VENDOR, DBG_LVL_ERROR,
				"PassPhrase Generate Fail\n");

#ifdef WSC_AP_SUPPORT
		NdisZeroMemory(pMBSSStruct->wdev.WscControl.WpaPsk, ARRAY_SIZE(pMBSSStruct->wdev.WscControl.WpaPsk));
	...
	case OID_802_11_HS_ANQP_RSP: {
		...
		if (wrq->u.data.length < sizeof(struct anqp_rsp_data)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"invalid value!\n");
		...
		if (rsp_data->anqp_rsp_len != (wrq->u.data.length - sizeof(struct anqp_rsp_data))) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"invalid value!\n");
			os_free_mem(Buf);
			Status = -NDIS_STATUS_FAILURE;
	...
	{
		UCHAR *Buf = NULL;
		struct action_frm_data *action_frm;
		struct wifi_dev *wdev = get_wdev_by_ioctl_idx_and_iftype(pAd, pObj->ioctl_if, pObj->ioctl_if_type);

//TODO: Add if needed in future
		if (wrq->u.data.length < sizeof(struct action_frm_data)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"invalid value!\n");
			Status = -NDIS_STATUS_FAILURE;
			break;
		...
		action_frm = (struct action_frm_data *)Buf;
		if (action_frm->frm_len != (wrq->u.data.length - sizeof(struct action_frm_data))) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"invalid value!\n");
			Status = -NDIS_STATUS_FAILURE;
			os_free_mem(Buf);
		...
		mtk_send_offchannel_action_frame(pAd, wdev, action_frm);
		os_free_mem(Buf);
	}
	break;
	...
	case OID_802_11_SET_PMK:
	{
		if (pAd->bDppEnable) {
			...
			if (wrq->u.data.length != sizeof(struct pmk_req)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"invalid value!\n");
				Status = -NDIS_STATUS_FAILURE;
				break;
	...
	case OID_SEND_QOS_ACTION_FRAME:
	{
		...
		if ((wrq->u.data.length < sizeof(struct action_frm_data)) ||
		    (wrq->u.data.length > MAX_MGMT_PKT_LEN)) {
		...
		frm = (struct action_frm_data *)Buf;

		if (frm->frm_len != (wrq->u.data.length - sizeof(*frm))) {
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_MGMT, DBG_LVL_ERROR,
		...
		QoS_send_action_frame(pAd, wdev, frm);
		os_free_mem(Buf);
	}
	break;
#ifdef MSCS_PROPRIETARY
	...
	case OID_802_11_WAPP_PARAM_SETTING: {
		...
		if (wrq->u.data.length != sizeof(struct wapp_param_setting)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"invalid data length %u!\n", wrq->u.data.length);
			Status = -EINVAL;
			break;
	...
	case OID_802_11_WNM_BTM_REQ: {
		...
		if (pEntry == NULL) {
			...
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_MGMT, DBG_LVL_INFO, "btm1\n");
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			...
			if (pEntry->ReqbtmData == NULL) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
						"Fail to allocate memory!\n");
				Status = -ENOMEM;
			} else {
				memcpy(pEntry->ReqbtmData, Buf,
						sizeof(struct btm_req_data) + req_data->btm_req_len);
			}
		}
	...
	case OID_802_11_OCE_REDUCED_NEIGHBOR_REPORT: {/*pure 1x is enabled. */
		...
		if (wrq->u.data.length > sizeof(REDUCED_NR_LIST_INFO))
			wrq->u.data.length = sizeof(REDUCED_NR_LIST_INFO);
		...
		if (ReducedNRListInfo.ValueLen > ARRAY_SIZE(pMBSS->ReducedNRListInfo.Value))
			ReducedNRListInfo.ValueLen = ARRAY_SIZE(pMBSS->ReducedNRListInfo.Value);
	...
	case OID_802_11_WNM_NOTIFY_REQ: {
		...
		if (pEntry == NULL) {
			...
			(IS_AKM_OPEN(pAd->ApCfg.MBSSID[ifIndex].wdev.SecConfig.AKMMap)) ||
				   ((pEntry->SecConfig.Handshake.WpaState == AS_PTKINITDONE) &&
					(pEntry->SecConfig.Handshake.GTKState == REKEY_ESTABLISHED))) {
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_WNM, DBG_LVL_INFO, "wnm1\n");
			...
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_WNM, DBG_LVL_INFO, "wnm2\n");
			...
			if (pEntry->ReqData == NULL) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
						"Fail to allocate memory!\n");
				Status = -ENOMEM;
			} else {
				memcpy(pEntry->ReqData, Buf,
					sizeof(struct wnm_req_data) + req_data->wnm_req_len);
			}
		}
#endif /* CONFIG_HOTSPOT_R2 */
		os_free_mem(Buf);
	...
	case OID_802_11_QOSMAP_CONFIGURE: {
		...
		if (Buf == NULL) {
			...
			Status = copy_from_user(Buf, wrq->u.data.pointer, wrq->u.data.length);
			if (Status || wrq->u.data.length < sizeof(struct qosmap_data)) {
				Status = EINVAL;
				os_free_mem(Buf);
				break;
			}
				...
				for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i); i++) {
					...
					if ((IS_ENTRY_CLIENT(pEntry))
						...
						if (pEntry->QosMapSupport) {
							...
							memset(pEntry->DscpException, 0xff, 42);
							if (req_data->qosmap_len >= 16) {
								pEntry->DscpExceptionCount =
									req_data->qosmap_len - 16;
								memcpy((UCHAR *)pEntry->DscpRange,
									&req_data->qosmap[pEntry->DscpExceptionCount], 16);
							}
	...
	case OID_WAPP_EVENT:
	{
		...
		if (buf == NULL) {
			...
			wapp_event_handle(pAd, req, NULL);
			os_free_mem(buf);
		}
	}
		break;
...
#define VOW_CMD_STR_LEN 16
	...
	case OID_802_11_VOW_BW_AT_EN: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			UINT16 val_len = (wrq->u.data.length - sizeof(UINT8)) / sizeof(UINT16);

			if ((wrq->u.data.length == 0) || (val_len == 0)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
							"length error!\n");
				Status = -EFAULT;
				os_free_mem(cfg);
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				ret = snprintf(buf, sizeof(buf), "%d-%d", group, cfg->val[group]);
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_BW_AT_EN(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_BW_TPUT_EN: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_BW_TPUT_EN(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_ATF_EN: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			if (os_snprintf_error(sizeof(buf), ret)) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_ATF_EN(0x%08x) -> val %d\n", cmd, val[0]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_RX_EN: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			ret = snprintf(buf, sizeof(buf), "%d", val[0]);
			if (os_snprintf_error(sizeof(buf), ret)) {
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_ERROR,
				"snprintf error!\n");
				Status = -EFAULT;
			} else {
				set_vow_rx_airtime_en(pAd, buf);
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_RX_EN(0x%08x) -> val %d\n", cmd, val[0]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_GROUP_MAX_RATE: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_GROUP_MAX_RATE(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_GROUP_MIN_RATE: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_GROUP_MIN_RATE(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_GROUP_MAX_RATIO: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_GROUP_MAX_RATIO(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
	...
	case OID_802_11_VOW_GROUP_MIN_RATIO: {
		...
		if (Status == NDIS_STATUS_SUCCESS) {
			...
			for (group = 0; (group < cfg->ssid_num) && (group < val_len); group++) {
				...
				MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
					"OID_802_11_VOW_GROUP_MIN_RATIO(0x%08x) -> val %d\n", cmd, cfg->val[group]);
			}
		} else
			Status = -EFAULT;
			...
			if (ret == NDIS_STATUS_SUCCESS) {
				...
				if (ret == NDIS_STATUS_SUCCESS) {
					...
					if (copy_from_user(ch_sw_user_cfg, wrq->u.data.pointer, wrq->u.data.length)) {
						Status = -EFAULT;
						MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "copy from user fail\n");
					} else {
	...
	case OID_802_11_CAC_STOP:
	{
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "OID_802_11_CAC_STOP!!\n");
...
#ifdef DFS_SLAVE_SUPPORT
		case OID_BH_STATUS_MSG:
		{
			struct BH_STATUS_MSG bh_status = {0};
			struct wifi_dev *wdev = NULL;

			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_INFO,
				"[DFS-SLAVE][%s] OID_BH_STATUS_MSG if_idx:%d if_type:%d\n",
				__func__, pObj->ioctl_if, pObj->ioctl_if_type);

			wdev = get_wdev_by_ioctl_idx_and_iftype(pAd, pObj->ioctl_if, pObj->ioctl_if_type);

			if (!wdev) {
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_ERROR,
				"[DFS-SLAVE][%s] invalid wdev\n", __func__);
				break;
			}

			Status = copy_from_user((UCHAR *)&bh_status, wrq->u.data.pointer, sizeof(struct BH_STATUS_MSG));

			if (SLAVE_MODE_EN(pAd)) {
				slave_bcn_ctrl(pAd, bh_status.fBhStatus);
			} else {
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_ERROR,
				"[DFS-SLAVE][%s] Slave DFS not enabled\n", __func__);
			}
		}
			break;
#endif /* DFS_SLAVE_SUPPORT */
...
INT Channel_Info_MsgHandle(PRTMP_ADAPTER pAd, RTMP_IOCTL_INPUT_STRUCT *wrq, POS_COOKIE pObj)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_DEBUG, "Ioctl : %d!\n", ifIndex);
	if (wrq->u.data.length != sizeof(OFFCHANNEL_SCAN_MSG)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "error\n");
		return CHANNEL_MONITOR_STRG_FAILURE;
	} else {
		if (wrq->u.data.length > sizeof(msg))
			wrq->u.data.length = sizeof(msg);

		memset(&msg, 0, sizeof(OFFCHANNEL_SCAN_MSG));
		...
		case GET_OFFCHANNEL_INFO:
		{
			...
			if (ScanCtrl->state != OFFCHANNEL_SCAN_INVALID) {
				...
				for (i = 0; (i < msg.data.offchannel_param.Num_of_Away_Channel) && (i < MAX_AWAY_CHANNEL); i++) {
		...
		case UPDATE_DRIVER_SORTED_CHANNEL_LIST:
			...
			if (msg.data.sorted_channel_list.size > 0) {
				...
				for (i = 0; (i < msg.data.sorted_channel_list.size) && (i < ARRAY_SIZE(pAd->sorted_list.SortedMaxChannelBusyTimeList)); i++) {
...
*		other : Fail
*/
INT andlink_get_stainfos(RTMP_ADAPTER *pAd, INT apidx, RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
	INT idx = 0;
	UCHAR *dst_ptr = NULL;
	UCHAR *src_ptr = NULL;
	...
	for (idx = 0; idx < MAX_LEN_OF_MAC_TABLE; idx++) {
		...
		if (pEnt->Sst == SST_ASSOC) {
			...
			if (pEnt->Sst == SST_ASSOC && pEnt->EntryType == ENTRY_CLIENT) {
				...
				/*tx_rate*/
				sta_info->item[sta_info->sta_cnt].TxRate = tx_rate_info.legacy;
	...
	RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
	...
	if (!VALID_MBSS(pAd, ap_idx) || NULL == wrq||
		wrq->u.data.length > sizeof(*andlink_scan_info)) {
		MTWF_DBG(pAd, DBG_CAT_ANDLINK, CATANDLINK_CFG, DBG_LVL_ERROR,
					"input apidx: %d > %d BSSIDNUM, user len(%d) or kernel mem len(%uz)\n",
					ap_idx, pAd->ApCfg.BssidNum, wrq->u.data.length,
					sizeof(*andlink_scan_info));
		return -EFAULT;
	}

	status = os_alloc_mem(pAd, (UCHAR **)&andlink_scan_info, sizeof(*andlink_scan_info));
	if (status != NDIS_STATUS_SUCCESS) {
		return -ENOMEM;
	}
	...
	NdisZeroMemory(andlink_scan_info, sizeof(struct mtk_wifi_scan_info));
	mtk_cfg80211_andlink_get_scan_result(pAd, ap_idx, andlink_scan_info, offset);
	...
	RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
	...
	if (apcli_idx >= MAX_APCLI_NUM || NULL == wrq || (apcli_idx >= MAX_MULTI_STA)) {
		MTWF_DBG(pAd, DBG_CAT_ANDLINK, CATANDLINK_CFG, DBG_LVL_ERROR,
	...
	mtk_cfg80211_andlink_get_uplink_info(pAd, apcli_idx, &andlink_uplink_info);
	...
	RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
	...
	if (ap_idx >= MAX_BEACON_NUM || NULL == wrq || !VALID_MBSS(pAd, ap_idx)) {
		MTWF_DBG(pAd, DBG_CAT_ANDLINK, CATANDLINK_CFG, DBG_LVL_ERROR,
					"input apidx: %d > MAX_APCLI_NUM(%d) or wrq: %p\n",
...
static void Get_Sta_Stats(
	IN RTMP_ADAPTER * pAd,
	IN OUT struct wifi_sta_stats *staStats)
{
...
static void Get_Sta_Rates(
	IN RTMP_ADAPTER * pAd,
	IN OUT struct wifi_sta_rates *staRates)
{
	PMAC_TABLE_ENTRY pEntry = NULL;
...
static INT Get_BSS_AC_Statistics(
	IN RTMP_ADAPTER * pAd,
	IN INT ap_idx,
	OUT struct wifi_dev_ac_stats *pStat)
{
	BSS_STRUCT *pMbss;
	INT i;

	if (!VALID_MBSS(pAd, ap_idx)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Error AP index\n");
		return -EINVAL;
	}
...
static void Get_Accounting_Server(
	IN RTMP_ADAPTER * pAd,
	IN UINT ap_idx,
	OUT struct wifi_accounting_server *accounting_server)
{
	if (!VALID_MBSS(pAd, apidx)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Error AP index\n");
		return;
	...
	os_zero_mem(&accounting_server, sizeof(struct wifi_accounting_server));
	...
	IN INT cmd)
{
	...
	ifIndex = pObj->ioctl_if;
	if (ifIndex < 0) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "ifIndex =%d\n", ifIndex);
		return -EFAULT;
	}

	if ((pObj->ioctl_if_type == INT_MBSSID) || (pObj->ioctl_if_type == INT_MAIN)) {
		if ((ifIndex >= pAd->ApCfg.BssidNum) || (ifIndex >= MAX_BEACON_NUM))
			return -EFAULT;
	...
	switch (cmd) {
#ifdef CONFIG_MAP_SUPPORT
	case OID_SET_BH_ASSOC_CTRL:
		{
			if (wrq->u.data.length > 0) {
				UCHAR apIdx = pObj->ioctl_if;
				struct bh_assoc_disallow_info *bh_disallow_info  = &pAd->ApCfg.MBSSID[apIdx].bh_disallow_info;

				if (wrq->u.data.length != sizeof(struct bh_assoc_disallow_info)) {
					Status = EINVAL;
					break;
				}
				RTMPZeroMemory(bh_disallow_info, wrq->u.data.length);
				if (copy_from_user(bh_disallow_info, wrq->u.data.pointer, wrq->u.data.length))
					Status = -EFAULT;
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
	...
	case OID_802_11_GET_NF:
		{
			...
			if (wdev) {
				...
				Status = copy_to_user(wrq->u.data.pointer, &pAd->Avg_NF, wrq->u.data.length);
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
	...
	case OID_802_11_GET_ACS_CHANNEL_SCORE:
		{
			...
			if (wdev) {
				auto_ch_ctrl = HcGetAutoChCtrl(pAd);
				...
				for (channel_idx = 0; (channel_idx < channel_info->channel_list_num) && (channel_idx < ARRAY_SIZE(ch_score->acs_channel_score)); channel_idx++) {
				...
				if (Status != 0) {
					Status = RTMP_IO_EFAULT;
				    MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_ACS, DBG_LVL_ERROR,
						"OID_802_11_GET_ACS_CHANNEL_SCORE is failed\n");
				}
	...
	case OID_GET_AIR_MONITOR_RESULT:
		{
			...
			if (wdev) {
				...
				if (mnt_info == NULL) {
					MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
				...
				for (i = 0; i < MAX_NUM_OF_MONITOR_STA; i++) {
					...
					if (pTmpEntry->Count != 0 && pTmpEntry->Count < pAd->MntMaxPktCnt) {
						...
						MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR, "STA ["MACSTR"] packet received %lu and total rssi %ld avg rssi %d\n",
				...
				MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
						"Query::OID_GET_AIR_MONITOR_RESULT success!\n");
				os_free_mem(mnt_info);
			} else
				MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
						"OID_GET_AIR_MONITOR_RESULT get null wdev!\n");
		}
		break;
#endif
#endif
	...
	case OID_802_11_SET_IEEE8021X:
		MTWF_DBG(pAd, DBG_CAT_MLME, CATMLME_DOT1X, DBG_LVL_INFO,
			"Query::OID_802_11_SET_IEEE8021X\n");
		wrq->u.data.length = sizeof(INT);

		if ((ifIndex < MAX_MBSSID_NUM(pAd)) && IS_IEEE8021X_Entry(&pAd->ApCfg.MBSSID[ifIndex].wdev))
			IEEE8021X = 1;
		else
			IEEE8021X = 0;
	...
	case OID_GET_CPU_TEMPERATURE:{
		...
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "invalid wdev for cmd %d\n", cmd);
		break;
	}

	case OID_MTK_CHIP_ID:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "Query ChipID = %x\n", pAd->ChipID);
		wrq->u.data.length = sizeof(UINT32);
		Status = copy_to_user(wrq->u.data.pointer, &pAd->ChipID, sizeof(UINT32));
		break;

	case OID_MTK_DRVER_VERSION:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "Driver Version = %s\n", AP_DRIVER_VERSION);
	...
	case OID_MAX_NUM_OF_STA: {
		UINT16 MaxStaNum = GET_MAX_UCAST_NUM(pAd);
	...
	case OID_802_11_BSSID:
		...
		if (pObj->ioctl_if_type == INT_APCLI) {
			...
			MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_DEBUG,
	...
	case OID_802_11_SSID:
		...
		if (pObj->ioctl_if_type == INT_APCLI) {
			...
			Ssid.SsidLength = ((pApCliEntry->CfgSsidLen > ARRAY_SIZE(pApCliEntry->CfgSsid))  ?  ARRAY_SIZE(pApCliEntry->CfgSsid) : pApCliEntry->CfgSsidLen);
		...
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "Query OID_802_11_SSID (Len=%d, ssid=%s)\n", Ssid.SsidLength,
				 Ssid.Ssid);
		break;
	case OID_802_11_GET_SSID_BSSID: {
		...
		if (pObj->ioctl_if_type == INT_APCLI) {
			...
			if (wdev) {
				...
				for (i = 0; (i < ScanTab->BssNr) && (ScanTab->BssNr < MAX_LEN_OF_BSS_TABLE)
					&& (i < ARRAY_SIZE(scan_result.entry)); i++) {
					scan_entry = &scan_result.entry[i];
					scan_entry->ssid_len = ScanTab->BssEntry[i].SsidLen;
					if (scan_entry->ssid_len > ARRAY_SIZE(scan_entry->ssid))
						scan_entry->ssid_len = ARRAY_SIZE(scan_entry->ssid);

					NdisMoveMemory(scan_entry->ssid, ScanTab->BssEntry[i].Ssid, scan_entry->ssid_len);
	...
	case OID_802_11_RSSI: {
		...
		case OID_ANDLINK_STAINFO:
			if ((pObj->ioctl_if_type == INT_MAIN || pObj->ioctl_if_type == INT_MBSSID) &&
				wdev && HcGetBandByWdev(wdev) < CFG_WIFI_RAM_BAND_NUM &&
				TRUE == pAd->CommonCfg.andlink_enable) {
#ifdef ANDLINK_V4_0
	...
	case OID_802_11_CHANNEL_WIDTH: {
		if (wdev) {
			...
			Status = copy_to_user(wrq->u.data.pointer, &ulInfo, wrq->u.data.length);
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "Query::OID_802_11_CHANNEL_WIDTH (=%lu)\n", ulInfo);
		} else {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "invalid wdev for cmd %d\n", cmd);
		}
		break;
	}
	break;
	...
	case RT_OID_802_11_COUNTRY_REGION:
		...
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO,
			"Query::RT_OID_802_11_COUNTRY_REGION (=%lu)\n", ulInfo);
		break;
	...
	case OID_802_11_BEACON_PERIOD:
		...
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_BCN, DBG_LVL_INFO,
			"Query::OID_802_11_BEACON_PERIOD (=%lu)\n", ulInfo);
		break;

	case RT_OID_802_11_TX_POWER_LEVEL_1:
		wrq->u.data.length = sizeof(UINT8);
		ulInfo = pAd->CommonCfg.ucTxPowerPercentage;
		Status = copy_to_user(wrq->u.data.pointer,
			&pAd->CommonCfg.ucTxPowerPercentage, wrq->u.data.length);
		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_POWER, DBG_LVL_INFO,
			"Query::RT_OID_802_11_TX_POWER_LEVEL_1 (=%u)\n",
	...
	case RT_OID_802_11_PREAMBLE:
		...
		Status = copy_to_user(wrq->u.data.pointer, &ulInfo, wrq->u.data.length);
		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_PREAMBLE, DBG_LVL_INFO,
			"Query::RT_OID_802_11_PREAMBLE(=%lu)\n", pAd->CommonCfg.TxPreamble);
		break;
	...
	case OID_802_11_HT_STBC:
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_HT, DBG_LVL_INFO,
				"Query::OID_802_11_HT_STBC(=%lu)\n", ulInfo);
		} else
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_HT, DBG_LVL_ERROR,
				"invalid wdev for cmd %d\n", cmd);
	...
	case OID_802_11_UAPSD:
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_PS, CATPS_UAPSD, DBG_LVL_INFO,
				"Query::OID_802_11_UAPSD (=%d)\n", wdev->UapsdInfo.bAPSDCapable);
		} else
			MTWF_DBG(pAd, DBG_CAT_PS, CATPS_UAPSD, DBG_LVL_ERROR,
				"invalid wdev for cmd %d\n", cmd);
	...
	case OID_802_11_TX_PACKET_BURST:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"Query::OID_802_11_TX_PACKET_BURST (=%d)\n", pAd->CommonCfg.bEnableTxBurst);
		break;
	...
	case OID_802_11_AMPDU:
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_RX, CATRX_AMPDU, DBG_LVL_INFO,
				"Query::OID_802_11_AMPDU (=%lu)\n", ulInfo);
		} else {
			MTWF_DBG(pAd, DBG_CAT_RX, CATRX_AMPDU, DBG_LVL_ERROR,
				"invalid wdev for cmd %d\n", cmd);
		}
		break;
	...
	case RT_FT_DATA_DECRYPT: {
		...
		*/
		...
		case RT_FT_DATA_ENCRYPT:
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_FT, DBG_LVL_INFO,
				"Query::RT_FT_DATA_ENCRYPT\n");
			FT_KDP_DataEncrypt(pAd, (UCHAR *)pBuffer, &DataLen);
			break;

		case RT_FT_DATA_DECRYPT:
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_FT, DBG_LVL_INFO,
				"Query::RT_FT_DATA_DECRYPT\n");
	...
	case RT_OID_802_11R_INFO: {
		...
		if (pFtCfg->FtR0khIdLen > ARRAY_SIZE(pFtConfig->R0KHId))
			pFtCfg->FtR0khIdLen = ARRAY_SIZE(pFtConfig->R0KHId);
	...
	case RT_QUERY_WNM_CAPABILITY: {
		...
		pWNMCtrl = &pAd->ApCfg.MBSSID[apidx].WNMCtrl;
		TotalLen = wrq->u.data.length;
	...
	case RT_OID_WSC_QUERY_STATUS: {
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"Query::RT_OID_WSC_QUERY_STATUS\n");
#ifdef APCLI_SUPPORT

		if (pObj->ioctl_if_type == INT_APCLI) {
			UINT ApCliIdx = pObj->ioctl_if;

			if (ApCliIdx >= MAX_MULTI_STA)
				return -EFAULT;
	...
	case RT_OID_APCLI_WSC_PIN_CODE:
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"Query::RT_OID_APCLI_WSC_PIN_CODE\n");
		wrq->u.data.length = sizeof(UINT);
		if ((apidx >= MAX_MULTI_STA) || (apidx < 0))
			return -EFAULT;
	...
	case RT_OID_WSC_CONFIG_STATUS:
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"Query::RT_OID_WSC_CONFIG_STATUS\n");
		wrq->u.data.length = sizeof(UCHAR);
		if (!VALID_MBSS(pAd, apidx))
			return -EFAULT;
	...
	case RT_OID_WSC_QUERY_PEER_INFO_ON_RUNNING:
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"Query::RT_OID_WSC_QUERY_PEER_INFO_ON_RUNNING\n");
		if (!VALID_MBSS(pAd, apidx))
			return -EFAULT;
	...
	case RT_OID_WSC_FRAGMENT_SIZE:
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"Query::RT_OID_WSC_FRAGMENT_SIZE (=%d)\n",
	...
	case RT_OID_GET_LLTD_ASSO_TABLE:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"Query::Get LLTD association table\n");
		...
		if ((wrq->u.data.pointer == NULL) || (apidx != MAIN_MBSSID) ||
			...
			INT i;
			PRT_LLTD_ASSOICATION_TABLE	pAssocTab = NULL;
			struct _MAC_TABLE_ENTRY *entry;

			os_alloc_mem(pAd, (UCHAR **)&pAssocTab,
				sizeof(RT_LLTD_ASSOICATION_TABLE) + (sizeof(RT_LLTD_ASSOICATION_ENTRY) * WTBL_MAX_NUM(pAd)));
			if (pAssocTab == NULL) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"alloc mem fail\n");
				Status = -EFAULT;
			...
			for (i = 0; (VALID_UCAST_ENTRY_WCID(pAd, i) && (i < WTBL_MAX_NUM(pAd))); i++) {
				entry = entry_get(pAd, i);
				if (IS_ENTRY_CLIENT(entry) && (entry->Sst == SST_ASSOC)) {
					COPY_MAC_ADDR(
						pAssocTab->Entry[pAssocTab->Num].Addr, entry->Addr);
					pAssocTab->Entry[pAssocTab->Num].phyMode = pAd->ApCfg.MBSSID[apidx].wdev.PhyMode;
					pAssocTab->Entry[pAssocTab->Num].MOR = RateIdToMbps[pAd->ApCfg.MBSSID[apidx].MaxTxRate] * 2;
					pAssocTab->Num += 1;
				}
			}
			...
			if (copy_to_user(wrq->u.data.pointer, pAssocTab, wrq->u.data.length)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"copy_to_user() fail\n");
				Status = -EFAULT;
			}

			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "AssocTab.Num = %d\n", pAssocTab->Num);

			if (pAssocTab)
				os_free_mem(pAssocTab);
		}
	...
	case RT_OID_GET_REPEATER_AP_LINEAGE:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"Not Support : Get repeater AP lineage.\n");
		break;
#endif /* APCLI_SUPPORT */
#endif /* LLTD_SUPPORT */
#ifdef DOT1X_SUPPORT
	...
	case OID_802_11_WEPDEFAULTKEYVALUE:
		...
		if (valueLen > ARRAY_SIZE(pKeyIdxValue->Value))
			valueLen = ARRAY_SIZE(pKeyIdxValue->Value);

		os_zero_mem(&(pKeyIdxValue->Value), ARRAY_SIZE(pKeyIdxValue->Value));
	...
	case OID_802_11_WEPDEFAULTKEYID:
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_INFO, "DefaultKeyId =%d\n",
	...
	case OID_802_11_CURRENTCHANNEL:
		...
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "Status=%d\n", Status);
		break;
#endif
	...
	case OID_802_11_ACL_BLK_REJCT_COUNT_STATICS:
		{
			...
			if (Policy == 2)
				...
				for (count = 0; (count < pAd->ApCfg.MBSSID[apidx].AccessControlList.Num) && (count < ARRAY_SIZE(pAd->ApCfg.MBSSID[apidx].AccessControlList.Entry)); count++)
	...
	case OID_GEN_MEDIA_CONNECT_STATUS: {
		...
		tr_entry = tr_entry_get(pAd, pApCliEntry->MacTabWCID);
...
//#ifdef CONFIG_HOTSPOT
	...
	case OID_802_11_WNM_IPV4_PROXY_ARP_LIST: {
		...
		if (!VALID_MBSS(pAd, ifIndex)) {
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_WNM, DBG_LVL_ERROR, "error index\n");
			Status = -EINVAL;
			return FALSE;
		}
	...
	MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_WNM, DBG_LVL_INFO,
		"Query::OID_802_11_WNM_PROXY_ARP_LIST\n");
	break;
	...
	case OID_802_11_HS_OSU_SSID: {
		...
		Status = copy_to_user(wrq->u.data.pointer, pAd->ApCfg.MBSSID[ifIndex].Ssid,
							  pAd->ApCfg.MBSSID[ifIndex].SsidLen);
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"\033[1;32m %u OID_802_11_HS_OSU_SSID [%s]\033[0m\n",
			__LINE__, pAd->ApCfg.MBSSID[ifIndex].Ssid);
	...
	case OID_802_11_GET_STA_HSINFO: {
		...
		if (Buf) {
			...
			if (hs_consortium->sta_wcid >= WTBL_MAX_NUM(pAd)) {
				MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_ROAMING, DBG_LVL_ERROR,
					"error index\n");
				os_free_mem(Buf);
				Status = -EINVAL;
				return FALSE;
			}
			mac_entry = entry_get(pAd, hs_consortium->sta_wcid);

			if (mac_entry != NULL) {
				MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_ROAMING, DBG_LVL_INFO,
					"Roaming Consortium\n");
	...
	case OID_802_11_GET_DPP_FRAME:
		{
			if (pAd->bDppEnable) {
				...
				if (wdev)
					MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_ERROR,
						"GET_DPP_FRAME wdev idx %d\n", wdev->wdev_idx);
				if (copy_from_user(&frm_id, wrq->u.data.pointer, 4)) {
					MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_ERROR,
						"failed to copy_from_user\n");
					break;
				}
		...
		case OID_GET_CAC_CAP:
		{
			...
			if (wdev) {
				...
				bandIdx = HcGetBandByWdev(wdev);
				pDot11h = wdev->pDot11_H;
				if ((pDot11h == NULL) || (bandIdx >= HW_RDD_NUM))
					return FALSE;
	...
	case OID_GET_CHAN_LIST:
		{
			...
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
				"(sync) Msg received!\n");
			pAd->ChannelListNum = pChCtrl->ChListNum;
			for (i = 0; (i < pChCtrl->ChListNum) && (i < ARRAY_SIZE(pAd->ChannelList)); i++) {
				pAd->ChannelList[i].Channel = pChCtrl->ChList[i].Channel;
	...
	case OID_WF6_CAPABILITY:
		{
			...
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
				"WF6:Driver: OID_WF6_CAPABILITY is called from WAPP in driver\n");
...
#define WF6_APCLI_INFO 1
			...
			for (i = 0; (i < wf6_cap.role_supp) && (i < ARRAY_SIZE(wf6_cap.wf6_role)); i++) {
...
#endif
		tx_pwr.num_of_op_class = op_class->num_of_op_class;
		for (op = 0; (op < op_class->num_of_op_class && (op < ARRAY_SIZE(op_class->opClassInfo)) && (pwr_num < ARRAY_SIZE(tx_pwr.tx_pwr_limit))); op++) {
	...
	case OID_802_11_VOW_ATF_EN:
		...
		break;
	case OID_802_11_VOW_GROUP_MAX_RATIO:
		if (ifIndex < VOW_MAX_GROUP_NUM) {
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
				"Get OID_802_11_VOW_GROUP_MAX_RATIO, ifIndex=%d,max_airtime_ratio=%d\n",
	...
	case OID_802_11_VOW_GROUP_MIN_RATIO:
		if (ifIndex < VOW_MAX_GROUP_NUM) {
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_VOW, DBG_LVL_INFO,
				"Get OID_802_11_VOW_GROUP_MIN_RATIO,ifIndex=%d,min_airtime_ratio=%d\n",
	...
	{
		if (wdev) {
			wrq->u.data.length = sizeof(pAd->ApCfg.AcsCfg.ACSCheckTime);
			Status = copy_to_user(wrq->u.data.pointer, &pAd->ApCfg.AcsCfg.ACSCheckTime, wrq->u.data.length);
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_ACS, DBG_LVL_INFO,
				"ACS_REFRESH_PERIOD = %d\n", pAd->ApCfg.AcsCfg.ACSCheckTime);
		} else
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_ACS, DBG_LVL_ERROR,
				"Invalid wdev for cmd %d\n", cmd);
		break;
	...
	case OID_802_11_BW:
	{
		...
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "bw = %d\n", bw);
		} else
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"Invalid wdev for cmd %d\n", cmd);
		break;
	...
	case OID_802_11_EXTENSION_CHANNEL:
	{
		...
		if (wdev) {
			...
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "ext_cha = %d\n", ext_cha);
		} else
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"Invalid wdev for cmd %d\n", cmd);
		break;
	...
	case OID_802_11_IEEE80211H:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "bIEEE80211H = %d\n",
	...
	case OID_802_11_COUNTRYCODE:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "CountryCode = %s\n",
	...
	case OID_802_11_DTIMPERIOD:
		...
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_BCN, DBG_LVL_INFO, "DtimPeriod[%d] = %d\n", ifIndex,
	...
	case OID_802_11_TXPREAMBLE:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "TxPreamble = %ld\n",
			pAd->CommonCfg.TxPreamble);
		break;
	case OID_802_11_BASICRATE:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "BasicRateBitmap = %lx\n",
	...
	case OID_802_11_SUPPRATE:
	{
		...
		if (wdev) {
			...
			for (j = 0; j < wdev->rate.legacy_rate.sup_rate_len; j++)
				MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO, "sup_rate[%d] = %x\n", j,
	...
	case OID_802_11_RADIO_CHANNEL_LAST_CHANGE:
	{
		...
		MTWF_DBG(pAd, DBG_CAT_HW, CATHW_PHY, DBG_LVL_INFO,
			"OID_802_11_RADIO_CHANNEL_CHANGE_STATS\n");
		if (wdev)
			bandIdx = HcGetBandByWdev(wdev);
	...
	{
		struct nbr_diag_result result;

		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"OID_802_11_WIFI_DIAG_RESULT\n");
	...
	case OID_802_11_STA:
	{
		...
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "OID_802_11_STA\n");
		NdisZeroMemory(&sta, sizeof(sta));
		Status = copy_from_user(&sta, wrq->u.data.pointer, sizeof(sta));
		if (Status != NDIS_STATUS_SUCCESS) {
			MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR,
				"OID_802_11_STA copy_from_user error.\n");
			break;
		}
		if (Status == NDIS_STATUS_SUCCESS) {
	...
	case OID_802_11_AP:
	{
		struct wifi_ap ap_info;

		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO, "OID_802_11_AP\n");
	...
	case OID_802_11_SEC_REKEYING_INTERVAL:
		...
		if (wdev) {
			...
			Status = copy_to_user(wrq->u.data.pointer,
						...
						wrq->u.data.length);
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_INFO,
				"OID_802_11_SEC_REKEYING_INTERVAL=%ld\n",
				wdev->SecConfig.GroupReKeyInterval);
		} else
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_ERROR,
			"Invalid wdev for cmd %d\n", cmd);
	...
	{
		struct wifi_dev_ac ac[WMM_NUM_OF_AC];

		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_WMM, DBG_LVL_INFO, "OID_802_11_AP_AC\n");
		wrq->u.data.length = sizeof(ac);
		NdisZeroMemory(&ac, sizeof(ac));
		Status = Get_Dev_Ac(pAd, apidx, (struct wifi_dev_ac *)&ac);
		if (Status != NDIS_STATUS_SUCCESS)
			break;
	...
	{
		struct wifi_dev_ac_stats ac_stats[WMM_NUM_OF_AC];

		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_WMM, DBG_LVL_INFO,
			"OID_802_11_AP_AC_STATS\n");
		NdisZeroMemory(&ac_stats, sizeof(ac_stats));
		Status = Get_BSS_AC_Statistics(pAd, apidx, (struct wifi_dev_ac_stats *)&ac_stats);
		if (Status != NDIS_STATUS_SUCCESS) {
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_WMM, DBG_LVL_ERROR,
				"OID_802_11_STA_STATS error.\n");
			break;
		}
	...
	{
		struct wifi_accounting_server accounting_server;

		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"OID_802_11_ACCOUNTING\n");
	...
	case OID_802_11_ACCOUNTING_INTERIMINTERVAL:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"OID_802_11_ACCOUNTING_INTERIMINTERVAL=%d\n",
	...
	case OID_802_11_BCN_TX_CNT:
		wrq->u.data.length = sizeof(pAd->BcnCheckInfo.totalbcncnt);
		Status = copy_to_user(wrq->u.data.pointer, &pAd->BcnCheckInfo.totalbcncnt, wrq->u.data.length);
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_BCN, DBG_LVL_INFO,
			"OID_802_11_BCN_TX_CNT %d\n", pAd->BcnCheckInfo.totalbcncnt);
		break;
...
INT Set_ChGeography_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (Geography <= BOTH)
		...
		MTWF_PRINT("Set_ChannelGeography_Proc::(wrong setting. 0: Out-door, 1: in-door, 2: both)\n");
	...
	if ((VALID_MBSS(pAd, pObj->ioctl_if)) && (strlen(arg) <= MAX_LEN_OF_SSID)) {
		...
		if (!SSID_EQUAL(arg, strlen(arg), pMbss->Ssid, strlen(pMbss->Ssid))) {
			...
			for (i = 0; i < MAX_PMKID_COUNT; i++) {
				if ((pmkid_cache->BSSIDInfo[i].Valid == TRUE)
					&& MAC_ADDR_EQUAL(&pmkid_cache->BSSIDInfo[i].own_mac,
									pMbss->wdev.bssid)) {
					pmkid_cache->BSSIDInfo[i].Valid = FALSE;
...
INT Set_BasicRate_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_PRINT("%s::(BasicRateBitmap=0x%08lx)\n", __func__,
			 pAd->CommonCfg.BasicRateBitmap);
	return TRUE;
}
	...
	if ((BeaconPeriod >= 20) && (BeaconPeriod < 1024) && wdev) {
		...
		for (i = 0; i < WDEV_NUM_MAX; i++) {
			...
			if (tdev && (tdev->wdev_type == WDEV_TYPE_AP) && HcIsRadioAcq(tdev)) {
				...
				tdev->bss_info_argument.u8BssInfoFeature = BSS_INFO_BASIC_FEATURE;
				if (AsicBssInfoUpdate(pAd, &tdev->bss_info_argument) != NDIS_STATUS_SUCCESS)
					MTWF_PRINT("Fail to apply the bssinfo\n");
				}
			}

		MTWF_PRINT("(BeaconPeriod=%d)\n", pAd->CommonCfg.BeaconPeriod);
	}
	return success;
}
...
#ifdef ACTION_MONITOR_SUPPORT
INT	Set_ActionMon_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	RTMP_STRING *arg)
{
		pAd->bActionMonOn = (UINT16)os_str_tol(arg, 0, 10);
		MTWF_PRINT("(Monitor Action =%d)\n", pAd->bActionMonOn);
	return TRUE;
}
#endif
	...
	IN	RTMP_STRING		*arg)
{
	...
	if (pObj->ioctl_if < 0) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "invalid ioctl_if %d\n", pObj->ioctl_if);
		return FALSE;
	}
	...
	if ((idle_period >= 1) && (idle_period <= 0xffff)) {
		...
		UpdateBeaconHandler(pAd, wdev, BCN_REASON(BCN_UPDATE_IE_CHG));
		MTWF_PRINT("%s::(i/f %d) (MaxIdlePeriod=%d)\n",
				__func__, IfIdx, idle_period);

		ret = TRUE;
	} else {
		MTWF_PRINT("%s::(i/f %d) (ERROR! range 1 to 65535)\n",
				__func__, IfIdx);
...
INT mtk_cfg80211_set_bss_max_idle_period_proc(IN PRTMP_ADAPTER pAd, IN unsigned int idle_period)
{
	...
	if ((idle_period >= 1) && (idle_period <= 0xffff)) {
		...
		UpdateBeaconHandler(pAd, wdev, BCN_REASON(BCN_UPDATE_IE_CHG));
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"(i/f %d) (MaxIdlePeriod=%d)\n", IfIdx, idle_period);

		ret = TRUE;
	} else {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"(i/f %d) (ERROR! range 1 to 65535)\n", IfIdx);
	...
	IN	RTMP_STRING *arg)
{
	...
	if ((apidx >= pAd->ApCfg.BssidNum) || apidx >= MAX_BEACON_NUM)
		return FALSE;
	...
	if (wlan_config_get_ch_band(wdev) != CMD_CH_BAND_24G) {
		MTWF_PRINT("5/6G only support slottime 9us\n");
		return FALSE;
	}
	SlotTime = (UINT8) os_str_tol(arg, 0, 10);
	if ((SlotTime < 9) || (SlotTime > 25)) {
		MTWF_PRINT("Invalid arguments! 9~25\n");
		return FALSE;
	}

	pAd->CommonCfg.bUseShortSlotTime = (SlotTime == 9) ? TRUE : FALSE;
	pAd->CommonCfg.SlotTime = SlotTime;
	HW_SET_SLOTTIME(pAd, pAd->CommonCfg.bUseShortSlotTime, wdev->channel, wdev);
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_PRINT("IF(ra%d) %s::(NoForwarding=%ld)\n",
			 ifIndex, __func__, pAd->ApCfg.MBSSID[ifIndex].IsolateInterStaTraffic);
	return TRUE;
}
...
#endif /* WSC_V2_SUPPORT */
	MTWF_PRINT("IF(ra%d) (HideSSID=%d)\n", ifIndex, pAd->ApCfg.MBSSID[ifIndex].bHideSsid);
	return TRUE;
}
...
INT Show_VLAN_GTK_Info_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_PRINT("VLAN interface hooked on %s:\n", wdev->if_dev->name);
	list_for_each(listptr, &wdev->vlan_gtk_list) {
		vg_info = list_entry(listptr, struct vlan_gtk_info, list);

		MTWF_PRINT("ifname=%s vlan_id=%d vlan_bmc_wcid=%d gtk_hexdump=",
			vg_info->vlan_dev->name, vg_info->vlan_id, vg_info->vlan_bmc_idx);
		for (i = 0; i < vg_info->gtk_len; i++)
			MTWF_PRINT("%2x ", vg_info->vlan_gtk[i]);

		MTWF_PRINT("\n");

	}

	MTWF_PRINT("STAs which are in VLAN:\n");

	for (i = 0; i < WTBL_MAX_NUM(pAd); i++) {
		PMAC_TABLE_ENTRY pEntry = &pAd->MacTab->Content[i];

		if (pEntry->vlan_id > 0) {
			MTWF_PRINT("%02x:%02x:%02x:%02x:%02x:%02x vlan_id %d:\n",
...
struct wifi_dev *QueryWdevFromIfParam(IN PRTMP_ADAPTER	pAd, UINT ifIndex, UINT if_type)
{
	struct wifi_dev *wdev = NULL;
	...
	if (if_type == INT_MAIN || if_type == INT_MBSSID) {
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_WARN, "Unexpected if_type\n");
	return wdev;
}
VOID ConfigVlanTag(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, USHORT param)
{
	if (param > VLANTAG) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Invalid VLANTAG\n");
		return;
	}
	if (wdev->bVLAN_Tag == param) {/*configed, do nothing*/
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO,
			"Redundant Val[%d]\n", param);
		return;
	}
	wdev->bVLAN_Tag = param;
	MTWF_PRINT("configure(%s)bVLAN_Tag=%d\n",
		RtmpOsGetNetDevName(wdev->if_dev), wdev->bVLAN_Tag);
}
VOID ConfigVlanID(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, USHORT param)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);

	if (param > MAX_VID) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Invalid VID\n");
		return;
	}
	if (wdev->VLAN_VID == param) {/*configed, do nothing*/
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO,
			"Redundant Val[%d]\n", param);
		return;
	}
	...
	if (cap->vlan_rx_tag_mode == VLAN_RX_TAG_HW_MODE)
		asic_update_vlan_id(pAd, HcGetBandByWdev(wdev), wdev->OmacIdx, param);
	MTWF_PRINT("configure(%s)VLAN_VID=%d\n",
		RtmpOsGetNetDevName(wdev->if_dev), wdev->VLAN_VID);
}
VOID ConfigVlanPriority(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, USHORT param)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);

	if (param > MAX_PCP) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Invalid PCP\n");
		return;
	}
	if (wdev->VLAN_Priority == param) {/*configed, do nothing*/
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO,
			"Redundant Val[%d]\n", param);
		return;
	}
	wdev->VLAN_Priority = param;
	if (cap->vlan_rx_tag_mode == VLAN_RX_TAG_HW_MODE)
		asic_update_vlan_priority(pAd, HcGetBandByWdev(wdev), wdev->OmacIdx, param);
	MTWF_PRINT("configure(%s)VLAN_Priority=%d\n",
		RtmpOsGetNetDevName(wdev->if_dev), wdev->VLAN_Priority);
}
VOID ConfigVlanTxPolicy(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, USHORT param)
{
	if (param >= VLAN_TX_POLICY_NUM) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Invalid TxPolicy\n");
		return;
	}
	if (wdev->VLAN_Policy[TX_VLAN] == param) {/*configed, do nothing*/
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO,
			"Redundant Val[%d]\n", param);
		return;
	}
	wdev->VLAN_Policy[TX_VLAN] = param;
	MTWF_PRINT("configure(%s)VLAN_Policy_TX=%d\n",
		RtmpOsGetNetDevName(wdev->if_dev), wdev->VLAN_Policy[TX_VLAN]);
}
VOID VlanRxPolicyToFw(IN PRTMP_ADAPTER pAd, USHORT param)
{
	RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
...
VOID ConfigVlanRxPolicy(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, USHORT param)
{
	INT if_idx;

	if (param >= VLAN_RX_POLICY_NUM) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Invalid RxPolicy\n");
		return;
	}
	if (wdev->VLAN_Policy[RX_VLAN] == param) {/*configed, do nothing*/
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_INFO,
			"Redundant Val[%d]\n", param);
		return;
	}
	wdev->VLAN_Policy[RX_VLAN] = param;
	VlanRxPolicyToFw(pAd, param);
	/*
	For now, VLAN Rx Policy is HW-supported,
	so we have to sync the setting to all of the wdev on the pAd.
	*/
	for (if_idx = 0; VALID_MBSS(pAd, if_idx); if_idx++)
		pAd->ApCfg.MBSSID[if_idx].wdev.VLAN_Policy[RX_VLAN] = param;
#ifdef CONFIG_STA_SUPPORT
	for (if_idx = 0; if_idx < MAX_MULTI_STA; if_idx++)
		pAd->StaCfg[if_idx].wdev.VLAN_Policy[RX_VLAN] = param;

#endif /* CONFIG_STA_SUPPORT */
	MTWF_PRINT("configure(%s)VLAN_VLAN_Policy_RX=%d\n",
		RtmpOsGetNetDevName(wdev->if_dev), wdev->VLAN_Policy[RX_VLAN]);
}
/*
@pAd: Global parameters
@wdev:which wifi device to be configerd
@type:enum VLAN_PARAM members.
@param:vlan parameters to set.
Return Value: VOID.
*/
VOID ProcessVlanParam(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, enum VLAN_PARAM type, USHORT param)
{
	if (!wdev) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR, "Wdev Null!\n");
		return;
	}
	if (type == VLAN_TAG)
		ConfigVlanTag(pAd, wdev, param);
	else if (type == VLAN_ID)
		ConfigVlanID(pAd, wdev, param);
	else if (type == VLAN_PRIO)
		ConfigVlanPriority(pAd, wdev, param);
	else if (type == VLAN_POLICY_TX)
		ConfigVlanTxPolicy(pAd, wdev, param);
	else if (type == VLAN_POLICY_RX)
		ConfigVlanRxPolicy(pAd, wdev, param);
	else
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_ERROR,
			"configure(%s) Parameters Error!\n", RtmpOsGetNetDevName(wdev->if_dev));
}
/*
@pAd: Global parameters
@wdev:which wifi device to be configerd
...
BOOLEAN APMloVlanParamProcessed(IN PRTMP_ADAPTER	pAd, struct wifi_dev *wdev, enum VLAN_PARAM type, UINT32 param)
{
	BSS_STRUCT *pMbss = NULL;
	struct wifi_dev *wdev_mlo = NULL;
	UCHAR group_id = 0;
	UCHAR link_id = 0;
	...
	/*None Mlo*/
	if (!pMbss
		|| bss_mngr_is_wdev_in_mlo_group(wdev) == FALSE)
		return FALSE;
	group_id = pMbss->mld_grp_idx;
	for (link_id = 0; link_id < BSS_MNGR_MAX_BAND_NUM; link_id++) {
		wdev_mlo = bss_mngr_query_group_wdev_by_link(group_id, link_id);
		if (wdev_mlo == NULL)
			continue;
		ProcessVlanParam(pAd, wdev_mlo, type, param);
	}
	MTWF_PRINT("%s()Done!\n", __func__);
	return TRUE;
}
...
@FALSE:Not Processed
*/
BOOLEAN STAMloVlanParamProcessed(IN PRTMP_ADAPTER	pAd, struct wifi_dev *wdev, enum VLAN_PARAM type, UINT32 param)
{
	struct wifi_dev *wdev_mlo = NULL;
	UCHAR idx = 0;
	struct mld_dev *sta_mld = NULL;
	...
	if ((wdev->wdev_type != WDEV_TYPE_STA)
		...
		return FALSE;
	sta_mld = wdev->mld_dev;
	if (!sta_mld || (sta_mld != &mld_device))
		return FALSE;
	if (sta_mld->valid_link_num == 0) {
		MTWF_PRINT("%s()No STA MLD members!\n", __func__);
		return FALSE;
	}
	for (idx = 0; idx < MLD_LINK_MAX; idx++) {
		if (sta_mld->mld_own_links[idx].used) {
			wdev_mlo = sta_mld->mld_own_links[idx].wdev;
			if (!wdev_mlo)
				continue;
			ProcessVlanParam(pAd, wdev_mlo, type, param);
		}
...
@FALSE:Not Processed
*/
BOOLEAN LegacyDevVlanParamProcessed(IN PRTMP_ADAPTER pAd, struct wifi_dev *wdev, enum VLAN_PARAM type, UINT32 param)
{
	if (!wdev)
		return FALSE;
	ProcessVlanParam(pAd, wdev, type, param);
	MTWF_PRINT("%s()Done!\n", __func__);
	return TRUE;
}
	...
	IN	RTMP_STRING *arg)
{
	...
	if (if_type == INT_MAIN || if_type == INT_MBSSID) {
		if (ifIndex < MAX_BEACON_NUM)
			...
			MTWF_PRINT("invalid MBSS index %d\n", ifIndex);
	} else if (if_type == INT_APCLI) {
#ifdef CONFIG_STA_SUPPORT
		if (ifIndex < MAX_MULTI_STA)
			wdev = &pAd->StaCfg[ifIndex].wdev;
...
#endif /* CONFIG_STA_SUPPORT */
			MTWF_PRINT("invalid APCLI index %d\n", ifIndex);
	} else if (if_type == INT_WDS) {
#ifdef WDS_SUPPORT
		if (ifIndex < MAX_WDS_ENTRY)
			wdev = &pAd->WdsTab.WdsEntry[ifIndex].wdev;
		else
			MTWF_PRINT("invalid WDS index %d\n", ifIndex);
#endif /* WDS_SUPPORT */
	} else {
		MTWF_PRINT("Unexpected if_type\n");
		return FALSE;
	}
...
INT	Set_VLAN_TAG_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (if_type == INT_MAIN || if_type == INT_MBSSID) {
		...
		if (!wdev)
			return FALSE;
		ucBssIndex = wdev->bss_info_argument.ucBssIndex;
		u2WlanIdx = wdev->tr_tb_idx;
	} else if (if_type == INT_APCLI) {
#ifdef CONFIG_STA_SUPPORT
		if (ifIndex < MAX_MULTI_STA)
			wdev = &pAd->StaCfg[ifIndex].wdev;
		...
		if (!wdev)
			return FALSE;
		ucBssIndex = wdev->BssIdx;
		u2WlanIdx = pAd->StaCfg[ifIndex].MacTabWCID;
	} else if (if_type == INT_WDS) {
#ifdef WDS_SUPPORT
		if (ifIndex < MAX_WDS_ENTRY)
			wdev = &pAd->WdsTab.WdsEntry[ifIndex].wdev;
	...
	if (wlan_operate_get_state(wdev) == WLAN_OPER_STATE_INVALID) {
		MTWF_PRINT("Interface WLAN_OPER_STATE_INVALID, Skip VLAN Tag setting\n");
		return FALSE;
	}
	wdev->bVLAN_Tag = bVLAN_Tag;
	if (!IS_ASIC_CAP(pAd, fASIC_CAP_MCU_OFFLOAD))
		return TRUE;
	/*run time config BMC vlan starec.*/
	HW_VLAN_BMC_VLANTAG_SET(pAd, ucBssIndex, u2WlanIdx);
	return TRUE;
}
...
INT Set_VLAN_Policy_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (wlan_operate_get_state(wdev) == WLAN_OPER_STATE_INVALID) {
		MTWF_PRINT("Interface WLAN_OPER_STATE_INVALID, Skip VLAN Policy setting\n");
		return FALSE;
	}
	...
	MTWF_PRINT("Set the VLAN checking policy : %d\n",
	...
	if (dir == RX_VLAN) {
		...
		for (if_idx = 0; if_idx < MAX_MBSSID_NUM(pAd); if_idx++)
...
/*
    ...
    ==========================================================================
*/
VOID get_vlan_conf_by_wdev(struct wifi_dev *wdev)
{
...
INT Show_VLAN_Info_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	ifIndex = pObj->ioctl_if;
	if_type = pObj->ioctl_if_type;
	wdev = QueryWdevFromIfParam(pAd, ifIndex, if_type);
	if (!wdev)
		return -EFAULT;
	MTWF_PRINT("VLANEn=%d\n", pAd->CommonCfg.bEnableVlan);
	get_vlan_conf_by_wdev(wdev);
	return TRUE;
}
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_Set_VLANEn_Proc(RTMP_ADAPTER *pAd, UCHAR vlan_en)
{
	pAd->CommonCfg.bEnableVlan = vlan_en;
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_NOTICE, "(vlan_en=%d)\n",
			 pAd->CommonCfg.bEnableVlan);
	return 0;
}

INT	mtk_cfg80211_Set_VLANID_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	UINT16 vlan_id)
{
	POS_COOKIE pObj = (POS_COOKIE) pAd->OS_Cookie;
	...
	if (!wdev)
		return -EFAULT;
	/*Handle AP MLO case*/
	ret = APMloVlanParamProcessed(pAd, wdev, VLAN_ID, vlan_id);
	if (ret == TRUE)
		return 0;
	/*Handle STA MLO case*/
	ret = STAMloVlanParamProcessed(pAd, wdev, VLAN_ID, vlan_id);
	if (ret == TRUE)
		return 0;
	/*Handle AP/STA Legacy case*/
	ret = LegacyDevVlanParamProcessed(pAd, wdev, VLAN_ID, vlan_id);
	if (ret == TRUE)
		return 0;
	else
		return -EFAULT;
...
INT	mtk_cfg80211_Set_VLANPriority_Proc(RTMP_ADAPTER *pAd, UINT8 vlan_priority)
{
	...
	if (!wdev)
		return -EFAULT;
	/*Handle AP MLO case*/
	ret = APMloVlanParamProcessed(pAd, wdev, VLAN_PRIO, vlan_priority);
	if (ret == TRUE)
		return 0;
	/*Handle STA MLO case*/
	ret = STAMloVlanParamProcessed(pAd, wdev, VLAN_PRIO, vlan_priority);
	if (ret == TRUE)
		return 0;
	/*Handle AP/STA Legacy case*/
	ret = LegacyDevVlanParamProcessed(pAd, wdev, VLAN_PRIO, vlan_priority);
	if (ret == TRUE)
		return 0;
	else
		return -EFAULT;
...
INT	mtk_cfg80211_Set_VLAN_TAG_Proc(RTMP_ADAPTER *pAd, UCHAR vlan_tag)
{
	...
	if (!wdev)
		return -EFAULT;
	/*Handle AP MLO case*/
	ret = APMloVlanParamProcessed(pAd, wdev, VLAN_TAG, bVLAN_Tag);
	if (ret == TRUE)
		goto end;
	/*Handle STA MLO case*/
	ret = STAMloVlanParamProcessed(pAd, wdev, VLAN_TAG, bVLAN_Tag);
	if (ret == TRUE)
		goto end;
	/*Handle AP/STA Legacy case*/
	ret = LegacyDevVlanParamProcessed(pAd, wdev, VLAN_TAG, bVLAN_Tag);
	if (ret == TRUE)
		goto end;
	else
		return -EFAULT;
	...
	if (wdev->if_up_down_state == 0)
		return 0;
	ucBssIndex = hc_get_bssidx(wdev);
	u2WlanIdx = HcAcquireGroupKeyWcid(pAd, wdev, FALSE);
	/*run time config BMC vlan starec.*/
	HW_VLAN_BMC_VLANTAG_SET(pAd, ucBssIndex, u2WlanIdx);
	return 0;
}
...
INT mtk_cfg80211_Set_VLAN_Policy_Proc(RTMP_ADAPTER *pAd, UINT32 vlan_dir, UINT32 vlan_policy)
{
	...
	if_type = pObj->ioctl_if_type;
	if (vlan_dir > RX_VLAN) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PROFILE, DBG_LVL_WARN, "Invalid argument\n");
		return -EFAULT;
	}
	dir = (vlan_dir == TX_VLAN) ? VLAN_POLICY_TX : VLAN_POLICY_RX;
	wdev = QueryWdevFromIfParam(pAd, ifIndex, if_type);
	if (!wdev)
		return -EFAULT;
	/*Handle AP MLO case*/
	ret = APMloVlanParamProcessed(pAd, wdev, dir, vlan_policy);
	if (ret == TRUE)
		return 0;
	/*Handle STA MLO case*/
	ret = STAMloVlanParamProcessed(pAd, wdev, dir, vlan_policy);
	if (ret == TRUE)
		return 0;
	/*Handle AP/STA Legacy case*/
	ret = LegacyDevVlanParamProcessed(pAd, wdev, dir, vlan_policy);
	if (ret == TRUE)
		return 0;
	else
		return -EFAULT;
	...
	IN	RTMP_STRING *arg)
{
	...
	if ((apidx >= pAd->ApCfg.BssidNum) || (apidx >= MAX_BEACON_NUM)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "invalid ioctl_if %d\n", apidx);
		return FALSE;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
		"Cannot set RekeyInterval since CFG80211 support!\n");
	return TRUE;
#endif /* RT_CFG80211_SUPPORT */
}
	...
	IN  RTMP_STRING *arg)
{
	...
	*/
	...
	if ((input >= 0) && (input <= 15) && VALID_MBSS(pAd, apidx))
		pAd->ApCfg.MBSSID[apidx].TxPwrAdj = input;
	else
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"AP[%d]->PktPwr: Out of Range\n");

	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "AP[%d]->PktPwr: %d\n", apidx,
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "I/F(%s%d) GroupKey ReKeyMethod=%x\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "I/F(ra%d) %ld\n",
	...
	IN  RTMP_STRING *arg)
{
	...
	if (rssi == 0)
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
			"Disable AP_ASSOC_REQ_RSSI_THRESHOLD\n");
	else if (rssi > 0 || rssi < -100) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "Value Error.\n");
		return FALSE;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "I/F(ra%d) %d\n",
		apidx, pAd->ApCfg.MBSSID[apidx].AssocReqRssiThreshold);
...
INT mtk_cfg80211_Set_AP_ASSOC_REQ_RSSI_THRESHOLD(RTMP_ADAPTER *pAd, CHAR rssi)
{
	...
	if (rssi == 0)
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Value Error.\n");
		return FALSE;
	}
	if (apidx >= MAX_BEACON_NUM) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "invalid ioctl_if %d\n", apidx);
	...
	pAd->ApCfg.MBSSID[apidx].AssocReqRssiThreshold = rssi;
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
			"I/F(ra%d) Set_AP_ASSOC_REQ_RSSI_THRESHOLD=%d\n", apidx,
			 pAd->ApCfg.MBSSID[apidx].AssocReqRssiThreshold);

	for (j = BSS0; j < pAd->ApCfg.BssidNum; j++)
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "%d. ==> %d\n",
			j, pAd->ApCfg.MBSSID[j].AssocReqRssiThreshold);
	...
	IN  RTMP_STRING *arg)
{
	...
	if (rssi == 0)
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
			"Disable RssiLowForStaKickOut Function\n");
	else if (rssi > 0 || rssi < -100) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"RssiLowForStaKickOut Value Error.\n");
		return FALSE;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
		"I/F(ra%d) RssiLowForStaKickOut=%d\n", apidx,
	...
	IN	RTMP_STRING *arg)
{
	...
	if (os_str_tol(arg, 0, 10) != 2) {
		...
		for (count = 0; (count < pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Num) &&
			(count < ARRAY_SIZE(pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Entry)); count++)
...
#endif
	default: /*Invalid argument */
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "Invalid argument (=%s)\n", arg);
		return FALSE;
	}
	...
	IN	RTMP_STRING *arg)
{
	...
	if (pacl == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "Allocate memory fail!\n");
		return FALSE;
	}
	...
	while ((this_char = strsep((char **)&arg, ";")) != NULL) {
		...
		if (strlen(this_char) != 17) { /*Mac address acceptable format 01:02:03:04:05:06 length 17 */
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
				"illegal MAC address length!\n");
			continue;
		}

		for (i = 0, value = rstrtok(this_char, ":"); value && (i < ARRAY_SIZE(macAddr)); value = rstrtok(NULL, ":")) {
		...
		for (j = 0; (j < pacl->Num) && (j < ARRAY_SIZE(pacl->Entry)); j++) {
		...
		if (pacl->Num == MAX_NUM_OF_ACL_LIST) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN,
					 "The AccessControlList is full, and no more entry can join the list!\n");
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN, "The last entry of ACL is "MACSTR"\n",
					 MAC2STR(macAddr));
			break;
		}
	}
	...
	for (i = 0; i < pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Num; i++) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Entry #%02d: ", i + 1);
	...
	IN	RTMP_STRING *arg)
{
	...
	for (j = 0; (j < pacl->Num) && (j < ARRAY_SIZE(pacl->Entry)) &&
		(i < ARRAY_SIZE(pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Entry)); j++) {
	...
	/* check if the change in ACL affects any existent association */
	ApUpdateAccessControlList(pAd, ifIndex);
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Policy=%ld, Entry#=%ld\n",
		pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Policy,
		pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Num);
#ifdef DBG
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
	...
	IN	RTMP_STRING *arg)
{
	...
	if (bDumpAll == 1)
		...
		bDumpAll = FALSE;
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN, "Your input is 0!\n");
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN,
			"The Access Control List will not be dumped!\n");
		return TRUE;
	} else {
		return FALSE;  /* Invalid argument */
	}
	...
	if (pacl->Policy < ARRAY_SIZE(pACL_PolicyMessage)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
	...
	for (i = 0; (i < pacl->Num) && (i < ARRAY_SIZE(pacl->Entry)); i++) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
				 "Entry #%02d: ", i + 1);
	...
	IN	RTMP_STRING *arg)
{
	...
	if (bClearAll == 1)
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN, "Your input is 0!\n");
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN,
			"The Access Control List will be kept unchanged!\n");
		return TRUE;
	} else {
		return FALSE;  /* Invalid argument */
	}
	...
	do {
		if (pacl->Num <= ARRAY_SIZE(pacl->Entry)) {
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Set (Policy=%ld, Entry#=%ld)\n",
			 pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Policy,
			 pAd->ApCfg.MBSSID[ifIndex].AccessControlList.Num);
	return TRUE;
}
	...
	IN	RTMP_STRING *arg)
{
	...
	if (strcmp(arg, "1") == 0)
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "Alg isn't defined\n");
		return FALSE;
	}
...
INT Set_PartialScan_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((pObj->ioctl_if_type == INT_MAIN) || (pObj->ioctl_if_type == INT_MBSSID)) {
		...
		for (mbss_idx = 0; (mbss_idx < pAd->ApCfg.BssidNum) && mbss_idx < MAX_BEACON_NUM; mbss_idx++) {
...
INT Set_Scan_SkipList_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	tmp = buf;
	strlcpy(buf, arg, strlen(arg)*sizeof(RTMP_STRING)-1);
	while (strsep(&buf, ":"))
		skiplist_cnt++;
...
INT show_scan_info_proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_PRINT("Scan is %srunning on wdev(%d).\n",
		ScanInfo->scan_running ? "" : "Not ", wdev->BssIdx);
...
INT Set_AutoChannelSelCheckTime_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((pObj->ioctl_if_type == INT_MBSSID) || (pObj->ioctl_if_type == INT_MAIN)) {
		...
		pAutoChCtrl->AutoChSelCtrl.ACSCheckCount = 0;/* Reset counter */
		MTWF_PRINT("\x1b[42m: ACSCheckTime[%d]=%u seconds\x1b[m\n",
				  BandIdx, pAd->ApCfg.AcsCfg.ACSCheckTime);
	} else {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
...
static INT show_apcfg_info(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (pObj == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "pObj is NULL\n");
		return FALSE;
	}
	...
	wdev = &pAd->ApCfg.MBSSID[ifIndex].wdev;
	if (wdev == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "wdev is NULL\n");
		return FALSE;
	}

	BandIdx = HcGetBandByWdev(wdev);
	MTWF_PRINT("%-24s%-16s%-8s\n", " ", "WIFI_DRIVER", "PEAK_VALUE");
	/*WirelessMode*/
	wmode = wdev->PhyMode;
	...
	apcfg_para_setting.tx_power_percentage = pAd->CommonCfg.ucTxPowerPercentage;
	MTWF_PRINT("%-24s%-16lu%lu\n", "TxPower",
			  apcfg_para_setting.tx_power_percentage,
			  apcfg_for_peak.tx_power_percentage);
	apcfg_para_setting.wifi_cert = pAd->CommonCfg.wifi_cert;
	MTWF_PRINT("%-24s%-16d%d\n", "WifiCert",
			  apcfg_para_setting.wifi_cert,
			  apcfg_for_peak.wifi_cert);
	/*TxPreamble*/
...
#ifdef DOT11_HE_AX
	/*HE_TxStream */
	apcfg_para_setting.ht_tx_streams = wlan_config_get_he_tx_nss(wdev);
	MTWF_PRINT("%-24s%-16d%d\n", "HE_TxStream",
			  apcfg_para_setting.ht_tx_streams,
			  apcfg_for_peak.ht_tx_streams);
	/*HE_RxStream */
	apcfg_para_setting.ht_rx_streams = wlan_config_get_he_rx_nss(wdev);
	MTWF_PRINT("%-24s%-16d%d\n", "HE_RxStream",
			  apcfg_para_setting.ht_rx_streams,
			  apcfg_for_peak.ht_rx_streams);
#endif
#ifdef DOT11_EHT_BE
	/*EHT_TxStream */
	apcfg_para_setting.ht_tx_streams = wlan_config_get_eht_tx_nss(wdev);
	MTWF_PRINT("%-24s%-16d%d\n", "EHT_TxStream",
			  apcfg_para_setting.ht_tx_streams,
			  apcfg_for_peak.ht_tx_streams);
	/*EHT_RxStream */
...
#ifdef MT_BAND4_DFS_SUPPORT
	/*Band4DfsEnable*/
	if (WMODE_CAP_5G(wmode)) {
		apcfg_para_setting.band4DfsEnable = pAd->CommonCfg.DfsParameter.band4DfsEnable;
		MTWF_PRINT("%-24s%-16d%d\n", "Band4DfsEnable",
				apcfg_para_setting.band4DfsEnable,
				apcfg_for_peak.band4DfsEnable);
		}
#endif
#endif
#ifdef BACKGROUND_SCAN_SUPPORT
...
#ifdef DOT11_HE_AX
	/*HE_BW*/
	apcfg_para_setting.conf_he_bw = wlan_config_get_he_bw(wdev);
	apcfg_para_setting.oper_he_bw = wlan_operate_get_he_bw(wdev);
	MTWF_PRINT("%-24s%-16d%d\n", "HE_BW(config)",
		apcfg_para_setting.conf_he_bw,
		(WMODE_CAP_AX_6G(wmode) ? HE_BW_160 :
		(WMODE_CAP_AX_5G(wmode) ? HE_BW_160 : HE_BW_2040)));
	MTWF_PRINT("%-24s%-16d%d\n", "HE_BW(operate)",
		apcfg_para_setting.oper_he_bw,
		(WMODE_CAP_AX_6G(wmode) ? HE_BW_160 :
		(WMODE_CAP_AX_5G(wmode) ? HE_BW_160 : HE_BW_2040)));
#endif
...
#ifdef DOT11_EHT_BE
	/*EHT_BW*/
	apcfg_para_setting.conf_eht_bw = wlan_config_get_eht_bw(wdev);
	apcfg_para_setting.oper_eht_bw = wlan_operate_get_eht_bw(wdev);
	MTWF_PRINT("%-24s%-16d%d\n", "EHT_BW(config)",
		apcfg_para_setting.conf_eht_bw,
		(WMODE_CAP_BE_6G(wmode) ? EHT_BW_320 :
		(WMODE_CAP_BE_5G(wmode) ? EHT_BW_160 : EHT_BW_2040)));
	MTWF_PRINT("%-24s%-16d%d\n", "EHT_BW(operate)",
		apcfg_para_setting.oper_eht_bw,
		(WMODE_CAP_BE_6G(wmode) ? EHT_BW_320 :
		(WMODE_CAP_BE_5G(wmode) ? EHT_BW_160 : EHT_BW_2040)));
	MTWF_PRINT("-----------------------------------------------------\n");
	MTWF_PRINT("%-24s%-16d\n", "EHT_dscb", wlan_config_get_eht_dscb_enable(wdev));
	MTWF_PRINT("%-24s0x%-16x\n", "EHT_dsc_bitmap", wlan_config_get_eht_dis_subch_bitmap(wdev));
	MTWF_PRINT("%-24s%-16d\n", "EHT_csa_dscb", wlan_config_get_eht_csa_dscb_enable(wdev));
	MTWF_PRINT("%-24s0x%-16x\n", "EHT_csa_dsc_bitmap", wlan_config_get_eht_csa_dis_subch_bitmap(wdev));
#endif
...
INT Show_Radio_Stat_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	COUNTER_802_11 *pWlanCounters = &pAd->WlanCounters;
	INT64 TxMgmtRetryCnt, RxDupDropCount, RxBaCnt, RTSTotalCnt, RTSFailureCount, MultipleRetryCount;
	INT64 ACKFailureCount, TxAmpduCnt, TxAbortCnt, TxMpduRetryDropCnt, TxRtsDropCnt, TxCtrlCnt;
	INT64 RxBeaconCnt, RxPhy2MacLenMismatchCount, TxBaCnt, RTSSuccessCount, RxFifoFullCount;
	INT64 RxDelimiterFailCount, RxOutOfRangeCount, RxFilterDropMpduCount, RxFcsErrorCount;
	INT64 RxMpduCount, RxMpduInAmpduCount, RxFcsOkCount, TxBcnCount;

	if (ctrl->rdev.pRadioCtrl->Last1TxCnt && ctrl->rdev.pRadioCtrl->Last1TxFailCnt)
		ctrl->rdev.pRadioCtrl->Last1SecPER =
			((100 * (ctrl->rdev.pRadioCtrl->Last1TxFailCnt))/
	...
	TxMgmtRetryCnt =
			...
			pWlanCounters->LastTxMgmtRetryCnt.QuadPart;
	RxDupDropCount =
			pWlanCounters->RxDupDropCount.QuadPart -
			pWlanCounters->LastRxDupDropCount.QuadPart;
	RxBaCnt =
			pWlanCounters->RxBaCnt.QuadPart -
			pWlanCounters->LastRxBaCnt.QuadPart;
	RTSTotalCnt =
			pWlanCounters->RTSTotalCnt.QuadPart -
			pWlanCounters->LastRTSTotalCnt.QuadPart;
	RTSFailureCount =
			pWlanCounters->RTSFailureCount.QuadPart -
			pWlanCounters->LastRTSFailureCount.QuadPart;
	MultipleRetryCount =
			pWlanCounters->MultipleRetryCount.QuadPart -
			pWlanCounters->LastMultipleRetryCount.QuadPart;
	ACKFailureCount =
			pWlanCounters->ACKFailureCount.QuadPart -
			pWlanCounters->LastACKFailureCount.QuadPart;
	TxAmpduCnt =
			pWlanCounters->TxAmpduCnt.QuadPart -
			pWlanCounters->LastTxAmpduCnt.QuadPart;
	TxAbortCnt =
			pWlanCounters->TxAbortCnt.QuadPart -
			pWlanCounters->LastTxAbortCnt.QuadPart;
	TxMpduRetryDropCnt =
			pWlanCounters->TxMpduRetryDropCnt.QuadPart -
			pWlanCounters->LastTxMpduRetryDropCnt.QuadPart;
	TxRtsDropCnt =
			pWlanCounters->TxRtsDropCnt.QuadPart -
			pWlanCounters->LastTxRtsDropCnt.QuadPart;
	TxCtrlCnt =
			pWlanCounters->TxCtrlCnt.QuadPart -
			pWlanCounters->LastTxCtrlCnt.QuadPart;
	RxBeaconCnt =
			pWlanCounters->RxBeaconCnt.QuadPart -
			pWlanCounters->LastRxBeaconCnt.QuadPart;
	RxPhy2MacLenMismatchCount =
			pWlanCounters->RxPhy2MacLenMismatchCount.QuadPart -
			pWlanCounters->LastRxPhy2MacLenMismatchCount.QuadPart;
	TxBaCnt =
			pWlanCounters->TxBaCnt.QuadPart -
			pWlanCounters->LastTxBaCnt.QuadPart;
	RxDelimiterFailCount =
			pWlanCounters->RxDelimiterFailCount.QuadPart -
			pWlanCounters->LastRxDelimiterFailCount.QuadPart;
	RxOutOfRangeCount =
			pWlanCounters->RxOutOfRangeCount.QuadPart -
			pWlanCounters->LastRxOutOfRangeCount.QuadPart;
	RxFilterDropMpduCount =
			pWlanCounters->RxFilterDropMpduCount.QuadPart -
			pWlanCounters->LastRxFilterDropMpduCount.QuadPart;
	RTSSuccessCount = RTSTotalCnt - RTSFailureCount;
	RxFcsErrorCount =
			pWlanCounters->RxFcsErrorCount.QuadPart -
			pWlanCounters->LastRxFcsErrorCount.QuadPart;
	RxFifoFullCount =
			pWlanCounters->RxFifoFullCount.QuadPart -
			pWlanCounters->LastRxFifoFullCount.QuadPart;
	RxMpduCount =
			pWlanCounters->RxMpduCount.QuadPart -
			pWlanCounters->LastRxMpduCount.QuadPart;
	RxMpduInAmpduCount =
			pWlanCounters->RxMpduInAmpduCount.QuadPart -
			pWlanCounters->LastRxMpduInAmpduCount.QuadPart;
	RxFcsOkCount =
			pWlanCounters->RxFcsOkCount.QuadPart -
			pWlanCounters->LastRxFcsOkCount.QuadPart;
	TxBcnCount =
			pAd->BcnCheckInfo.totalbcncnt -
			ctrl->rdev.pRadioCtrl->TxBeaconPacketCount.u.LowPart;

	MTWF_PRINT("------------------BAND:%d-----------------------\n", hc_get_hw_band_idx(pAd));
	MTWF_PRINT("TxDataPacketCnt     = %lld\n", ctrl->rdev.pRadioCtrl->TxDataPacketCount.QuadPart);
	MTWF_PRINT("TxDataPacketByte    = %lld\n", ctrl->rdev.pRadioCtrl->TxDataPacketByte.QuadPart);
	MTWF_PRINT("RxDataPacketCnt     = %lld\n", ctrl->rdev.pRadioCtrl->RxDataPacketCount.QuadPart);
	MTWF_PRINT("RxDataPacketByte    = %lld\n", ctrl->rdev.pRadioCtrl->RxDataPacketByte.QuadPart);
	MTWF_PRINT("TxMgmtPacketCnt     = %lld\n", ctrl->rdev.pRadioCtrl->TxMgmtPacketCount.QuadPart);
	MTWF_PRINT("RxMgmtPacketCnt     = %lld\n", ctrl->rdev.pRadioCtrl->RxMgmtPacketCount.QuadPart);
	MTWF_PRINT("TxBcnPacketCnt      = %lld\n", TxBcnCount);
	MTWF_PRINT("ucPktsTx            = %lld\n", ctrl->rdev.pRadioCtrl->TxUnicastDataPacket.QuadPart);
	MTWF_PRINT("mcPktsTx            = %lld\n", ctrl->rdev.pRadioCtrl->TxMulticastDataPacket.QuadPart);
	MTWF_PRINT("bcPktsTx            = %lld\n", ctrl->rdev.pRadioCtrl->TxBroadcastDataPacket.QuadPart);
	MTWF_PRINT("TxDroppedPacketCnt  = %lld\n", ctrl->rdev.pRadioCtrl->TxPacketDroppedCount.QuadPart);
	MTWF_PRINT("ChannelUtilization  = %u\n", pAd->Ch_BusyTime_11k);
	MTWF_PRINT("RxCRCErrorCount     = %lld\n", ctrl->rdev.pRadioCtrl->RxCRCErrorCount.QuadPart);
	MTWF_PRINT("RxMICErrorCount     = %lld\n", ctrl->rdev.pRadioCtrl->RxMICErrorCount.QuadPart);
	MTWF_PRINT("RxDecyptionErrorCnt = %lld\n", ctrl->rdev.pRadioCtrl->RxDecryptionErrorCount.QuadPart);
	...
	MTWF_PRINT("ThroughPut(TX Kbps)	= %lld\n",
		(ctrl->rdev.pRadioCtrl->LastSecTxByte.QuadPart >> 7));
	MTWF_PRINT("ThroughPut(RX Kbps)	= %lld\n",
		(ctrl->rdev.pRadioCtrl->LastSecRxByte.QuadPart >> 7));
	...
	MTWF_PRINT("Packets Sent	:	%10lld	%10lld	%10lld	%10lld\n",
			ctrl->rdev.pRadioCtrl->TxDataPacketCountPerAC[QID_AC_BK].QuadPart,
			ctrl->rdev.pRadioCtrl->TxDataPacketCountPerAC[QID_AC_BE].QuadPart,
			ctrl->rdev.pRadioCtrl->TxDataPacketCountPerAC[QID_AC_VI].QuadPart,
			ctrl->rdev.pRadioCtrl->TxDataPacketCountPerAC[QID_AC_VO].QuadPart);
	MTWF_PRINT("Packets Rcvd	:	%10lld	%10lld	%10lld	%10lld\n",
			ctrl->rdev.pRadioCtrl->RxDataPacketCountPerAC[QID_AC_BK].QuadPart,
			ctrl->rdev.pRadioCtrl->RxDataPacketCountPerAC[QID_AC_BE].QuadPart,
			ctrl->rdev.pRadioCtrl->RxDataPacketCountPerAC[QID_AC_VI].QuadPart,
			ctrl->rdev.pRadioCtrl->RxDataPacketCountPerAC[QID_AC_VO].QuadPart);
	MTWF_PRINT("RSSI				0		1		2		3\n");
	MTWF_PRINT("Data Rx		:		%d		%d		%d		%d\n",
			ctrl->rdev.pRadioCtrl->LastDataPktRssi[0],
			ctrl->rdev.pRadioCtrl->LastDataPktRssi[1],
			ctrl->rdev.pRadioCtrl->LastDataPktRssi[2],
			ctrl->rdev.pRadioCtrl->LastDataPktRssi[3]);

	MTWF_PRINT("-------------------TX-------------------------\n");
	MTWF_PRINT("TxFragmentationCount = %lld\n", pAd->WlanCounters.TxFragmentationCount.QuadPart);
	MTWF_PRINT("TxMgmtPacketCnt      = %lld\n", pAd->WlanCounters.TxManagementCnt.QuadPart);
	MTWF_PRINT("TxManagementBytes    = %lld\n", pAd->WlanCounters.TxManagementBytes.QuadPart);
	MTWF_PRINT("TxMgmtPacketCnt(uc)  = %lld\n", ctrl->rdev.pRadioCtrl->TxMgmtPacketCount.QuadPart);
	MTWF_PRINT("TxManagementBytes(uc)= %lld\n", ctrl->rdev.pRadioCtrl->TxMgmtPacketByte.QuadPart);
	MTWF_PRINT("TxBarCnt             = %lld\n", pAd->WlanCounters.TxBarCnt.QuadPart + tr_cnt->ba_tx_bar_cnt);
	MTWF_PRINT("TxBaCnt              = %lld\n", TxBaCnt);
	MTWF_PRINT("TxPsPollCnt          = %lld\n", pAd->WlanCounters.TxPsPollCnt.QuadPart);
	MTWF_PRINT("TxDataNullCnt        = %lld\n", pAd->WlanCounters.TxDataNullCnt.QuadPart);
	MTWF_PRINT("TxQosNullCnt         = %lld\n", pAd->WlanCounters.TxQosNullCnt.QuadPart);
	MTWF_PRINT("TxAssocReqCnt        = %lld\n", pAd->WlanCounters.TxAssocReqCnt.QuadPart);
	MTWF_PRINT("TxAssocRspCnt        = %lld\n", pAd->WlanCounters.TxAssocRspCnt.QuadPart);
	MTWF_PRINT("TxReassocReqCnt      = %lld\n", pAd->WlanCounters.TxReassocReqCnt.QuadPart);
	MTWF_PRINT("TxReassocRspCnt      = %lld\n", pAd->WlanCounters.TxReassocRspCnt.QuadPart);
	MTWF_PRINT("TxDisassocCnt        = %lld\n", pAd->WlanCounters.TxDisassocCnt.QuadPart);
	MTWF_PRINT("TxAuthCnt            = %lld\n", pAd->WlanCounters.TxAuthCnt.QuadPart);
	MTWF_PRINT("TxDeauthCnt          = %lld\n", pAd->WlanCounters.TxDeauthCnt.QuadPart);
	MTWF_PRINT("TxProbeReqCnt        = %lld\n", pAd->WlanCounters.TxProbeReqCnt.QuadPart);
	MTWF_PRINT("TxProbeRspCnt        = %lld\n", pAd->WlanCounters.TxProbeRspCnt.QuadPart);
	MTWF_PRINT("TxActionCnt          = %lld\n", pAd->WlanCounters.TxActionCnt.QuadPart);
#ifdef TR181_SUPPORT
	MTWF_PRINT("TxUnicastCnt         = %lld\n", pAd->WlanCounters.ucPktsTx.QuadPart);
	MTWF_PRINT("TxUnicastBytes       = %lld\n", pAd->WlanCounters.ucBytesTx.QuadPart);
	MTWF_PRINT("TxMulticastCnt       = %lld\n", pAd->WlanCounters.mcPktsTx.QuadPart);
	MTWF_PRINT("TxMulticastBytes     = %lld\n", pAd->WlanCounters.mcBytesTx.QuadPart);
	MTWF_PRINT("TxBroadcastCnt       = %lld\n", pAd->WlanCounters.bcPktsTx.QuadPart);
	MTWF_PRINT("TxBroadcastBytes     = %lld\n", pAd->WlanCounters.bcBytesTx.QuadPart);
#endif /* TR181_SUPPORT */
	MTWF_PRINT("RTSTotalCnt          = %lld\n", RTSTotalCnt);
	MTWF_PRINT("RTSFailureCount      = %lld\n", RTSFailureCount);
	MTWF_PRINT("MultipleRetryCount   = %lld\n", MultipleRetryCount);
	MTWF_PRINT("ACKFailureCount      = %lld\n", ACKFailureCount);
	MTWF_PRINT("TxAmpduCnt           = %lld\n", TxAmpduCnt);
	MTWF_PRINT("TxAbortCnt           = %lld\n", TxAbortCnt);
	MTWF_PRINT("TxMpduRetryDropCnt   = %lld\n", TxMpduRetryDropCnt);
	MTWF_PRINT("TxRtsDropCnt         = %lld\n", TxRtsDropCnt);
	MTWF_PRINT("TxCtrlCnt            = %lld\n", TxCtrlCnt);
	MTWF_PRINT("TxMgmtRetryCnt       = %lld\n", TxMgmtRetryCnt);

	MTWF_PRINT("-------------------RX-------------------------\n");
	MTWF_PRINT("RxFragmentationCount = %lld\n", pAd->WlanCounters.RxFragmentationCount.QuadPart);
	MTWF_PRINT("RxMgmtPacketCnt      = %lld\n", pAd->WlanCounters.RxManagementCnt.QuadPart);
	MTWF_PRINT("RxManagementBytes    = %lld\n", pAd->WlanCounters.RxManagementBytes.QuadPart);
	MTWF_PRINT("RxMgmtPacketCnt(uc)  = %lld\n", ctrl->rdev.pRadioCtrl->RxMgmtPacketCount.QuadPart);
	MTWF_PRINT("RxManagementBytes(uc)= %lld\n", ctrl->rdev.pRadioCtrl->RxMgmtPacketByte.QuadPart);
	MTWF_PRINT("RxBarCnt             = %lld\n", pAd->WlanCounters.RxBarCnt.QuadPart + tr_cnt->ba_rx_bar_cnt);
	MTWF_PRINT("RxBaCnt              = %lld\n", RxBaCnt);
	MTWF_PRINT("RxPsPollCnt          = %lld\n", pAd->WlanCounters.RxPsPollCnt.QuadPart);
	MTWF_PRINT("RxDataNullCnt        = %lld\n", pAd->WlanCounters.RxDataNullCnt.QuadPart);
	MTWF_PRINT("RxQosNullCnt         = %lld\n", pAd->WlanCounters.RxQosNullCnt.QuadPart);
	MTWF_PRINT("RxAssocReqCnt        = %lld\n", pAd->WlanCounters.RxAssocReqCnt.QuadPart);
	MTWF_PRINT("RxAssocRspCnt        = %lld\n", pAd->WlanCounters.RxAssocRspCnt.QuadPart);
	MTWF_PRINT("RxReassocReqCnt      = %lld\n", pAd->WlanCounters.RxReassocReqCnt.QuadPart);
	MTWF_PRINT("RxReassocRspCnt      = %lld\n", pAd->WlanCounters.RxReassocRspCnt.QuadPart);
	MTWF_PRINT("RxDisassocCnt        = %lld\n", pAd->WlanCounters.RxDisassocCnt.QuadPart);
	MTWF_PRINT("RxAuthCnt            = %lld\n", pAd->WlanCounters.RxAuthCnt.QuadPart);
	MTWF_PRINT("RxDeauthCnt          = %lld\n", pAd->WlanCounters.RxDeauthCnt.QuadPart);
	MTWF_PRINT("RxProbeReqCnt        = %lld\n", pAd->WlanCounters.RxProbeReqCnt.QuadPart);
	MTWF_PRINT("RxProbeRspCnt        = %lld\n", pAd->WlanCounters.RxProbeRspCnt.QuadPart);
	MTWF_PRINT("RxActionCnt          = %lld\n", pAd->WlanCounters.RxActionCnt.QuadPart);
	MTWF_PRINT("RxUnicastCnt         = %lld\n", ctrl->rdev.pRadioCtrl->RxDataPacketCount.QuadPart);
	MTWF_PRINT("RxUnicastBytes       = %lld\n", ctrl->rdev.pRadioCtrl->RxDataPacketByte.QuadPart);
#ifdef TR181_SUPPORT
	//MTWF_PRINT("RxUnicastCnt         = %lld\n", pAd->WlanCounters.ucPktsRx.QuadPart);//unused
	//MTWF_PRINT("RxUnicastBytes       = %lld\n", pAd->WlanCounters.ucBytesRx.QuadPart);
	MTWF_PRINT("RxMulticastCnt       = %lld\n", pAd->WlanCounters.mcPktsRx.QuadPart);
	MTWF_PRINT("RxMulticastBytes     = %lld\n", pAd->WlanCounters.mcBytesRx.QuadPart);
	MTWF_PRINT("RxBroadcastCnt       = %lld\n", pAd->WlanCounters.bcPktsRx.QuadPart);
	MTWF_PRINT("RxBroadcastBytes     = %lld\n", pAd->WlanCounters.bcBytesRx.QuadPart);
#endif /* TR181_SUPPORT */
	MTWF_PRINT("RxFcsOkCount         = %lld\n", RxFcsOkCount);
	MTWF_PRINT("RxFcsErrorCount      = %lld\n", RxFcsErrorCount);
	MTWF_PRINT("RxFifoFullCount      = %lld\n", RxFifoFullCount);
	MTWF_PRINT("RxMpduCount          = %lld\n", RxMpduCount);
	MTWF_PRINT("RxMpduInAmpduCount   = %lld\n", RxMpduInAmpduCount);
	MTWF_PRINT("RxDelimiterFailCount = %lld\n", RxDelimiterFailCount);
	MTWF_PRINT("RxOutOfRangeCount    = %lld\n", RxOutOfRangeCount);
	MTWF_PRINT("RxDupDropCount       = %lld\n", RxDupDropCount);
	MTWF_PRINT("RxDataByte           = %lld\n", pAd->WlanCounters.RxDataByte.QuadPart);
	MTWF_PRINT("RxBeaconCnt          = %lld\n", RxBeaconCnt);
	MTWF_PRINT("RxFilterDropMpduCount     = %lld\n", RxFilterDropMpduCount);
	MTWF_PRINT("RxPhy2MacLenMismatchCount = %lld\n", RxPhy2MacLenMismatchCount);
	MTWF_PRINT("-------------------Crypto-------------------------\n");
	MTWF_PRINT("RxDecryptionSuccessCount = %lld\n", pAd->WlanCounters.RxDecryptionSuccessCount.QuadPart);
	MTWF_PRINT("RxWepExcludeCount  = %lld\n",
		ctrl->rdev.pRadioCtrl->RxDecryptionErrorCount.QuadPart + ctrl->rdev.pRadioCtrl->RxMICErrorCount.QuadPart);
	MTWF_PRINT("RxTkipDecErrCount  = %lld\n", pAd->WlanCounters.RxTkipDecErrCount.QuadPart);
	MTWF_PRINT("RxCcmpDecErrCount  = %lld\n", pAd->WlanCounters.RxCcmpDecErrCount.QuadPart);
	MTWF_PRINT("RxCcmpReplayCount  = %lld\n", pAd->WlanCounters.RxCcmpReplayCount.QuadPart);
	MTWF_PRINT("RxTkipReplayCount  = %lld\n", pAd->WlanCounters.RxTkipReplayCount.QuadPart);
	MTWF_PRINT("RxTkipMicErrCount  = %lld\n", pAd->WlanCounters.RxTkipMicErrCount.QuadPart);
	MTWF_PRINT("RxCcmpMicErrCount  = %lld\n", pAd->WlanCounters.RxCcmpMicErrCount.QuadPart);
	MTWF_PRINT("----------------------------------------------\n");

	return TRUE;
}

static INT Show_Rate_Report_2G(RTMP_ADAPTER *pAd)
{
	UINT32 NssIndex, McsIndex, DirIndex;
	struct TXRX_RATE_REPORT_2G_T *Report2G = NULL;

	for (DirIndex = 0; DirIndex < ENUM_DIR_MAX; DirIndex++) {
		Report2G = &pAd->TxRxRateReport.Report2G[DirIndex];
		MTWF_PRINT("Report2G: [%s]\n", (DirIndex == ENUM_DIR_TX) ? "TX" : "RX");
		MTWF_PRINT("CCK\n");
		MTWF_PRINT("\t1SS ");
		for (McsIndex = 0; McsIndex < CCK_RATE_MAX; McsIndex++) {
			MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report2G->rCckCnt[McsIndex].SuccessCnt, Report2G->rCckCnt[McsIndex].FailCnt);
		}
		MTWF_PRINT("\n");

		MTWF_PRINT("OFDM\n");
		MTWF_PRINT("\t1SS ");
		for (McsIndex = 0; McsIndex < OFDM_RATE_MAX; McsIndex++) {
			MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report2G->rOfdmCnt[McsIndex].SuccessCnt, Report2G->rOfdmCnt[McsIndex].FailCnt);
		}
		MTWF_PRINT("\n");

		MTWF_PRINT("HT\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			MTWF_PRINT("\t%uSS ", NssIndex + 1);
			for (McsIndex = 0; McsIndex < HT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report2G->rHtCnt[NssIndex][McsIndex].SuccessCnt, Report2G->rHtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		MTWF_PRINT("HE\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			MTWF_PRINT("\t%uSS ", NssIndex + 1);
			for (McsIndex = 0; McsIndex < HE_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report2G->rHeCnt[NssIndex][McsIndex].SuccessCnt, Report2G->rHeCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		MTWF_PRINT("EHT\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			...
			for (McsIndex = 0; McsIndex < EHT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report2G->rEhtCnt[NssIndex][McsIndex].SuccessCnt, Report2G->rEhtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
	}
...
static INT Show_Rate_Report_5G(RTMP_ADAPTER *pAd)
{
	UINT32 NssIndex, McsIndex, DirIndex;
	struct TXRX_RATE_REPORT_5G_T *Report5G = NULL;

	for (DirIndex = 0; DirIndex < ENUM_DIR_MAX; DirIndex++) {
		Report5G = &pAd->TxRxRateReport.Report5G[DirIndex];
		MTWF_PRINT("Report5G: [%s]\n", (DirIndex == ENUM_DIR_TX) ? "TX" : "RX");

		MTWF_PRINT("OFDM\n");
		MTWF_PRINT("\t1SS ");
		for (McsIndex = 0; McsIndex < OFDM_RATE_MAX; McsIndex++) {
			MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report5G->rOfdmCnt[McsIndex].SuccessCnt, Report5G->rOfdmCnt[McsIndex].FailCnt);
		}
		MTWF_PRINT("\n");
		...
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			...
			for (McsIndex = 0; McsIndex < HT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report5G->rHtCnt[NssIndex][McsIndex].SuccessCnt, Report5G->rHtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		...
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			MTWF_PRINT("\t%uSS ", NssIndex + 1);
			for (McsIndex = 0; McsIndex < VHT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report5G->rVhtCnt[NssIndex][McsIndex].SuccessCnt, Report5G->rVhtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		...
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			...
			for (McsIndex = 0; McsIndex < HE_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report5G->rHeCnt[NssIndex][McsIndex].SuccessCnt, Report5G->rHeCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		MTWF_PRINT("EHT\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			...
			for (McsIndex = 0; McsIndex < EHT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report5G->rEhtCnt[NssIndex][McsIndex].SuccessCnt, Report5G->rEhtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
	}
...
static INT Show_Rate_Report_6G(RTMP_ADAPTER *pAd)
{
	UINT32 NssIndex, McsIndex, DirIndex;
	struct TXRX_RATE_REPORT_6G_T *Report6G = NULL;

	for (DirIndex = 0; DirIndex < ENUM_DIR_MAX; DirIndex++) {
		Report6G = &pAd->TxRxRateReport.Report6G[DirIndex];
		MTWF_PRINT("Report6G: [%s]\n", (DirIndex == ENUM_DIR_TX) ? "TX" : "RX");
		MTWF_PRINT("HE\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			MTWF_PRINT("\t%uSS ", NssIndex + 1);
			for (McsIndex = 0; McsIndex < HE_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report6G->rHeCnt[NssIndex][McsIndex].SuccessCnt, Report6G->rHeCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
		MTWF_PRINT("EHT\n");
		for (NssIndex = 0; NssIndex < RA_NSS_MAX; NssIndex++) {
			...
			for (McsIndex = 0; McsIndex < EHT_RATE_MAX; McsIndex++) {
				MTWF_PRINT(", [%u]%u/%u",
						McsIndex, Report6G->rEhtCnt[NssIndex][McsIndex].SuccessCnt, Report6G->rEhtCnt[NssIndex][McsIndex].FailCnt);
			}
			MTWF_PRINT("\n");
		}
	}
...
static INT Show_Stbc_Gi_Report(RTMP_ADAPTER *pAd)
{
	UINT8 ucBandIdx = hc_get_hw_band_idx(pAd);
	UINT32 DirIndex;

	for (DirIndex = 0; DirIndex < ENUM_DIR_MAX; DirIndex++)
		MTWF_PRINT("STBC BAND:%u, [%s]=%u\n", ucBandIdx, (DirIndex == ENUM_DIR_TX) ? "TX" : "RX", pAd->TxRxRateReport.STBCCnt[ucBandIdx][DirIndex]);

	for (DirIndex = 0; DirIndex < ENUM_DIR_MAX; DirIndex++) {
		MTWF_PRINT("HtVht SGI BAND:%u, [%s]=%u\n", ucBandIdx, (DirIndex == ENUM_DIR_TX) ? "TX" : "RX", pAd->TxRxRateReport.HtVhtGICnt[ucBandIdx][DirIndex][ENUM_SGI]);
		MTWF_PRINT("HtVht LGI BAND:%u, [%s]=%u\n", ucBandIdx, (DirIndex == ENUM_DIR_TX) ? "TX" : "RX", pAd->TxRxRateReport.HtVhtGICnt[ucBandIdx][DirIndex][ENUM_LGI]);
		MTWF_PRINT("HeEht SGI BAND:%u, [%s]=%u\n", ucBandIdx, (DirIndex == ENUM_DIR_TX) ? "TX" : "RX", pAd->TxRxRateReport.HeEhtGICnt[ucBandIdx][DirIndex][ENUM_SGI]);
		MTWF_PRINT("HeEht LGI BAND:%u, [%s]=%u\n", ucBandIdx, (DirIndex == ENUM_DIR_TX) ? "TX" : "RX", pAd->TxRxRateReport.HeEhtGICnt[ucBandIdx][DirIndex][ENUM_LGI]);
	}
	return TRUE;
}
...
static INT Show_Rate_Report_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	asic_get_all_rate_cnts(pAd, hc_get_hw_band_idx(pAd), ENUM_DIR_TX);
	asic_get_all_rate_cnts(pAd, hc_get_hw_band_idx(pAd), ENUM_DIR_RX);
	asic_get_stbc_cnts(pAd, hc_get_hw_band_idx(pAd));
	asic_get_gi_cnts(pAd, hc_get_hw_band_idx(pAd));

	if (WMODE_CAP_6G(PhyMode))
		Show_Rate_Report_6G(pAd);
	else if (WMODE_CAP_2G(PhyMode))
		Show_Rate_Report_2G(pAd);
	else if (WMODE_CAP_5G(PhyMode))
		Show_Rate_Report_5G(pAd);

	Show_Stbc_Gi_Report(pAd);
...
INT Show_Bss_Stat_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	union _HTTRANSMIT_SETTING LastMbssTxPktRate;
	ULONG DataRate_Tx;
	ULONG Multicast_Tx_Rate;
	USHORT Multicast_Tx_MCS, Multicast_Tx_Mode;
	for (i = 0 ; (i < pAd->ApCfg.BssidNum) && VALID_MBSS(pAd, i); i++) {
	...
	for (Bss_Idx = 0 ; (Bss_Idx < pAd->ApCfg.BssidNum) && VALID_MBSS(pAd, Bss_Idx) ; Bss_Idx++) {
		...
		if (VALID_UCAST_ENTRY_WCID(pAd, pMbss->stat_bss.LastPktStaWcid)) {
			PMAC_TABLE_ENTRY pEntry = entry_get(pAd, pMbss->stat_bss.LastPktStaWcid);
...
INT Show_Sta_Stat_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	UINT16 i, max_sta_num;

	for (i = 0, max_sta_num = GET_MAX_UCAST_NUM(pAd); i < max_sta_num && (i < WTBL_MAX_NUM(pAd)); i++) {
		PMAC_TABLE_ENTRY pEntry = entry_get(pAd, i);
...
INT Get_Rfdisable_cnts(RTMP_ADAPTER *pAd)
{
	struct tr_counter *tr_cnt = &pAd->tr_ctl.tr_cnt;
	struct wifi_dev *wdev = NULL;
	UINT32 i = 0, rfdisable = 0;

	for (i = 0; i < WDEV_NUM_MAX; i++) {
		wdev = pAd->wdev_list[i];
		if ((wdev != NULL) && (wdev->wdev_type == WDEV_TYPE_AP) && (wdev->if_up_down_state == false))
			rfdisable++;
	}

	tr_cnt->rfdisable_cnt = rfdisable;
	return TRUE;
}
...
INT Show_Eap_Stats_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (arg == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
				"Please enter in the format \"iwpriv <inf_name> show eap_stats=<sta wcid>\"\n");
		return TRUE;
	}
	...
	if (!VALID_UCAST_ENTRY_WCID(pAd, Wcid) || (Wcid >= WTBL_MAX_NUM(pAd))) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "Invalid Wcid!!\n");
		return TRUE;
	} else {
		pEntry = entry_get(pAd, Wcid);
		if (IS_VALID_ENTRY(pEntry) && IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC)) {
			MTWF_PRINT("WCID[%d], MAC Address["MACSTR"]\n",
				pEntry->wcid, MAC2STR(pEntry->Addr));
			MTWF_PRINT("mpdu_attempts/retries/dropped(HW) = %lld/%lld/%lld\n",
				pEntry->mpdu_attempts.QuadPart, pEntry->mpdu_retries.QuadPart, pEntry->mpdu_xretries.QuadPart);
#ifdef EAP_ENHANCE_STATS_SUPPORT
			MTWF_PRINT("tx agg cnt:  min/max/avg = %d/%d/%d\n",
				pEntry->tx_cnt_min, pEntry->tx_cnt_max, pEntry->tx_cnt_avg);
			MTWF_PRINT("air latency: min/max/avg = %d/%d/%d (TU)\n",
				pEntry->air_latency_min, pEntry->air_latency_max, pEntry->air_latency_avg);
#endif /* EAP_ENHANCE_STATS_SUPPORT */
			MTWF_PRINT("tx latency:  min/max/avg = %d/%d/%d (TU)\n",
...
static VOID Get_Pkt_Cnt_Per_Band(RTMP_ADAPTER *pAd, ULONG *AllStaTxRetryCount, ULONG *AllStaTxDropCount)
{
#ifdef WIFI_UNIFIED_COMMAND
	UINT32 i;
	UINT32 staNum = 0;
	UINT16 *wcid = NULL;
	struct sta_msdu_pkt_cnt mutilStaPktCnt;
	BOOLEAN IsMultiRsp = TRUE;
#endif

	*AllStaTxRetryCount = 0;
	*AllStaTxDropCount = 0;

#ifdef WIFI_UNIFIED_COMMAND
	os_alloc_mem(pAd, (UCHAR **)&wcid, sizeof(UINT16) * MAX_STA_LIST_NUM);
	if (!wcid)
		return;

	NdisZeroMemory(wcid, sizeof(UINT16) * MAX_STA_LIST_NUM);

	for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i) && (i < WTBL_MAX_NUM(pAd)); i++) {
		PMAC_TABLE_ENTRY pEntry = entry_get(pAd, i);

		if (IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC))
			wcid[staNum++] = pEntry->wcid;

		if (staNum == MAX_STA_LIST_NUM) {
			NdisZeroMemory(&mutilStaPktCnt, sizeof(struct sta_msdu_pkt_cnt));
			UniCmdPerStaGetPktCnt(pAd, wcid, staNum, IsMultiRsp, (UINT32 *)&mutilStaPktCnt);
			*AllStaTxDropCount += mutilStaPktCnt.txMsduDropCnt;
			*AllStaTxRetryCount += mutilStaPktCnt.txMsduRetryCnt;
			NdisZeroMemory(wcid, sizeof(UINT16) * MAX_STA_LIST_NUM);
			staNum = 0;
		}
	}

	if ((staNum > MAX_STA_LIST_NUM) || (staNum == 0))
		goto done;
...
#ifdef WIFI_UNIFIED_COMMAND
	UINT32 staNum = 1;
	BOOLEAN IsMultiRsp = FALSE;
	struct sta_msdu_pkt_cnt perStaPktCnt;
#endif

	if (wcid > WTBL_MAX_NUM(pAd))
		return;

	*PerStaTxRetryCount = 0;
	*PerStaTxDropCount = 0;

#ifdef WIFI_UNIFIED_COMMAND
	NdisZeroMemory(&perStaPktCnt, sizeof(struct sta_msdu_pkt_cnt));
	UniCmdPerStaGetPktCnt(pAd, &wcid, staNum, IsMultiRsp, (UINT32 *)&perStaPktCnt);
	*PerStaTxRetryCount = perStaPktCnt.txMsduRetryCnt;
	*PerStaTxDropCount = perStaPktCnt.txMsduDropCnt;
#endif
}
...
#ifdef IGMP_SNOOP_SUPPORT
	MTWF_PRINT("\n\n%-19s%-4s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s\n",
		"MAC", "AID", "TxPackets", "RxPackets", "TXFail", "TXMpduRetry",
		"TXMsduRetry", "TxMsduDrop", "TxBytes", "RxBytes",
		"M2U-TxPkts", "M2U-TxBytes", "TP(Tx)", "TP(Rx)");
#else
	MTWF_PRINT("\n\n%-19s%-4s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s\n",
			  "MAC", "AID", "TxPackets", "RxPackets", "TXFail", "TXMpduRetry",
			  "TXMsduRetry", "TxMsduDrop", "TxBytes", "RxBytes", "TP(Tx)", "TP(Rx)");
#endif
	for (i = 0, max_sta_num = GET_MAX_UCAST_NUM(pAd); i < max_sta_num && (i < WTBL_MAX_NUM(pAd)); i++) {
		PMAC_TABLE_ENTRY pEntry = entry_get(pAd, i);
		...
		if (((IS_ENTRY_CLIENT(pEntry) || IS_ENTRY_PEER_AP(pEntry) || IS_ENTRY_REPEATER(pEntry))
			...
			Get_Pkt_Cnt_Per_Sta(pAd, pEntry->wcid, &pEntry->txMsduRetryCnt, &pEntry->txMsduDropCnt);
			...
			MTWF_PRINT("%-12lu", (ULONG)pEntry->TxFailCount);
			MTWF_PRINT("%-12lu", pEntry->TxRetriedPktCount);
			MTWF_PRINT("%-12lu", pEntry->txMsduRetryCnt);
			MTWF_PRINT("%-12lu", pEntry->txMsduDropCnt);
			MTWF_PRINT("%-12lu", (ULONG)pEntry->TxBytes);
			MTWF_PRINT("%-12lu", (ULONG)pEntry->RxBytes);
#ifdef IGMP_SNOOP_SUPPORT
			MTWF_PRINT("%-12lld", pEntry->M2U_TxPackets);
			MTWF_PRINT("%-12lld", pEntry->M2U_TxBytes);
#endif /*IGMP_SNOOP_SUPPORT*/
...
INT Show_TxBfInfo_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
...
#endif /* VHT_TXBF_SUPPORT */
#if (defined(HE_TXBF_SUPPORT) || defined(EHT_TXBF_SUPPORT))
	enum PHY_CAP phy_caps;
#endif
#ifdef HE_TXBF_SUPPORT
	struct he_bf_info he_bf_struct;
#endif
#if (defined(DOT11_EHT_BE) && defined(EHT_TXBF_SUPPORT))
	struct eht_bf_info eht_bf_struct;
	enum eht_nss_mcs_bw peer_bw = EHT_NSS_MCS_20;
#endif /* defined(DOT11_EHT_BE) && defined(EHT_TXBF_SUPPORT) */
	...
	if (cap->FlgHwTxBfCap) {
		...
		if (bfee) {
...
#if (defined(DOT11_EHT_BE) && defined(EHT_TXBF_SUPPORT))
			case MODE_EHT:
				ucTxMode = MODE_EHT_ER_SU;
				if (pEntry->wdev->channel < 14 && WMODE_CAP_2G(pEntry->wdev->PhyMode)) {
					/* 2G */
					if (pEntry->cap.ch_bw.he_ch_width & SUPP_40M_CW_IN_24G_BAND)
						peer_bw = EHT_NSS_MCS_80;

				} else if (WMODE_CAP_5G(pEntry->wdev->PhyMode) || WMODE_CAP_6G(pEntry->wdev->PhyMode)) {
					/* 5G */
					if (pEntry->cap.ch_bw.he_ch_width & SUPP_40M_80M_CW_IN_5G_6G_BAND) {
						peer_bw = EHT_NSS_MCS_80;
						if (pEntry->cap.ch_bw.he_ch_width & (SUPP_160M_CW_IN_5G_6G_BAND|SUPP_160M_8080M_CW_IN_5G_6G_BAND))
							peer_bw = EHT_NSS_MCS_160;
					}
					/*6G*/
					if ((pEntry->MaxHTPhyMode.field.BW == BW_320) && (WMODE_CAP_BE_6G(pEntry->wdev->PhyMode)))
						peer_bw = EHT_NSS_MCS_320;
				}
				u1PeerMaxRxNss = pEntry->cap.rate.rx_nss_mcs[peer_bw].mcs0_7;
				MTWF_PRINT("EHT phy cap:\n");
				MTWF_PRINT("Wcid:%d\n", wcid);
				MTWF_PRINT("TxMode:%d\n", MODE_HE_SU);
				MTWF_PRINT("MaxHTPhyMode.field.BW:%d\n", pEntry->MaxHTPhyMode.field.BW);
				MTWF_PRINT("he_ch_width:%d, EHT 6G BW 320: %x\n", pEntry->cap.ch_bw.he_ch_width, pEntry->cap.eht_phy_cap&EHT_320M_6G);
				MTWF_PRINT("Rx Max Nss:%d\n", u1PeerMaxRxNss);
				MTWF_PRINT("SU Beamformer:%u\n", (pEntry->cap.eht_bf.bf_cap & EHT_SU_BFER)?1:0);
				MTWF_PRINT("SU Beamformee:%u\n", (pEntry->cap.eht_bf.bf_cap & EHT_SU_BFEE)?1:0);
				MTWF_PRINT("MU Beamformer:%u\n", (pEntry->cap.eht_bf.bf_cap & EHT_MU_BFER)?1:0);
				MTWF_PRINT("Beamformee STS <= 80MHz:%d\n", pEntry->cap.eht_bf.bfee_ss_le_eq_bw80);
				MTWF_PRINT("Beamformee STS for 160MHz:%d\n", pEntry->cap.eht_bf.bfee_ss_bw160);
				MTWF_PRINT("Beamformee STS for 320MHz:%d\n", pEntry->cap.eht_bf.bfee_ss_bw320);
				MTWF_PRINT("Number of Sounding Dimension <= 80 MHz:%d\n", pEntry->cap.eht_bf.snd_dim_le_eq_bw80);
				MTWF_PRINT("Number of Sounding Dimension for 160MHz:%d\n", pEntry->cap.eht_bf.snd_dim_bw160);
				MTWF_PRINT("Number of Sounding Dimension for 160MHz:%d\n", pEntry->cap.eht_bf.snd_dim_bw320);
				MTWF_PRINT("Ng = 16 SU Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_BFEE_NG16_SU_FEEDBACK)?1:0);
				MTWF_PRINT("Ng = 16 MU Feedback :%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_BFEE_NG16_MU_FEEDBACK)?1:0);
				MTWF_PRINT("Codebook Size {4,2} SU Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_BFEE_CODEBOOK_4_2_SU_FEEDBACK)?1:0);
				MTWF_PRINT("Codebook Size {7,5} SU Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_BFEE_CODEBOOK_7_5_SU_FEEDBACK)?1:0);
				MTWF_PRINT("Triggered SU Beamforming Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_TRIGED_SU_BF_FEEDBACK)?1:0);
				MTWF_PRINT("Triggered MU Beamforing Partial BW Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_TRIGED_MU_BF_PATIAL_BW_FEEDBACK)?1:0);
				MTWF_PRINT("Triggered CQI Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_TRIGED_CQI_FEEDBACK)?1:0);
				MTWF_PRINT("Non-Triggered CQI Feedback:%d\n", (pEntry->cap.eht_bf.bf_cap & EHT_NON_TRIGED_CQI_FEEDBACK)?1:0);
				MTWF_PRINT("Max Nc :%d\n", pEntry->cap.eht_bf.bfee_max_nc);
				MTWF_PRINT("Max EHT LTF:%x\n", pEntry->cap.eht_bf.max_eht_ltf_num);
			...
			MTWF_PRINT("BfSmthIntlBypass[%u]:%u\n", ucBandIdx, pAd->CommonCfg.BfSmthIntlBypass);
			MTWF_PRINT("HeraStbcPriority[%u]:%u\n", ucBandIdx, pAd->CommonCfg.HeraStbcPriority);
			...
			if (IS_PHY_CAPS(phy_caps, fPHY_CAP_TXBF)) {
				...
				MTWF_PRINT("EHT TxBF Cap from eht_bf_struct:\n");
				MTWF_PRINT("  SU Beamformer:%d\n", (eht_bf_struct.bf_cap & EHT_SU_BFER)?1:0);
				MTWF_PRINT("  SU Beamformee:%d\n", (eht_bf_struct.bf_cap & EHT_SU_BFEE)?1:0);
				MTWF_PRINT("  MU Beamformer:%d\n", (eht_bf_struct.bf_cap & EHT_MU_BFER)?1:0);
				MTWF_PRINT("  Beamformee STS <= 80MHz:%d\n", eht_bf_struct.bfee_ss_le_eq_bw80);
				MTWF_PRINT("  Beamformee STS for 160MHz:%d\n", eht_bf_struct.bfee_ss_bw160);
				MTWF_PRINT("  Beamformee STS for 320MHz:%d\n", eht_bf_struct.bfee_ss_bw320);
				MTWF_PRINT("  Number Of Sounding Dimensions <= 80MHz:%d\n", eht_bf_struct.snd_dim_le_eq_bw80);
				MTWF_PRINT("  Number Of Sounding Dimensions for 160MHz:%d\n", eht_bf_struct.snd_dim_bw160);
				MTWF_PRINT("  Number Of Sounding Dimensions for 320MHz:%d\n", eht_bf_struct.snd_dim_bw320);
				MTWF_PRINT("  Ng = 16 SU Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_BFEE_NG16_SU_FEEDBACK)?1:0);
				MTWF_PRINT("  Ng = 16 MU Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_BFEE_NG16_MU_FEEDBACK)?1:0);
				MTWF_PRINT("  Codebook Size = {4,2} SU Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_BFEE_CODEBOOK_4_2_SU_FEEDBACK)?1:0);
				MTWF_PRINT("  Codebook Size = {7,5} MU Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_BFEE_CODEBOOK_7_5_SU_FEEDBACK)?1:0);
				MTWF_PRINT("  Triggered SU Beamforming Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_TRIGED_SU_BF_FEEDBACK)?1:0);
				MTWF_PRINT("  Triggered MU Beamforming Partial Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_TRIGED_MU_BF_PATIAL_BW_FEEDBACK)?1:0);
				MTWF_PRINT("  Triggered Trigger CQI Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_TRIGED_CQI_FEEDBACK)?1:0);
				MTWF_PRINT("  Triggered Non-Trigger CQI Feedback:%d\n", (eht_bf_struct.bf_cap & EHT_NON_TRIGED_CQI_FEEDBACK)?1:0);
				MTWF_PRINT("  Max Nc:%d\n", eht_bf_struct.bfee_max_nc);
				MTWF_PRINT("  Max EHT LTF:%x\n", eht_bf_struct.max_eht_ltf_num);
			} else {
				MTWF_PRINT("Wlan Device has no EHT TxBF Cap\n");
			}
#endif /* defined(DOT11_EHT_BE) && defined(EHT_TXBF_SUPPORT) */
...
INT Set_DiagOpt_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "DiagOpt=%ld!\n", diagOpt);
	return TRUE;
}
...
INT Show_Diag_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (!pDiag) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "AllocMem failed!\n");
		return FALSE;
	}
...
INT andlink_send_inf_stat_event(RTMP_ADAPTER *pAd, INT apidx)
{
	...
	if (!VALID_MBSS(pAd, apidx)) {
		MTWF_DBG(pAd, DBG_CAT_ANDLINK, CATANDKINK_TX, DBG_LVL_ERROR,
					"input apidx: %d > %d BSSIDNUM\n", apidx, pAd->ApCfg.BssidNum);
		return FALSE;
	}
...
INT Show_Sat_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_PRINT("TransmittedFragmentCount = %lld\n",
			  (INT64)pAd->WlanCounters.TransmittedFragmentCount.u.LowPart +
			  pAd->WlanCounters.MulticastTransmittedFrameCount.QuadPart);
	...
	Get_Pkt_Cnt_Per_Band(pAd, &pAd->Counters8023.TxRetryCount, &pAd->Counters8023.TxDropCount);
	MTWF_PRINT("TransmittedMsduRetryCount  = %lu\n", pAd->Counters8023.TxRetryCount);
	MTWF_PRINT("TransmittedMsduDropCount  = %lu\n", pAd->Counters8023.TxDropCount);
...
#endif /* DOT11_N_SUPPORT */
	{
		...
		for (apidx = 0; (apidx < pAd->ApCfg.BssidNum) && VALID_MBSS(pAd, apidx); apidx++) {
			...
			MTWF_PRINT("Byte Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].TransmittedByteCount);
			...
			MTWF_PRINT("Error Packets Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].TxErrorCount);
			MTWF_PRINT("Drop Received Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].TxDropCount);
			MTWF_PRINT("Unicast Packets Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].ucPktsTx);
			MTWF_PRINT("Unicast Packets Received = %ld\n", pAd->ApCfg.MBSSID[apidx].ucPktsRx);
			MTWF_PRINT("Multicast Packets Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].mcPktsTx);
			MTWF_PRINT("Multicast Packets Received = %ld\n", pAd->ApCfg.MBSSID[apidx].mcPktsRx);
			MTWF_PRINT("Broadcast Packets Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].bcPktsTx);
			MTWF_PRINT("Broadcast Packets Received = %ld\n", pAd->ApCfg.MBSSID[apidx].bcPktsRx);
#ifdef IGMP_SNOOP_SUPPORT
#ifdef IGMP_SNOOPING_OFFLOAD
			MTWF_PRINT("M2U Packets Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].M2U_TxPackets);
			MTWF_PRINT("M2U Bytes Sent = %ld\n", pAd->ApCfg.MBSSID[apidx].M2U_TxBytes);
#endif
#endif

#ifdef ANDLINK_FEATURE_SUPPORT
			if (HcGetBandByWdev(&pAd->ApCfg.MBSSID[apidx].wdev) < CFG_WIFI_RAM_BAND_NUM
	...
	}
	{
		...
		for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i) && (i < WTBL_MAX_NUM(pAd)); i++) {
			...
			if (IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC)) {
				...
				for (j = maxMcs; (j >= 0) && (j < ARRAY_SIZE(pEntry->TXMCSExpected)); j--) {
...
INT Show_FwDbgInfo_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (arg != NULL)
		mcu_type = os_str_toul(arg, 0, 10);

	if (mcu_type >= MAX_LOG_OUTPUT) {
		MTWF_PRINT("mcu_type:%d, op: 0->WM, 1->MA\n", mcu_type);
		return FALSE;
	}

	if (chip_dbg->show_fw_dbg_info)
		chip_dbg->show_fw_dbg_info(pAd, mcu_type);
...
INT Show_WFDMA_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	struct _RTMP_CHIP_DBG *chip_dbg = hc_get_chip_dbg(pAd->hdev_ctrl);

	if (chip_dbg->show_wfdma_info)
...
INT Show_CoreDump_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (chip_dbg->show_coredump_proc)
		chip_dbg->show_coredump_proc(pAd, mcu_type);
...
INT Show_Sat_Reset_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	pAd->WlanCounters.FCSErrorCount.u.LowPart = 0;
	pAd->WlanCounters.FrameDuplicateCount.u.LowPart = 0;
	pAd->WlanCounters.FCSErrorCount.u.HighPart = 0;
	pAd->WlanCounters.FrameDuplicateCount.u.HighPart = 0;

	pAd->WlanCounters.TransmittedFrameCount.u.LowPart = 0;
	pAd->WlanCounters.WEPUndecryptableCount.u.LowPart = 0;
#ifdef STATS_COUNT_SUPPORT
	pAd->WlanCounters.AmpduSuccessCount.u.LowPart = 0;
	pAd->WlanCounters.AmpduFailCount.u.LowPart = 0;
	pAd->WlanCounters.AmpduSuccessCount.u.HighPart = 0;
	pAd->WlanCounters.AmpduFailCount.u.HighPart = 0;
#endif /* STATS_COUNT_SUPPORT */
	pAd->WlanCounters.RxFcsErrorCount.u.LowPart = 0;
	pAd->WlanCounters.RxFcsErrorCount.u.HighPart = 0;
	pAd->WlanCounters.RxFifoFullCount.u.LowPart = 0;
	pAd->WlanCounters.RxFifoFullCount.u.HighPart = 0;
	pAd->WlanCounters.RxMpduCount.QuadPart = 0;
	pAd->WlanCounters.ChannelIdleCount.QuadPart = 0;
	pAd->WlanCounters.CcaNavTxTime.QuadPart = 0;
	pAd->WlanCounters.RxMdrdyCount.QuadPart = 0;
	pAd->WlanCounters.SCcaTime.QuadPart = 0;
	pAd->WlanCounters.PEdTime.QuadPart = 0;
	pAd->WlanCounters.RxTotByteCount.QuadPart = 0;
	pAd->WlanCounters.CurrentBwTxCount.u.LowPart = 0;
	pAd->WlanCounters.OtherBwTxCount.u.LowPart = 0;
	pAd->WlanCounters.TxAggRange1Count.u.LowPart = 0;
	pAd->WlanCounters.TxAggRange2Count.u.LowPart = 0;
	pAd->WlanCounters.TxAggRange3Count.u.LowPart = 0;
	pAd->WlanCounters.TxAggRange4Count.u.LowPart = 0;
	...
	for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i) && (i < WTBL_MAX_NUM(pAd)); i++) {
		...
		if (IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC)) {
			...
			for (j = maxMcs; (j >= 0) && (j < ARRAY_SIZE(pEntry->TXMCSExpected)); j--) {
				if ((pEntry->TXMCSExpected[j] != 0) || (pEntry->TXMCSFailed[j] != 0)) {
					...
					for (k = maxMcs; (k >= 0) && (k < ARRAY_SIZE(pEntry->TXMCSAutoFallBack[j])) && (pEntry->TXMCSAutoFallBack[j][k] != 0)
						; k--) {
						MTWF_PRINT("\t\t\tAutoMCS[%02d]: %u (%d%%)\n", k, pEntry->TXMCSAutoFallBack[j][k],
							(100 * pEntry->TXMCSAutoFallBack[j][k]) / pEntry->TXMCSExpected[j]);
					}
		...
		for (j = 0; (j < (maxMcs + 1)) && (j < ARRAY_SIZE(pEntry->TXMCSExpected)); j++) {
			pEntry->TXMCSExpected[j] = 0;
			pEntry->TXMCSSuccessful[j] = 0;
			pEntry->TXMCSFailed[j] = 0;

			for (k = maxMcs; (k >= 0) && (k < ARRAY_SIZE(pEntry->TXMCSAutoFallBack[j])); k--)
...
INT Show_MATTable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	dumpIPMacTb(PD_GET_MAT_CFG_PTR(pAd->physical_dev), -1);
	dumpSesMacTb(PD_GET_MAT_CFG_PTR(pAd->physical_dev), -1);
	dumpUidMacTb(PD_GET_MAT_CFG_PTR(pAd->physical_dev), -1);
	dumpIPv6MacTb(PD_GET_MAT_CFG_PTR(pAd->physical_dev), -1);
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	if (copy_from_user(pKey, wrq->u.data.pointer, wrq->u.data.length)) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_PMK, DBG_LVL_INFO, "copy from user failed\n");
		os_free_mem(pKey);
		return;
	}
	...
	if (IS_AKM_WPA2(pSecConfig->AKMMap)
		...
		if (pKey->KeyLength == 32) {
			...
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_PMK, DBG_LVL_INFO,
				"PMK =%02x:%02x:%02x:%02x-%02x:%02x:%02x:%02x\n",
				pKey->KeyMaterial[0], pKey->KeyMaterial[1],
				pKey->KeyMaterial[2], pKey->KeyMaterial[3], pKey->KeyMaterial[4],
				pKey->KeyMaterial[5], pKey->KeyMaterial[6], pKey->KeyMaterial[7]);
		} else
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_PMK, DBG_LVL_ERROR,
				"Set::RT_OID_802_11_WPA2_ADD_PMKID_CACHE ERROR or is wep key\n");
	}
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_INFO, "IF(ra%d)\n", apidx);
	if (apidx >= MAX_BEACON_NUM) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_ERROR,
			"Invalid interface id %d\n", apidx);
		return;
	...
	if (pAd->ApCfg.MBSSID[apidx].wdev.SecConfig.WepKey[KeyIdx].KeyLen == 0) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WEP, DBG_LVL_ERROR,
			"ERROR: Can not get Default shared-key (index-%d)\n", KeyIdx);
		return;
	}
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	if (wrq->u.data.length != sizeof(DOT1X_IDLE_TIMEOUT)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"the length is mis-match\n");
		return;
	}
	pIdleTime = &IdleTime;
	if (copy_from_user(&IdleTime, wrq->u.data.pointer, wrq->u.data.length)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "copy from user failed\n");
		return;
	}
	...
	if (pEntry == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "the entry is empty\n");
		return;
	}

	pEntry->NoDataIdleCount = 0;
	tr_entry = tr_entry_get(pAd, pEntry->wcid);
	if (pEntry->wcid < WTBL_MAX_NUM(pAd))
		tr_entry->NoDataIdleCount = 0;
	else
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_WARN,
			"wcid %d exceed tr_entry\n", pEntry->wcid);

	pEntry->StaIdleTimeout = pIdleTime->idle_timeout;
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
		"Update Idle-Timeout(%d) from dot1x daemon\n",
	...
	IN      RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	if (!VALID_MBSS(pAd, apidx)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Invalid interface id %d\n", apidx);
		return;
	}

	if (pAd->ApCfg.MBSSID[apidx].wdev.SecConfig.RadiusMacAuthCache.Policy != RADIUS_MAC_AUTH_ENABLE) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"RADIUS_MAC_AUTH Function State in Disable.\n");
		return;
	}
	...
	if (pAclEntry) {
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"Error in alloc mem in New Radius ACL Function.\n");
}
	...
	IN      RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	if (pListEntry) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "[%d]Del "MACSTR" in Cache(%d).\n", apidx,
	...
	IN      RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	if (pListHeader->size == 0) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "[%d] Radius ACL Cache already in empty.\n", apidx);
		return;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "Clean [%d] Radius ACL Cache.\n", apidx);
}
#endif /* RADIUS_MAC_ACL_SUPPORT */
	...
	IN      RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	if (copy_from_user(&macBuf, wrq->u.data.pointer, wrq->u.data.length)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "copy_to_user fail\n");
		return;
	}
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
		...
		while ((this_char = strsep((char **)&ptr, ",")) != NULL) {
			...
			if (!value || !*value) {
				...
				if (strstr(this_char, ":")) {
					...
					if (PD_GET_E2P_ACCESS_MODE(pAdapter->physical_dev)
						== E2P_FLASH_MODE)
	...
	if (bIsPrintAllE2PROM) {
		...
		for (eepAddr = start; eepAddr < end; eepAddr += 2) {
			RT28xx_EEPROM_READ16(pAdapter, eepAddr, eepValue);
			ret = snprintf(msg + strlen(msg), string_size - strlen(msg), "[0x%04X]:%04X  ", eepAddr, eepValue);
			if (os_snprintf_error(string_size - strlen(msg), ret)) {
				MTWF_DBG(NULL, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_WARN,
					"snprintf error!\n");
			}

			if ((eepAddr & 0x6) == 0x6) {
				ret = snprintf(msg + strlen(msg), string_size - strlen(msg), "\n");
				if (os_snprintf_error(string_size - strlen(msg), ret)) {
					MTWF_DBG(NULL, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_WARN,
					"snprintf error!\n");
				}
	...
	if (wrq->u.data.flags != RT_OID_802_11_HARDWARE_REGISTER)
		MTWF_DBG(NULL, DBG_CAT_FW, CATFW_EFUSE, DBG_LVL_INFO, "<==RTMPIoctlE2PROM\n");
}
...
int RTMPGetStatisticsStr(RTMP_ADAPTER *pAd, POS_COOKIE pObj, RTMP_STRING *msg, int msg_buf_len)
{
	...
	UINT8 ucBand = BAND0;
	ULONG txCount = 0;
	ULONG rxCount = 0, rxFcsCount = 0, rxFifofullCount = 0;
	...
	UINT16 u2CnInfo = 0;
	INT msg_len = msg_buf_len, left_buf_size;
	INT ret, allocRet = 0;
	UINT8 *pu4SensorResult = NULL, ddie_num = 0, die_index = 0;
	UINT32 sensorCount = 0, sensorType = 0;
	UINT32 ap_ackcount = 0, apcli_ackcount = 0;
	struct get_temp_adc *temp_adc;
	...
	rxFcsCount = (ULONG)pAd->WlanCounters.RxFcsErrorCount.u.LowPart - (ULONG)pAd->WlanCounters.LastRxFcsErrorCount.u.LowPart;
	rxFifofullCount = (ULONG)pAd->WlanCounters.RxFifoFullCount.u.LowPart - (ULONG)pAd->WlanCounters.LastRxFifoFullCount.u.LowPart;
...
#endif	/* CONFIG_WLAN_SERVICE */
	{
		...
		rxCount = (ULONG)pAd->WlanCounters.RxMpduCount.QuadPart - (ULONG)pAd->WlanCounters.LastRxMpduCount.QuadPart;
	}
	ddie_num = cap->ddie_lvts_num;
	allocRet = os_alloc_mem(pAd, (PUCHAR *)&pu4SensorResult,
			sizeof(UINT8) + (sizeof(struct get_temp_adc) * ddie_num));
	...
	for (sensorType = 0; sensorType < 2 && allocRet == NDIS_STATUS_SUCCESS; sensorType++) {
		memset(pu4SensorResult, 0x00, sizeof(UINT8) + (sizeof(struct get_temp_adc) * ddie_num));
		ret = MtCmdGetThermalTempAdcResult(pAd, sensorType, ucBand, pu4SensorResult);
		...
		for (die_index = 0 ; die_index < sensorCount && die_index < ddie_num; die_index++, temp_adc++) {
			...
			if (sensorType == 0)
				...
				ret = snprintf(msg + strlen(msg), left_buf_size
					, "LVTS%u			               = %d\n"
					, die_index, (int)temp_adc->temp);

			if (os_snprintf_error(left_buf_size, ret)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"final_name snprintf error!\n");
				if (pu4SensorResult != NULL)
					os_free_mem(pu4SensorResult);
				return 0;
			}
		}
	}
	...
	if (IS_HIF_TYPE(pAd, HIF_MT)) {
		per = txCount == 0 ? 0 : 1000 * (pAd->WlanCounters.FailedCount.u.LowPart) /
			  (pAd->WlanCounters.FailedCount.u.LowPart + txCount);

		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
				"Tx fail count                          = %lu, PER=%ld.%1ld%%\n"
				"Current BW Tx count                    = %lu\n"
				"Other BW Tx count                      = %lu\n",
				(ULONG)pAd->WlanCounters.FailedCount.u.LowPart,
				per / 10, per % 10,
				(ULONG)pAd->WlanCounters.CurrentBwTxCount.u.LowPart,
				(ULONG)pAd->WlanCounters.OtherBwTxCount.u.LowPart);
	...
	per = (rxCount == 0) ? 0 : 1000 * rxFcsCount / (rxFcsCount  + rxCount);
	ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
		"Rx with CRC                            = %lu, PER=%ld.%1ld%%\n"
		"Rx drop due to out of resource         = %lu\n",
		rxFcsCount, per / 10, per % 10, rxFifofullCount);
	if (os_snprintf_error(msg_len, ret)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"snprintf error!\n");
		return 0;
	...
	if (pAd->AckCntEnable) {
		ap_ackcount = pAd->WlanCounters.APAckCount.u.LowPart;
	#ifdef APCLI_SUPPORT
		apcli_ackcount = pAd->WlanCounters.APCliAckCount.u.LowPart;
	#endif /* APCLI_SUPPORT */
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
			"Ack Count                              = %d\n", ap_ackcount + apcli_ackcount);
		if (os_snprintf_error(msg_len, ret)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"snprintf error!\n");
			return 0;
	...
	ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "Rssi: ");
	if (os_snprintf_error(msg_len - strlen(msg), ret)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"snprintf error!\n");
		return 0;
	...
	for (path_idx = 0; (path_idx < len) && (path_idx < ARRAY_SIZE(rssi)); path_idx++) {
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "%d ", rssi[path_idx]);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"snprintf error!\n");
			return 0;
...

	{
			...
			for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i) && (i < WTBL_MAX_NUM(pAd)); i++) {
				...
				if ((IS_ENTRY_CLIENT(pEntry) && pEntry->Sst == SST_ASSOC) || IS_ENTRY_WDS(pEntry) || IS_ENTRY_PEER_AP(pEntry)) {
					...
					if (IS_HIF_TYPE(pAd, HIF_MT))  {
						...
						ShowLastRxPhyRate(
							pAd, ucBand, pEntry->wcid, &rx_rate);
						StatHERxRateToString(pAd, msg, rx_rate);
					} else
#endif /* MT_MAC */
					{
						ret = snprintf(msg + strlen(msg),
							msg_len - strlen(msg),
							"Last TX Rate                           ="
							" MCS%d, %2dM, %cGI, %s%s\n",
							lastTxRate & 0x7F,
							((lastTxRate >> 7) & 0x1) ? 40 : 20,
		...
		if (IS_HIF_TYPE(pAd, HIF_MT)) {
			...
			if (pAd->CommonCfg.bTXRX_RXV_ON) {
				ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
					"/* Condition Number should enable mode4 of 0x6020_426c */\n"
	...
	if (PD_GET_USE_EFUSE(pAd->physical_dev) == TRUE) {
		struct _RTMP_CHIP_CAP *cap = hc_get_chip_cap(pAd->hdev_ctrl);
		eFuseGetFreeBlockCount(pAd, &efusefreenum);

		if (cap->efuse_free_block_ver == EFUSE_FREE_BLOCK_FORMAT_V2) {
			int i = 0;
			struct _EFUSE_FREE_BLOCK_INFO *pEfuse_info = PD_GET_EFUSE_BLK_INFO_PTR(pAd->physical_dev);

			for (i = 0; i < cap->efuse_total_bank_num; i++) {
				ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
					"bankIdx:%d Total:%d Free:%d eFuseNum:%u\n",
					i, pEfuse_info->blk_info[i].total_block,
					pEfuse_info->blk_info[i].free_block,
					pEfuse_info->blk_info[i].efuse_num);
				if (os_snprintf_error(msg_len - strlen(msg), ret)) {
					MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
						"snprintf error!\n");
					return 0;
...

	{
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
				...
				pHSCtrl->HotSpotEnable, pHSCtrl->HSDaemonReady, pHSCtrl->DGAFDisable,
				pHSCtrl->L2Filter, pHSCtrl->ICMPv4Deny, pHSCtrl->QosMapEnable,
				pHSCtrl->bASANEnable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"snprintf error!\n");
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
				...
				pWNMCtrl->ProxyARPEnable, pWNMCtrl->WNMNotifyEnable, pWNMCtrl->WNMBTMEnable);
...
#ifdef CONFIG_DOT11U_INTERWORKING
		pGASCtrl = &pAd->ApCfg.MBSSID[apidx].GASCtrl;
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg),
				"GAS come back delay                    = %d\n"
				"GAS MMPDU size                         = %d\n"
				"GAS enable                             = %d\n",
				pGASCtrl->cb_delay, pGASCtrl->MMPDUSize, pGASCtrl->b11U_enable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"snprintf error!\n");
			return 0;
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "<==RTMPIoctlStatistics\n");
...
VOID RTMPIoctlStatistics(RTMP_ADAPTER *pAd, RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	UINT16 u2CnInfo = 0;
	UINT msg_len = 2048;
	int ret, left_buf_size, allocRet = 0;
	UINT8 *pu4SensorResult = NULL, ddie_num = 0, die_index = 0;
	UINT32 sensorCount = 0, sensorType = 0;
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_DEBUG, "ra offload=%d\n", cap->fgRateAdaptFWOffload);
#ifdef RACTRL_FW_OFFLOAD_SUPPORT
	...
	for (sensorType = 0; sensorType < 2 && allocRet == NDIS_STATUS_SUCCESS; sensorType++) {
		...
		sensorCount = *pu4SensorResult;
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "Sensor:%u\n", sensorCount);
...

	{
...
#endif /* MT_MAC */
					{
						ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "Last TX Rate                    = MCS%d, %2dM, %cGI, %s%s\n",
						...
						if (os_snprintf_error(msg_len - strlen(msg), ret)) {
							MTWF_DBG(pAd,
								DBG_CAT_CFG, CATCFG_DBGLOG,
								DBG_LVL_ERROR,
								"buffer full, stop!\n");
							goto done;
						}
						ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "Last RX Rate                    = MCS%d, %2dM, %cGI, %s%s\n",
		...
		if (IS_HIF_TYPE(pAd, HIF_MT)) {
			...
			if (pAd->CommonCfg.bTXRX_RXV_ON) {
				ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "/* Condition Number should enable mode4 of 0x6020_426c */\n");
				if (os_snprintf_error(msg_len - strlen(msg), ret)) {
					MTWF_DBG(pAd,
						DBG_CAT_CFG, CATCFG_DBGLOG,
						DBG_LVL_ERROR,
	...
	if (pAd->Flags & fRTMP_ADAPTER_RADIO_OFF)
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "Enable Wireless LAN		= %s\n", "0");
	else
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "Enable Wireless LAN		= %s\n", "1");
	if (os_snprintf_error(msg_len - strlen(msg), ret)) {
		MTWF_DBG(pAd,
	...
	if (PD_GET_USE_EFUSE(pAd->physical_dev) == TRUE) {
		...
		if (cap->efuse_free_block_ver == EFUSE_FREE_BLOCK_FORMAT_V2) {
			...
			ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "efuseFreeNumber                 = %d\n", efusefreenum);
			if (os_snprintf_error(msg_len - strlen(msg), ret)) {
				MTWF_DBG(pAd,
					DBG_CAT_CFG, CATCFG_DBGLOG,
					DBG_LVL_ERROR,
...

	{
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot enable                    = %d\n", pHSCtrl->HotSpotEnable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "daemon ready                  = %d\n", pHSCtrl->HSDaemonReady);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot DGAFDisable               = %d\n", pHSCtrl->DGAFDisable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot L2Filter              = %d\n", pHSCtrl->L2Filter);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot ICMPv4Deny                = %d\n", pHSCtrl->ICMPv4Deny);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot QosMapEnable              = %d\n", pHSCtrl->QosMapEnable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
		...
		ret = snprintf(msg + strlen(msg), msg_len - strlen(msg), "hotspot OSEN enable                   = %d\n", pHSCtrl->bASANEnable);
		if (os_snprintf_error(msg_len - strlen(msg), ret)) {
			MTWF_DBG(pAd,
				DBG_CAT_CFG, CATCFG_DBGLOG,
				DBG_LVL_ERROR,
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	for (i = 0; ((VALID_UCAST_ENTRY_WCID(pAd, i)) && (TotalEntry > 0) && (i < WTBL_MAX_NUM(pAd))); i++) {
		PMAC_TABLE_ENTRY pEntry = entry_get(pAd, i);
		...
		if (IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC) && (ba_info->TxBitmap) && (index < 32)
			&& (index < ARRAY_SIZE(BAT->BAOriEntry))) {
			NdisMoveMemory(BAT->BAOriEntry[index].MACAddr, pEntry->Addr, 6);

			for (j = 0; (j < 8) && (j < ARRAY_SIZE(BAT->BAOriEntry[index].BufSize) &&
				(j < ARRAY_SIZE(ba_info->OriWcidArray)) && (ba_info->OriWcidArray[j] < ARRAY_SIZE(ba_ctl->BAOriEntry))); j++) {
				if (ba_info->OriWcidArray[j] != 0)
					BAT->BAOriEntry[index].BufSize[j] = ba_ctl->BAOriEntry[ba_info->OriWcidArray[j]].BAWinSize;
				else
	...
	for (i = 0; ((VALID_UCAST_ENTRY_WCID(pAd, i)) && (TotalEntry > 0) && (i < WTBL_MAX_NUM(pAd))); i++) {
		...
		if (IS_ENTRY_CLIENT(pEntry) && (pEntry->Sst == SST_ASSOC) && (ba_info->RxBitmap) && (index < 32)
			&& (index < ARRAY_SIZE(BAT->BARecEntry))) {
			NdisMoveMemory(BAT->BARecEntry[index].MACAddr, pEntry->Addr, 6);
			BAT->BARecEntry[index].BaBitmap = (UCHAR)ba_info->RxBitmap;

			for (j = 0; (j < 8) && (j < ARRAY_SIZE(BAT->BARecEntry[index].BufSize)) &&
				(j < ARRAY_SIZE(ba_info->RecWcidArray)) && (ba_info->RecWcidArray[j] < ARRAY_SIZE(ba_ctl->BARecEntry)); j++) {
				Idx = ba_info->RecWcidArray[j];

				if (Idx != 0) {
					ba_entry = &ba_ctl->BARecEntry[Idx];
					NdisAcquireSpinLock(&ba_entry->RxReRingLock);
					BAT->BARecEntry[index].BufSize[j] = ba_entry->BAWinSize;
	...
	if (copy_to_user(wrq->u.data.pointer, BAT, wrq->u.data.length))
		MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_BA, DBG_LVL_ERROR, "copy_to_user() fail\n");
...
INT Set_ApCli_SendPsPoll_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((pObj->ioctl_if_type != INT_APCLI) || (pObj->ioctl_if >= MAX_MULTI_STA))
		return FALSE;
...
INT Set_ApCli_PwrSet_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	for (wcid = 0; VALID_UCAST_ENTRY_WCID(pAd, wcid) && (wcid < WTBL_MAX_NUM(pAd)); wcid++) {
		pEntry = entry_get(pAd, wcid);
	...
	IN	BOOLEAN flag)
{
	...
	if ((ifIndex >= MAX_APCLI_NUM) || (ifIndex >= MAX_MULTI_STA)) {
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR,
			"Error ifIdx = %d\n", ifIndex);
		return FALSE;
	}
	...
	if (IS_MAP_TURNKEY_ENABLE(pAd)) {
		if (pAd->StaCfg[ifIndex].ApcliInfStat.Enable
			&& (pDot11h && pDot11h->ChannelMode == CHAN_SILENCE_MODE)) {
			pDot11h->RDCount = pDot11h->cac_time;
		}
	}
#endif
	MTWF_PRINT("I/F(apcli%d) (enable = %d)\n",
...
INT Set_ApCli_Enable_Proc(PRTMP_ADAPTER pAd, RTMP_STRING *arg)
{
	UINT Enable;
	BOOLEAN flag;
	POS_COOKIE pObj;
	...
	Enable = (UINT)os_str_tol(arg, 0, 16);
	...
	IN  RTMP_STRING *arg)
{
	...
	if (strlen(arg) == 17) { /* Mac address acceptable format 01:02:03:04:05:06 length 17 */
		for (i = 0, value = rstrtok(arg, ":"); value && (i < ARRAY_SIZE(pAd->StaCfg[ifIndex].CfgApCliBssid)); value = rstrtok(NULL, ":"), i++) {
			if ((strlen(value) != 2) || (!isxdigit(*value)) || (!isxdigit(*(value + 1))))
	...
	MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "(%2X:%2X:%2X:%2X:%2X:%2X)\n",
...
INT Set_ApCli_AuthMode(RTMP_ADAPTER *pAd, INT staidx, RTMP_STRING *arg)
{
	...
	if (staidx < 0 || staidx >= MAX_MULTI_STA) {
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR,
			"Error ifIdx = %d\n", staidx);
		return FALSE;
	}
	...
	if (pSecConfig == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR, "pSecConfig == NULL, arg=%s\n", arg);
		return FALSE;
	}
	...
	IN  RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "I/F(apcli%d) = %d\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	wdev->channel = HcGetRadioChannel(pAd);
	...
	if (wdev_do_close(wdev) != TRUE)
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "close fail!\n");
	...
	/* sync bw ext ch from mbss wdev */
	{
		if (pAd->CommonCfg.dbdc_mode == TRUE) {
			...
			for (mbss_idx = 0; (mbss_idx < pAd->ApCfg.BssidNum) && VALID_MBSS(pAd, mbss_idx) ; mbss_idx++) {
	...
	if (wdev_do_open(wdev) != TRUE)
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO, "open fail!!!\n");
...
INT Set_ApCli_Twt_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	for (i = 0, macptr = rstrtok(arg, "-"); macptr && (i < CMD_TWT_MAX_PARAMS); macptr = rstrtok(NULL, "-"), i++) {
	...
	RTMP_STRING *arg)
{
	...
	if  (ifIndex >= MAX_MULTI_STA) {
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR, "invalid ioctl_if %d\n", ifIndex);
		return FALSE;
	}
	...
	if (pApCliEntry->TrialCh)
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO,
			"I/F(apcli%d) pApCliEntry->TrialCh = %d\n", ifIndex, pApCliEntry->TrialCh);
	else
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO,
			"I/F(apcli%d) pApCliEntry->TrialCh = %d\n", ifIndex, pApCliEntry->TrialCh);
	...
	IN  RTMP_STRING *arg)
{
	...
	case INT_APCLI:
		...
		break;
	default:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "No Support This Type\n");
		return FALSE;
...
#ifdef APCLI_CFG80211_SUPPORT
		MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_ERROR,
			"Auto connect by ioctl is removed for APCLI CFG80211\n");
		return FALSE;
#else /* APCLI_CFG80211_SUPPORT */
	POS_COOKIE	pObj = (POS_COOKIE) pAd->OS_Cookie;
	UCHAR				ifIndex;
...
{
	{
		...
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2020, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2024, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2128, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E212C, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2130, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2134, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E2138, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820E213C, 0x000a000a);

		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2020, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2024, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2128, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F212C, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2130, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2134, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F2138, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x820F213C, 0x000a000a);

		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2020, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2024, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2128, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E212C, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2130, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2134, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E2138, 0x000a000a);
		RTMP_IO_WRITE32(pAd->hdev_ctrl, 0x830E213C, 0x000a000a);
	}
...
INT Set_RoamingEnhance_Enable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "I/F(apcli%d) (enable = %d)\n",
	...
	IN      BOOLEAN     bIsApCli)
{
	...
	for (idx = 0; (idx < 192) && (idx < ARRAY_SIZE(pWscControl->RegData.EnrolleeRandom)); idx++)
	...
	if (bIsApCli) {
		...
		OS_SEM_LOCK(&pWscControl->WscPeerListSemLock);
		WscClearPeerList(&pWscControl->WscPeerList);
		OS_SEM_UNLOCK(&pWscControl->WscPeerListSemLock);
	}
	...
	RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((Mode >= CON_WPS_APCLI_BAND_MAX) || (opposBandIdx >= ARRAY_SIZE(adapt_list)))
		return FALSE;
	...
	RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((PreferIface >= CON_WPS_APCLI_AUTO_PREFER_IFACE_MAX) || (opposBandIdx >= ARRAY_SIZE(adapt_list)))
		return FALSE;
	...
	RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if  (opposBandIdx >= ARRAY_SIZE(adapt_list))
		return FALSE;
	...
	IN	RTMP_STRING *arg)
{
	...
	if (ConfModeIdx == WSC_ENROLLEE_REGISTRAR) {
		...
		if ((pAd->ApCfg.ConWpsApCliDisableSetting == TRUE) &&
			...
			entry = entry_get(pAd, ApClientWcid);
			tr_entry = tr_entry_get(pAd, ApClientWcid);
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "IF(ra%d) (WscStatus=%d)\n",
...
/* WPS_BandSteering Support */
	...
	if (!bFromApCli) {
		if ((WscMode == DEV_PASS_ID_PIN) && VALID_MBSS(pAd, (INT)pWscControl->EntryIfIdx)) {
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "IF(ra%d)\n", apidx);
	return TRUE;
}
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	* wrq)
{
	...
	NdisZeroMemory(Profile.WscSsid, ARRAY_SIZE(Profile.WscSsid));
	if (pMbss->SsidLen > ARRAY_SIZE(Profile.WscSsid))
		pMbss->SsidLen = ARRAY_SIZE(Profile.WscSsid);
	...
	NdisZeroMemory(Profile.WscWPAKey, ARRAY_SIZE(Profile.WscWPAKey));
	...
	if (Profile.WscEncrypType == 2) {
		...
		if (pMbss->wdev.WscControl.WpaPskLen > ARRAY_SIZE(Profile.WscWPAKey))
			pMbss->wdev.WscControl.WpaPskLen = ARRAY_SIZE(Profile.WscWPAKey);
...
#endif/* INF_AR9 */
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "%s", msg);
	os_free_mem(msg);
}
#endif /* VENDOR_FEATURE6_SUPPORT */
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	if (copy_to_user(wrq->u.data.pointer, &Profile, wrq->u.data.length))
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "copy_to_user() fail\n");
	...
	copy_to_user(wrq->u.data.pointer, msg, wrq->u.data.length);
#endif/* INF_AR9 */
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "%s", msg);
done:
	os_free_mem(msg);
}
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	if (Profile.WscEncrypType == 2) {
		...
		Profile.DefaultKeyIdx = 2;
		if (pAd->ApCfg.MBSSID[apidx].wdev.WscControl.WpaPskLen > ARRAY_SIZE(Profile.WscWPAKey))
			pAd->ApCfg.MBSSID[apidx].wdev.WscControl.WpaPskLen = ARRAY_SIZE(Profile.WscWPAKey);
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	 *wrq)
{
	...
	if (msg == NULL) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "Alloc memory failed\n");
		return;
	}
	...
	if (copy_to_user(wrq->u.data.pointer, msg, wrq->u.data.length))
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "%s", msg);
...
#endif /* defined(AR9_MAPI_SUPPORT) */
#endif /* defined(INF_AR9) */
	...
	IN  PWSC_CTRL       pWscControl)
{
	...
	MTWF_DBG(NULL, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "check Enrollee Nonce\n");
	...
	while (Length > 4) {
		...
		if (Length < WscLen + 4) {
			MTWF_DBG(NULL, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR,
	...
	MTWF_DBG(NULL, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "Nonce mismatch!!\n");
	return FALSE;
}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	Set_SecWPAPSK_Proc(pAd, "RalinkInitialAPxx1234");
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "IF(ra%d)\n", apidx);
}
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "IF(ra%d) (WscSecurityMode=%d)\n",
	...
	IN  RTMP_STRING *arg)
{
	...
	if (pObj->ioctl_if_type == INT_APCLI) {
		if (apidx >= MAX_MULTI_STA) {
			MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "invalid ioctl_if %d\n", apidx);
			return FALSE;
		}
		bFromApCli = TRUE;
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "IF(ra%d) (bCheckMultiByte=%d)\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	if (ifIndex >= MAX_BEACON_NUM) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "error AP index\n");
		return FALSE;
	}

	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(version=%x)\n", version);
	...
	IN	RTMP_STRING *arg)
{
	...
	if (strlen(arg) ==	(UUID_LEN_STR - 1)) {
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "[%d]::(arg=%s)\n", ifIndex, arg);
		...
		MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO,
			"ERROR [%d]::(arg=%s), Leng(%d) is incorrect!\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(bool_flag=%d)\n", bool_flag);
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(WscFragSize=%d)\n", WscFragSize);
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(bSetupLock=%d)\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(bEnableWpsV2=%d)\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(new_tag=0x%04X)\n", new_tag);
	return TRUE;
}
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(type=%d)\n", type);
	return TRUE;
}
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(DataLen = %d)\n", DataLen);
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "os_alloc_mem fail\n");
	return FALSE;
}
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(MaxPinAttack=%d)\n", MaxPinAttack);
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(SetupLockTime=%d)\n",
			 SetupLockTime);
	...
	IN	RTMP_STRING		*arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "(bWscAutoTriggerDisable=%d)\n",
...
#ifdef FORCE_NULL_TX
/*test command to force null to a station */
INT	Set_ForceNullTx_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	RTMP_STRING * arg)
{
	...
	if (pEntry) {
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_KPLIVE, DBG_LVL_ERROR, "%s: Send Force Null to WCID:%ld\n", __func__, wcid);
		if (CLIENT_STATUS_TEST_FLAG(pEntry, fCLIENT_STATUS_WMM_CAPABLE))
			bQosNull = TRUE;
		RtmpEnqueueForceNullFrame(pAd, pEntry->Addr, pEntry->CurrTxRate,
								pEntry->wcid, pEntry->func_tb_idx, bQosNull, TRUE, 0);
	} else
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_KPLIVE, DBG_LVL_ERROR, "%s: pEntry not found\n", __func__);
	...
	IN	RTMP_STRING *arg)
{
	...
	for (i = 0, value = rstrtok(arg, ":"); value && (i < ARRAY_SIZE(macAddr)); value = rstrtok(NULL, ":")) {
		if ((strlen(value) != 2) || (!isxdigit(*value)) || (!isxdigit(*(value + 1))))
			return FALSE;  /*Invalid */
	...
	IN RTMP_STRING *arg)
{
	...
	if (value == 2) {
		...
		for (i = 0; VALID_UCAST_ENTRY_WCID(pAd, i); i++) {
			...
			if (IS_ENTRY_CLIENT(pEntry)) {
				MTWF_DBG(pAd, DBG_CAT_CLIENT, CATCLIENT_APCLI, DBG_LVL_INFO,
					"[PMF] MacTableDeleteEntry %x:%x:%x:%x:%x:%x\n", PRINT_MAC(pEntry->Addr));
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "I/F(%s%d) IEEE8021X=%d\n",
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "I/F(%s%d) PreAuth=%d\n",
	...
	IN	RTMP_STRING *arg)
{
	...
	if (strlen(arg) > 0 && strlen(arg) <= IFNAMSIZ) {
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "EAPifname=%s, len=%d\n",
...
INT	Set_RADIUS_Key_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	for (count = 0, macptr = rstrtok(arg, ";"); (macptr &&
		...
		if (strlen(macptr) > 0 && strlen(macptr) < 65 && srv_cnt < pSecConfig->radius_srv_num) {
			...
			if (pSrvInfo->radius_key_len > ARRAY_SIZE(pSrvInfo->radius_key))
				pSrvInfo->radius_key_len = ARRAY_SIZE(pSrvInfo->radius_key);
...
#ifdef DOT11_EHT_BE
	own_mac_mld = wdev->bss_info_argument.mld_info.mld_addr;
	MTWF_DBG(NULL, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_INFO,
		"MLO, own mac mld="MACSTR"\n", own_mac_mld);
#endif /* DOT11_EHT_BE */

	pmkid_cache = PD_GET_PMKID_PTR(pAd->physical_dev);
	own_mac_link = pAd->ApCfg.MBSSID[apidx].wdev.bssid;
	OS_SEM_LOCK(&pmkid_cache->pmkid_lock);
	for (i = 0; i < MAX_PMKID_COUNT; i++) {
		RTMPDeletePMKIDCache(pmkid_cache, own_mac_link, i); /* non-MLO for legacy */
#ifdef DOT11_EHT_BE
		if (!MAC_ADDR_EQUAL(own_mac_mld, own_mac_link) && !MAC_ADDR_EQUAL(own_mac_mld, ZERO_MAC_ADDR)) {
			MTWF_DBG(NULL, DBG_CAT_SEC, CATSEC_KEY, DBG_LVL_INFO,
				"clear PMKID cache for MLO, own mac mld="MACSTR"\n", own_mac_mld);
			RTMPDeletePMKIDCache(pmkid_cache, own_mac_mld, i); /* MLO */
		}
#endif /* DOT11_EHT_BE */
	}
	OS_SEM_UNLOCK(&pmkid_cache->pmkid_lock);
...
INT	Set_DumpPMKID_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (imput == 1) {
		for (i = 0; i < MAX_PMKID_COUNT; i++) {
			...
			if (pBssInfo->Valid) {
				MTWF_PRINT("Cacheidx = %d, own mac="MACSTR", peer mac="MACSTR"\n",
						  i, MAC2STR(pBssInfo->own_mac), MAC2STR(pBssInfo->peer_mac));
				MTWF_PRINT("is_mlo_connect=%d, is_ft=%d\n", pBssInfo->is_mlo_connect, pBssInfo->is_ft);
				hex_dump_always("PMKID:", pBssInfo->PMKID, LEN_PMKID);
			}
		}
	}
...
INT set_mgmt_rate_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING * arg)
{
	...
	if (wlan_config_get_ch_band(wdev) != CMD_CH_BAND_24G) {
		if (phymode == EAP_CCK) {
			MTWF_PRINT("We could not set CCK mode for Mgm in 5/6G band!\n");
			return FALSE;
		}
	}
	...
	case EAP_RATE_DISABLE: /* disable */
		NdisMoveMemory(transmit, &wdev->rate.MlmeTransmit, sizeof(union _HTTRANSMIT_SETTING));
	...
	case EAP_CCK:	/* CCK */
		...
		if (mcs <= 3) {
			if (OPSTATUS_TEST_FLAG(pAd, fOP_STATUS_SHORT_PREAMBLE_INUSED)) {
				if (mcs == 0) {
					mcs = mcs + 1;
					MTWF_PRINT("Invalid MCS(CCK-1M) in Short Preamble!\n");
				}
				mcs |= 0x4;
			}
			transmit->field.MCS = mcs;
		} else {
			MTWF_PRINT("MCS must in range of 0 ~ 3 for CCK Mode.\n");
			mcs = 0;
			status = FALSE;
		}
	...
	case EAP_OFDM:	/* OFDM */
		...
		transmit->field.BW =  BW_20;
		if (mcs > 7) {
			MTWF_PRINT("MCS must in range from 0 to 7 for OFDM Mode.\n");
			mcs = 0;
			status = FALSE;
		} else
			transmit->field.MCS = mcs;
		...
		break;
	default:
		MTWF_PRINT("unknown mgmt ratetype/phymode/mcs %d/%d/%d.\n", ratetype, phymode, mcs);
		status = FALSE;
	...
	MTWF_PRINT("mgmt rateen(%x), ratetype/phymode/mcs = %d-%d-%d\n",
		wdev->eap.eap_mgmrate_en, ratetype, phymode, mcs);

	return status;

Error:
	MTWF_PRINT("error input parameter!\n");
	MTWF_PRINT("iwpriv ra0 set mgmtrate=[ratetype]-[phymode]-[mcs]\n");
	MTWF_PRINT("[ratetype]: 0-BCN, 1-MGMT, 2-PROBE, 3-AUTH, 4-ASSOC, 5-ACTION\n");
	MTWF_PRINT("[phymode] : 0-Disable	[mcs]:ignore\n");
	MTWF_PRINT("[phymode] : 1-CCK	[mcs]:0~3\n");
	MTWF_PRINT("[phymode] : 2-OFDM	[mcs]:0~7\n");
...
INT show_mgmtrate(IN PRTMP_ADAPTER pAd, IN RTMP_STRING * arg)
{
	...
	struct wifi_dev *wdev = NULL;
	POS_COOKIE pObj = (POS_COOKIE) pAd->OS_Cookie;
	UCHAR i, ratetype = 0xFF, str[10] = {"\0"};
	int ret;
	...
	if (arg != NULL)
		ratetype = os_str_tol(arg, 0, 10);

	MTWF_PRINT("Mgmt Rate Enable = %x, ratetype = %x\n\n", wdev->eap.eap_mgmrate_en, ratetype);

	for (i = BCN_TYPE; i < MGMT_MAX_TYPE; i++) {

		if (ratetype != 0xFF && i != ratetype)
			continue;

		switch (i) {
		case BCN_TYPE:
			ret = snprintf(str, 10, "%s", "BCN");
			break;
		case MGMT_TYPE:
			ret = snprintf(str, 10, "%s", "MGMT");
			break;
		case PROBE_TYPE:
			ret = snprintf(str, 10, "%s", "PROBE");
			break;
		case AUTH_TYPE:
			ret = snprintf(str, 10, "%s", "AUTH");
			break;
		case ASSOC_TYPE:
			ret = snprintf(str, 10, "%s", "ASSOC");
			break;
		case ACTION_TYPE:
			ret = snprintf(str, 10, "%s", "ACTION");
			break;
		default:
			MTWF_PRINT("error mgmt rate type!\n");
			return FALSE;
		}
		...
		transmit = &wdev->eap.mgmphymode[i];

		MTWF_PRINT("RateType = %d-%s\n", i, str);
		MTWF_PRINT("%s Transmit = %x\n", str, transmit->word);
		if (transmit->field.MODE == MODE_CCK) {
			MTWF_PRINT("Enable %s Preamble\n",
					(transmit->field.MCS & 0x4) ? "Short" : "Long");
			transmit->field.MCS &= 0x3;
		}
		MTWF_PRINT("%s PhyMode = %d, Mcs = %d, BW = %d\n\n", str,
			transmit->field.MODE + 1, transmit->field.MCS, transmit->field.BW);
	}
...
INT set_high_pri_rate_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING * arg)
{
	...
	if ((pObj->ioctl_if_type != INT_MBSSID) && (pObj->ioctl_if_type != INT_MAIN)) {
		MTWF_PRINT("Do nothing! This device interface is NOT AP mode!\n");
		return FALSE;
	}

	if (apidx >= pAd->ApCfg.BssidNum) {
		MTWF_PRINT("Invalid device interface!\n");
		return FALSE;
	}
	...
	case EAP_OFDM:	/* OFDM */
		...
		break;
	default:
		MTWF_PRINT("unknown hpri ratetype/phymode/mcs %d/%d/%d.\n", ratetype, phymode, mcs);
		status = FALSE;
	...
	MTWF_PRINT("highpri rateen(%x), ratetype/phymode/mcs = %d-%d-%d\n",
		wdev->eap.eap_hprirate_en, ratetype, phymode, mcs);

	for (i = 0; i < pAd->ApCfg.BssidNum; i++) {
		struct wifi_dev *mwdev = &pAd->ApCfg.MBSSID[i].wdev;

		mbandIdx =	HcGetBandByWdev(mwdev);
		if (mbandIdx != bandIdx)
			continue;
		/* Sync config to single band all bss */
		mwdev->eap.eap_hprirate_en = wdev->eap.eap_hprirate_en;
		mwdev->eap.hpriphymode[ratetype].word = transmit->word;
	}
	...
	if (AsicBssInfoUpdate(pAd, &bss_info_argument) != NDIS_STATUS_SUCCESS) {
		MTWF_PRINT("Fail to apply the bssinfo, BSSID=%d!\n", apidx);
		status = FALSE;
	}
...
Error:
	MTWF_PRINT("error input parameter!\n");
	MTWF_PRINT("iwpriv ra0 set highprirate=[ratetype]-[phymode]-[mcs]\n");
	MTWF_PRINT("[ratetype]: 0-ARP, 1-DHCP, 2-PING, 3-EAPOL\n");
	MTWF_PRINT("[phymode] : 0-Disable	[mcs]:ignore\n");
	MTWF_PRINT("[phymode] : 1-CCK	[mcs]:0~3\n");
	MTWF_PRINT("[phymode] : 2-OFDM	[mcs]:0~7\n");
...
INT show_high_pri_rate(IN PRTMP_ADAPTER pAd, IN RTMP_STRING * arg)
{
	...
	MTWF_PRINT("HighPri Rate Enable = %x, ratetype = %x\n\n", wdev->eap.eap_hprirate_en, ratetype);
	...
	for (i = HIGHPRI_ARP; i < HIGHPRI_MAX_TYPE; i++) {
		...
		switch (i) {
		case HIGHPRI_ARP:
			ret = snprintf(str, 10, "%s", "ARP");
			break;
		case HIGHPRI_DHCP:
			ret = snprintf(str, 10, "%s", "DHCP");
			break;
		case HIGHPRI_PING:
			ret = snprintf(str, 10, "%s", "PING");
			break;
		case HIGHPRI_EAPOL:
			ret = snprintf(str, 10, "%s", "EAPOL");
			break;
		default:
			MTWF_PRINT("error mgmt rate type!\n");
			return FALSE;
		...
		transmit = &wdev->eap.hpriphymode[i];
	...
	for (i = 0; i < MAX_LEN_OF_SUPPORTED_RATES; i++) {
		if (supratesetbitmap & (1 << i)) {
			if (WMODE_EQUAL(wdev->PhyMode, WMODE_B)
				...
				|| wlan_config_get_ch_band(wdev) == CMD_CH_BAND_6G) && (i > 3)) {
				eap_legacy_rate->sup_rate[eap_legacy_rate->sup_rate_len] = rate[i];
				eap_legacy_rate->sup_rate_len++;
...
INT set_htsuprateset_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING *arg)
{
	...
	if (!WMODE_CAP_N(wdev->PhyMode)) {
		...
		"Device not configured in HT mode\n");
		return FALSE;
	}
...
INT set_vhtsuprateset_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING *arg)
{
	...
	if (!WMODE_CAP_AC(wdev->PhyMode)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_MISC, DBG_LVL_ERROR,
		"Device not configured in VHT mode\n");
		return FALSE;
	}
...
static BOOLEAN check_hesuprateset(RTMP_STRING * arg)
{
	...
	MTWF_DBG(NULL, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_NOTICE, "arg=%s\n", arg);
...
HELP:
	...
	MTWF_PRINT("Usage: iwpriv [interface] set hesuprateset=[BW <= 80 MCS],");
	MTWF_PRINT("[BW160 MCS],[BW8080 MCS]\n");
	...
	MTWF_PRINT("This command set the supported MCS(BW <= 80, RX, SS1&SS2) to 0 ");
	MTWF_PRINT("and MCS(BW <= 80, RX, SS1) to 1, the rest of MCS are 3.\n");
...
INT set_hesuprateset_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING *arg)
{
	...
	if (!WMODE_CAP_AX(wdev->PhyMode)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
		"Device not configured in AX mode\n");
		return FALSE;
	}
	...
	UpdateBeaconHandler(pAd, wdev, BCN_REASON(BCN_UPDATE_IE_CHG));
	for (i = 1; VALID_UCAST_ENTRY_WCID(pAd, i); i++) {
		MAC_TABLE_ENTRY *mac_entry = entry_get(pAd, i);
		...
		if (IS_ENTRY_CLIENT(mac_entry) &&
			...
			if (IS_HE_STA(mac_entry->cap.modes)) {
				mac_entry->update_he_maxra = true;
...
#ifdef DOT11_EHT_BE
static BOOLEAN check_ehtsuprateset(RTMP_STRING *arg)
{
	UINT comma = 0;
	PUCHAR c;

	MTWF_DBG(NULL, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE, "arg=%s\n", arg);
...
HELP:
	MTWF_PRINT("ehtsuprateset: param error\n");
	MTWF_PRINT("Usage:\n");
	MTWF_PRINT("       iwpriv [interface] set ehtsuprateset=[BW <= 80 NSS],[BW160 NSS],");
	MTWF_PRINT("[BW320 NSS]\n");
	MTWF_PRINT("       iwpriv [interface] set ehtsuprateset=[BW <= 80 NSS],[BW160 NSS]\n");
	MTWF_PRINT("       iwpriv [interface] set ehtsuprateset=[BW <= 80 NSS]\n");
	MTWF_PRINT("The format of [BW <= 80 NSS], [BW160 NSS], and [BW320 NSS] is:\n");
	MTWF_PRINT("  bit 3-0  : Rx max NSS for EHT-MCS 0-9\n");
	MTWF_PRINT("  bit 7-4  : Tx max NSS for EHT-MCS 0-9\n");
	MTWF_PRINT("  bit 11-8 : Rx max NSS for EHT-MCS 10-11\n");
	MTWF_PRINT("  bit 15-12: Tx max NSS for EHT-MCS 10-11\n");
	MTWF_PRINT("  bit 19-16: Rx max NSS for EHT-MCS 12-13\n");
	MTWF_PRINT("  bit 23-20: Tx max NSS for EHT-MCS 12-13\n\n");
	MTWF_PRINT("Max NSS encoding:\n");
	MTWF_PRINT("  0        : Not supported\n");
	MTWF_PRINT("  1-8      : 1-8 Max NSS\n");
	MTWF_PRINT("  9-15     : Reserved\n");
	MTWF_PRINT("If the [BW* NSS] is omitted, the 0x000000 is set to.\n");
	MTWF_PRINT("eg: iwpriv ra0 set ehtsuprateset=0x000088\n");
	MTWF_PRINT("For an AP, this command sets the Rx and Tx max NSS that supports EHT-MCS 0-9 ");
	MTWF_PRINT("for BW <= 80 to 8,");
	MTWF_PRINT("the rest of the max NSS are 0.\n");
...
INT set_ehtsuprateset_proc(IN PRTMP_ADAPTER pAd, IN RTMP_STRING *arg)
{
	...
	for (i = 0, nss_ptr = rstrtok(arg, ",");
	     nss_ptr && i < (ARRAY_SIZE(nss_set));
	     nss_ptr = rstrtok(NULL, ","), i++) {

		nss_set[i] = (UINT32)os_str_tol(nss_ptr, 0, 0);
	}
	MTWF_PRINT("%s nss_set: 0x%x 0x%x 0x%x\n", wdev->if_dev->name,
		  nss_set[0], nss_set[1], nss_set[2]);

	for (i = EHT_NSS_MCS_80; i < EHT_MCS_NSS_BW_NUM; i++) {
	...
	for (i = 1; VALID_UCAST_ENTRY_WCID(pAd, i); i++) {
		...
		if (IS_ENTRY_CLIENT(mac_entry) &&
			...
			if (IS_EHT_STA(mac_entry->cap.modes)) {
				mac_entry->update_eht_maxra = true;
				eaprawrapperentryset(pAd, mac_entry, &mac_entry->RaEntry);
				RTEnqueueInternalCmd(pAd, CMDTHREAD_UPDATE_MAXRA,
						     mac_entry, sizeof(MAC_TABLE_ENTRY));
			}
	...
	IN RTMP_STRING *arg)
{
	...
	BSS_INFO_ARGUMENT_T bss_info_argument;
	union _HTTRANSMIT_SETTING *transmit;
	UINT Phymode, Mcs, cfg_ht_bw, txnss, bandIdx;
	struct wifi_dev *wdev = NULL;
#ifdef MCAST_VENDOR10_CUSTOM_FEATURE
	INT i = 0;
	UCHAR mbandIdx;
	...
	if (wlan_config_get_ch_band(wdev) != CMD_CH_BAND_24G) {
		if (Phymode == MCAST_CCK) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
					 "We could not set CCK mode for multicast frames in 5/6G band!\n");
			return FALSE;
		}
	}
	...
	case MCAST_CCK:	/* CCK */
		...
		if (Mcs <= 3) {
			if (OPSTATUS_TEST_FLAG(pAd, fOP_STATUS_SHORT_PREAMBLE_INUSED)) {
				if (Mcs == 0) {
					Mcs = Mcs + 1;
					MTWF_DBG(pAd, DBG_CAT_TX, CATTX_PREAMBLE, DBG_LVL_ERROR,
			...
			MTWF_DBG(pAd, DBG_CAT_TX, CATTX_PREAMBLE, DBG_LVL_ERROR,
					 "MCS must in range of 0 ~ 3 for CCK Mode.\n");
			Mcs = 0;
			status = FALSE;
		}
	...
	default:
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
				 "unknown Multicast PhyMode/Mcs %d/%d.\n", Phymode, Mcs);
		status = FALSE;
		break;
	}
	...
	for (i = 0; i < pAd->ApCfg.BssidNum; i++) {
		...
		bss_info_argument.ucBssIndex = wdev->bss_info_argument.ucBssIndex;
		bss_info_argument.u8BssInfoFeature = BSS_INFO_BROADCAST_INFO_FEATURE;
		memmove(&bss_info_argument.BcTransmit, transmit, sizeof(union _HTTRANSMIT_SETTING));
		memmove(&bss_info_argument.McTransmit, transmit, sizeof(union _HTTRANSMIT_SETTING));
...
Error:
	MTWF_PRINT("error input parameter!\n");
	MTWF_PRINT("iwpriv ra0 set McastRate=[phymode]-[mcs]\n");
	MTWF_PRINT("[phymode]:0-Disable [mcs]:ignore\n");
	MTWF_PRINT("[phymode]:1-CCK     [mcs]:0~3\n");
	MTWF_PRINT("[phymode]:2-OFDM    [mcs]:0~7\n");
	...
	IN	RTMP_STRING *arg)
{
	...
	if (ifIndex >= MAX_BEACON_NUM) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "error AP index\n");
		return FALSE;
	}

	if (pAd->CommonCfg.bBssCoexEnable == FALSE) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "BssCoex not enable\n");
		return FALSE;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Trigger AP ReScan !!!\n");
	return TRUE;
}
#endif /* DOT11N_DRAFT3 */
#endif /* DOT11_N_SUPPORT */
...
#ifdef RT_CFG80211_SUPPORT
INT	mtk_cfg80211_trigger_2040_overlap_scan(RTMP_ADAPTER *pAd, struct wifi_dev *wdev)
{
	if (pAd->CommonCfg.bBssCoexEnable == FALSE) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_WARN, "BssCoex not enable\n");
		return FALSE;
	}

	/*To do overlap scan, need TakeChannelOpCharge first*/
	if (!TakeChannelOpCharge(pAd, wdev, CH_OP_OWNER_SCAN, FALSE)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_NOTICE,
			"TakeChannelOpCharge fail for 2040 overlap SCAN!!\n");
		return FALSE;
	}
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "Trigger AP overlap scan !!!\n");
...
#ifdef EAP_STATS_SUPPORT
INT Set_StaPowerOffDetect_Proc(struct _RTMP_ADAPTER *pAd, char *arg)
{
	RTMP_STRING *this_char;
	UINT16 err_times;
	...
	if (this_char == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "invalid input arg");
		return FALSE;
	}
	...
	txm_thres.per_err_total = err_times;
	txm_thres.tx_contd_fail_total = tx_contd_fail_cnt * err_times;
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_NOTICE,
			"set STA power off detect with per_err_total = %d, tx_contd_fail_total = %ld\n",
			txm_thres.per_err_total, txm_thres.tx_contd_fail_total);
	...
	IN RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "IF(ra%d) (MaxStaNum=%d)\n",
...
INT	Set_PowerSaveLifeTime_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Set new life time = %d\n", pAd->MacTab->MsduLifeTime);
	return TRUE;
}
#endif /* CONFIG_AP_SUPPORT */
...
INT	Show_MbssInfo_Display_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	/* dump mbss info*/
	MTWF_PRINT("\n\tBssidNum=%d\n",	pAd->ApCfg.BssidNum);
	MTWF_PRINT("\n\tBSS Idx\t\tPhy Mode\tIF_addr\t\t\tgrp [max:%d]\t\tMulticast Count\n", pAd->max_bssgroup_num);
	for (IdBss = 0; IdBss < pAd->ApCfg.BssidNum; IdBss++) {
		...
		if (mbss->mbss_11v.mbss_11v_enable)
			continue;
#endif /* DOT11V_MBSSID_SUPPORT */
		mod_str = wmode_2_str(wdev->PhyMode);
		MTWF_PRINT("\t%d\t%16s\t%02x:%02x:%02x:%02x:%02x:%02x\t%d\t(%s)\t%s\t\t%-12lld\n",
				IdBss, mod_str, PRINT_MAC(wdev->if_addr),
				mbss->mbss_idx,
				RTMP_OS_NETDEV_GET_DEVNAME(wdev->if_dev), type, wdev->multicast_cnt);
...
#ifdef DOT11V_MBSSID_SUPPORT
	mbss_11v_group_information(pAd, dump_lvl);
#endif /* DOT11V_MBSSID_SUPPORT */
	...
	IN      RTMP_STRING     *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "%-10lu\t%-10lu\n",
	...
	for (apidx = 0; apidx < pAd->ApCfg.BssidNum; apidx++) {
		...
		for (i = 0; i < MAX_TIME_RECORD; i++)
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Idx[%d]:\t%-10lu\t%-10lu\t%-10lu\t%-10lu\n", i,
	...
	IN  RTMP_STRING *arg)
{
	...
	if (!IS_HIF_TYPE(pAd, HIF_MT)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "chipcap is not HIF_MT\n");
		return FALSE;
	}

	if ((bcn_state < BCN_TX_IDLE) || (bcn_state > BCN_TX_DMA_DONE)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "bcn_state is incorrect!!\n");
		return FALSE;
	}
	...
	if (pMbss == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "pMbss == NULL!!\n");
		return FALSE;
	}
	...
	IN  RTMP_STRING *arg)
{
	...
	if (!IS_HIF_TYPE(pAd, HIF_MT)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "chip_cap is not HIF_MT\n");
		return FALSE;
	}

	if ((enable < 0) || (enable > 2)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "enable is incorrect!!\n");
		return FALSE;
	}
	...
	IN	ULONG					Data)
{
	...
	case CMD_RTPRIV_IOCTL_AP_SIOCGIWESSID: {
		...
		{
			ifIndex = pSSID->apidx;
			if (ifIndex < 0 || ifIndex >= MAX_MBSSID_NUM(pAd)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
					"error AP index %d\n", ifIndex);
				Status = NDIS_STATUS_FAILURE;
				goto end;
	...
	case CMD_RTPRIV_IOCTL_AP_SIOCGIWAP: {
		...
		if (Data == INT_APCLI) {
			...
			if (pAd->StaCfg[ifIndex].ApcliInfStat.Valid == TRUE)
				pBssidStr = (PCHAR)APCLI_ROOT_BSSID_GET(
					pAd, pAd->StaCfg[ifIndex].MacTabWCID);
			else
				pBssidStr = NULL;
		} else
#endif /* APCLI_SUPPORT */
	...
	IN UINT32 ANQPRspLen)
{
	...
	OS_SEM_LOCK(&pGASCtrl->GASPeerListLock);
	...
	OS_SEM_UNLOCK(&pGASCtrl->GASPeerListLock);
	os_alloc_mem(NULL, (UCHAR **)&Buf, sizeof(*Event) + ANQPRspLen);

	if (!Buf) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Not available memory\n");
		goto error0;
	}
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO,
		"ANQPRspLen %d pGASCtrl->MMPDUSize %d\n", ANQPRspLen, pGASCtrl->MMPDUSize);
	...
	if ((ANQPRspLen > pGASCtrl->MMPDUSize) || (pGASCtrl->cb_delay != 0)) {
		...
		if (!IsFound) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
				"Can not find peer address in GASPeerList\n");
			goto error1;
		}
		...
		DlListForEach(GASPeerEntry, &pGASCtrl->GASPeerList, GAS_PEER_ENTRY, List)
		{
			if (MAC_ADDR_EQUAL(GASPeerEntry->PeerMACAddr, PeerMACAddr)) {
				IsFound = TRUE;
				MTWF_PRINT("GAS RSP DialogToken = %x\n", GASPeerEntry->DialogToken);
				...
				RTMP_IOCTL_INPUT_STRUCT *wrq)
{
	...
	struct dpp_frame_list *dpp_frame = NULL;

	if (DlListEmpty(&wdev->dpp_frame_event_list)) {
		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_ERROR,
	...
	DlListForEach(dpp_frame, &wdev->dpp_frame_event_list,  struct dpp_frame_list, List) {
		if (dpp_frame->dpp_frame_event->data.frame.wapp_dpp_frame_id_no == frm_id) {
			MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_INFO,
	...
	if (req_data->frm_len == 0) {
		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_ERROR,
						"frame length is invalid\n");
		goto error;
	}
	wrq->u.data.length = sizeof(*req_data) + req_data->frm_len;
	if (copy_to_user(wrq->u.data.pointer, req_data, wrq->u.data.length)) {
		MTWF_DBG(NULL, DBG_CAT_PROTO, CATPROTO_DPP, DBG_LVL_ERROR,
						"copy to user failed\n");
		goto error;
	}
...
INT mtk_cancel_roc(PRTMP_ADAPTER pAd, struct wifi_dev *wdev)
{
	...
	ch_sw_info = &pAd->ch_sw_cfg;

	if (pAd == NULL)
		return -EFAULT;

	if (ch_sw_info == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "ch info not found\n");
		return -EFAULT;
	}
	...
	if (ch_sw_info->ch_sw_on_going == TRUE || ch_sw_info->ch_switch_sm.CurrState == CH_SWITCH_STATE_RUNNING) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "canceling ROC\n");
...
INT mtk_switch_chan(PRTMP_ADAPTER pAd, struct wifi_dev *wdev, UCHAR channel, UINT duration)
{
	...
	if (ret != NDIS_STATUS_SUCCESS) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "alloc mem fail!\n");
		return FALSE;
	}
	...
	if (ret != NDIS_STATUS_SUCCESS) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"set_ch_switch_monitor_cfg failed!\n");
		os_free_mem(ch_sw_cfg);
		return FALSE;
	}
...
INT mtk_start_roc(PRTMP_ADAPTER pAd, struct wifi_dev *wdev, struct roc_req *roc)
{
	...
	if (wdev_channel == roc->chan) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO,
			"wdev is in same channel as roc request\n");
		return 0;
	}
	...
	IN UINT32 BTMReqLen)
{
	...
	if (IsFound) {
		MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_BTM, DBG_LVL_NOTICE,
			"Already receive BTM Query Before!\n");
	...
	if (!IsFound) {
		...
		if (!BTMPeerEntry) {
			MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_BTM, DBG_LVL_ERROR,
	...
	if (!Buf) {
		MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_BTM, DBG_LVL_ERROR, "Not available memory\n");
		goto error1;
	}
	...
	if (FALSE == ret)
		MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_BTM, DBG_LVL_ERROR, "enqueue MLME failed!\n");
	...
	IN UINT8	Apidx)
{
	...
	if (QosMapLen > ARRAY_SIZE(pQOSMap->DSCP_Field))
		QosMapLen = ARRAY_SIZE(pQOSMap->DSCP_Field);
	...
	(struct _RTMP_ADAPTER *pAd, UINT16 wcid)
{
	...
	MTWF_DBG(pAd, DBG_CAT_TX, CATTX_DABS_QOS, DBG_LVL_INFO, "Send_DABS_Announce:wcid=%d\n", wcid);
	...
	pEntry = entry_get(pAd, wcid);
	if (!pEntry) {
		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_DABS_QOS, DBG_LVL_ERROR, "entry not found\n");
		MlmeFreeMemory(pOutBuffer);
		return;
	}
	wdev = pEntry->wdev;
	if (!wdev) {
		MTWF_DBG(pAd, DBG_CAT_TX, CATTX_DABS_QOS, DBG_LVL_ERROR, "wdev not found\n");
		MlmeFreeMemory(pOutBuffer);
		return;
	}
	...
	(struct _RTMP_ADAPTER *pAd, UINT16 wcid, UCHAR status, UINT32 *keybitmap)
{
	...
	MTWF_DBG(pAd, DBG_CAT_TX, CATTX_DABS_QOS, DBG_LVL_INFO, "dabs rsp(status=%d)\n", status);
	...
	IN	RTMP_STRING *arg)
{
	...
	if (arg) {
		...
		if (i4Recv != 3) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Format Error!\n");
			return FALSE;
		}
	...
	IN	RTMP_STRING *arg)
{
	...
	if (token1 == NULL) {
		MTWF_DBG(pAd, DBG_CAT_PROTO, CATPROTO_QOS_MAP, DBG_LVL_ERROR, "token1 is NULL!\n");
		return TRUE;
	}
	...
	for (i = 0, value = rstrtok(token1, ":"); (value != NULL) && (i < ARRAY_SIZE(peer_mac_addr)); value = rstrtok(NULL, ":")) {
	...
	if (pEntry != NULL) {
		...
		if (type == 0) {
			...
			while (value != NULL) {
				value2 = rstrtok(NULL, ":");
				if ((value2 != NULL) && (tmp < ARRAY_SIZE(pEntry->DscpException)) && (qos_map_buf_len < ARRAY_SIZE(qos_map_buf))) {
	...
	IN	RTMP_STRING * arg)
{
	...
	if (kstrtol(arg, 10, &Enable)) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"Invalid ProxyArp Setting %ld\n", Enable);
		return FALSE;
	}
	pWNMCtrl->ProxyARPEnable = (BOOLEAN)Enable;
	...
	IN	RTMP_STRING *arg)
{
	...
	if (arg) {
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Type %d,BW %d,Band %d\n",
				 Type, BW, Band);
	...
	char *arg)
{
	...
	if (arg) {
		do {
			i4Recv = sscanf(arg, "%u-%u", &(sw_hash_en), &(per_round));
			MTWF_PRINT("%s():sw_hash_en = %d, per_round = %d\n",
					 __func__, sw_hash_en, per_round);
		} while (0);
	...
	pAd->rps_special_hash_en = sw_hash_en;
	pAd->rps_per_round = per_round;
	...
	IN	RTMP_STRING *arg)
{
	...
	if (pWcidDest == NULL || arg == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Invalid parameters\n");
		return FALSE;
	}
	...
	IN	RTMP_STRING *arg)
{
	...
	STA_ADMIN_CONFIG *pApCli = &pAd->StaCfg[apidx];
		...
		if ((pApCli->MacTabWCID) && (pApCli->MacTabWCID < WTBL_MAX_NUM(pAd))) {
			pEntry = entry_get(pAd, pApCli->MacTabWCID);

			/*Enable 4 address mode for the entry */
			if (pEntry->bEnable4Addr) {
#ifdef WIFI_UNIFIED_COMMAND
				if (wifi_sys_header_trans_update(pAd, pEntry) != NDIS_STATUS_SUCCESS)
					MTWF_PRINT("WDS STA 4 Address Mode failed to set to  %d for wcid %d\n", wds_enable, pApCli->MacTabWCID);
#else
...
#ifdef WIFI_UNIFIED_COMMAND
					if (wifi_sys_header_trans_update(pAd, pEntry) != NDIS_STATUS_SUCCESS)
						MTWF_PRINT("WDS AP Address Mode failed to set to  %d for wcid %d\n", wds_enable, pEntry->wcid);
#else
					HW_SET_ASIC_WCID_4ADDR_HDR_TRANS(pAd, pEntry->wcid, wds_enable);
#endif
				}
	...
	IN	RTMP_STRING *arg)
{
	...
	for (i = 0, value = rstrtok(arg, ":"); value && (i < ARRAY_SIZE(Addr)); value = rstrtok(NULL, ":")) {
		if ((strlen(value) != 2) || (!isxdigit(*value)) || (!isxdigit(*(value+1))))
			return FALSE;  /*Invalid */
	...
	IN	RTMP_STRING *arg)
{
	...
	*/
	...
	if (pObj->ioctl_if_type == INT_APCLI) {
#ifdef MAP_R5
		pAd->StaCfg[inf_idx].dscp_pri_map[dscpValue] = pri;
		enable = pAd->StaCfg[inf_idx].dscp_pri_map_enable;
#endif
	} else {
		pAd->ApCfg.MBSSID[inf_idx].dscp_pri_map[dscpValue] = pri;
		enable = pAd->ApCfg.MBSSID[inf_idx].dscp_pri_map_enable;
	}
	...
	if (pAd->ApCfg.MBSSID[inf_idx].dscp_pri_map_enable)
		MtCmdSetDscpPri(pAd, inf_idx, pObj->ioctl_if_type);
	...
	IN	RTMP_STRING *arg)
{
...
#ifdef MAP_R5
		if (enable)
			pAd->StaCfg[inf_idx].dscp_pri_map_enable = TRUE;
		else
			pAd->StaCfg[inf_idx].dscp_pri_map_enable = FALSE;
#endif
	} else {
		if (enable)
	...
	MTWF_PRINT("%s, type:%s, inf_idx: %d, dscp_Pri_map_enable=%d\n",
		__func__, (pObj->ioctl_if_type == INT_APCLI) ? "APCLI" : "AP", inf_idx, enable);
	...
	IN	RTMP_STRING *arg)
{
	...
	if_idx = pObj->ioctl_if;
	if (pObj->ioctl_if_type == INT_APCLI) {
#ifdef MAP_R5
		if ((if_idx >= MAX_MULTI_STA) || (if_idx < 0)) {
			MTWF_PRINT("[%s] if_idx %d error!\n", __func__, if_idx);
			return FALSE;
		}
		MTWF_PRINT("[%s] DSCP priority setting for apcli Idx %d: DscpPriEnable:%d\n",
					__func__, if_idx, pAd->StaCfg[if_idx].dscp_pri_map_enable);
		MTWF_PRINT("DSCP  PRI  DSCP  PRI  DSCP  PRI  DSCP  PRI  ");
		MTWF_PRINT("DSCP  PRI  DSCP  PRI  DSCP  PRI  DSCP  PRI\n");
		for (idx = 0; idx < 64; idx++) {
			if (idx%8 == 0)
				MTWF_PRINT("\n");
			MTWF_PRINT("%4d  %3d", idx, pAd->StaCfg[if_idx].dscp_pri_map[idx]);
		}
#endif
		MTWF_PRINT("\n");
	} else {
		...
		if ((if_idx >= MAX_BEACON_NUM) || (if_idx < 0)) {
			MTWF_PRINT("[%s] if_idx %d error!\n", __func__, if_idx);
			return FALSE;
		}
		mbss = &pAd->ApCfg.MBSSID[if_idx];
		MTWF_PRINT("[%s] DSCP priority setting for Bss Idx %d: DscpPriEnable:%d\n",
					__func__, if_idx, mbss->dscp_pri_map_enable);
		MTWF_PRINT("DSCP  PRI  DSCP  PRI  DSCP	PRI  DSCP  PRI	");
		MTWF_PRINT("DSCP  PRI  DSCP  PRI  DSCP	PRI  DSCP  PRI\n");
		for (idx = 0; idx < 64; idx++) {
			if (idx%8 == 0)
	...
	IN RTMP_STRING	*arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_NOTICE, "-->\n");
	if (!wdev) {
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_WARN, "wdev is NULL\n");
			return FALSE;
	}
	mnt_enable = (UCHAR)simple_strtol(arg, 0, 10);
	band_idx = HcGetBandByWdev(wdev);
	pAd->MntEnable = mnt_enable;
	pAd->MntMaxPktCnt = 0;

	ret = asic_set_air_mon_enable(pAd, mnt_enable, band_idx);

	MTWF_PRINT("<--[Band%d]MntEnable=0x%x\n", band_idx, pAd->MntEnable);
	return TRUE;
}

#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_enable(IN RTMP_ADAPTER * pAd, IN UCHAR monitor_enable)
{
	UCHAR band_idx;
	INT ret;

	pAd->MntEnable = monitor_enable;
	band_idx = hc_get_hw_band_idx(pAd);
	ret = asic_set_air_mon_enable(pAd, monitor_enable, band_idx);
	if (ret != TRUE)
		return -EFAULT;

	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_NOTICE,
		"[Band%d]MntEnable=0x%0x\n", band_idx, monitor_enable);
	return 0;
}
#endif
	...
	IN RTMP_STRING	* arg)
{
	POS_COOKIE pObj = (POS_COOKIE)pAd->OS_Cookie;
	struct wifi_dev *wdev = get_wdev_by_ioctl_idx_and_iftype(pAd, pObj->ioctl_if, pObj->ioctl_if_type);
	long max_cnt = 0, band_idx = hc_get_hw_band_idx(pAd);
	...
	if (kstrtol(arg, 10, &max_cnt)) {
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
			"<--[Band%ld]max cnt(=%ld) is not received\n", band_idx, max_cnt);
		return FALSE;
	}

	pAd->MntMaxPktCnt = max_cnt;

	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_INFO,
		"<--[Band%ld]MntEnable=%d\n", band_idx, pAd->MntMaxPktCnt);
	return TRUE;
}
	...
	IN RTMP_STRING	*arg)
{
	...
	INT idx = 0;
	UCHAR rx_rule[3], band_idx = hc_get_hw_band_idx(pAd);

	MTWF_PRINT("--> %s()\n", __func__);

	while ((this_char = strsep((char **)&arg, ";")) != NULL) {
		if (*this_char == '\0') {
			MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_WARN,
				"An unnecessary delimiter entered!\n");
			continue;
		}
		...
		for (idx = 0, value = rstrtok(this_char, ":"); value; value = rstrtok(NULL, ":")) {
			...
			if (idx < 0 || idx >= ARRAY_SIZE(rx_rule)) {
				MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
						"illegal index: %d!\n", idx);
				break;
			}
...
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_rule(IN RTMP_ADAPTER * pAd, IN UCHAR *rx_rule)
{
	UCHAR band_idx;
	INT ret;
	...
	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_NOTICE,
		"[Band%d]MntRule=%d:%d:%d\n", band_idx, rx_rule[0], rx_rule[1], rx_rule[2]);
	return 0;
}
#endif
	...
	IN RTMP_STRING	*arg)
{
	...
	while ((this_char = strsep((char **)&arg, ";")) != NULL) {
		...
		for (idx = 0, value = rstrtok(this_char, ":"); value && (idx < ARRAY_SIZE(pAd->curMntAddr)); value = rstrtok(NULL, ":")) {
			if ((strlen(value) != 2) || (!isxdigit(*value)) || (!isxdigit(*(value + 1)))) {
				MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_WARN,
					"illegal MAC address format or octet!\n");
				break;
...
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_target(IN RTMP_ADAPTER * pAd, IN UCHAR *mac_addr)
{
	NdisCopyMemory(pAd->curMntAddr, mac_addr, MAC_ADDR_LEN);
	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_NOTICE,
		"MntTarget=%02x:%02x:%02x:%02x:%02x:%02x\n", PRINT_MAC(MAC2STR(pAd->curMntAddr)));
	return 0;
}
#endif
...
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_index(IN RTMP_ADAPTER * pAd, IN UCHAR mnt_idx)
{
	POS_COOKIE pObj = (POS_COOKIE) pAd->OS_Cookie;
	UCHAR band_idx;
	INT ret;
...
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_clear(IN RTMP_ADAPTER * pAd)
{
	UCHAR i;
	MNT_STA_ENTRY *pEntry = NULL;
	...
	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
		"Clear all Monitor STA Entry\n");
	return 0;
}
#endif

#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_monitor_sta_index(IN RTMP_ADAPTER * pAd,
	IN struct mnt_sta *req_sta)
{
	UCHAR sta_mac[MAC_ADDR_LEN] = {0};
	UCHAR sta_idx = 0;
	INT ret = FALSE;

	NdisCopyMemory(sta_mac, req_sta->sta_mac, MAC_ADDR_LEN);
	sta_idx = req_sta->sta_id;

	mtk_cfg80211_set_monitor_target(pAd, sta_mac);
	if (sta_idx < MAX_NUM_OF_MONITOR_STA) {
		ret = mtk_cfg80211_set_monitor_index(pAd, sta_idx);
		if (!ret)
			return ret;
	} else {
		MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
		...
		IN int cmd_len)
{
	...
	for (i = 0; i < MAX_NUM_OF_MONITOR_STA; i++) {
		...
		if (pTmpEntry->Count != 0 && pTmpEntry->Count < pAd->MntMaxPktCnt) {
			...
			mnt_info[pEntryLen].rssi = (char)(pTmpEntry->RssiTotal/(LONG)pTmpEntry->Count);
			MTWF_DBG(pAd, DBG_CAT_AP, CATAP_MNT, DBG_LVL_ERROR,
				"STA ["MACSTR"] packet received %ld total rssi %ld avg rssi %d\n",
				MAC2STR(pTmpEntry->addr), pTmpEntry->Count, pTmpEntry->RssiTotal, mnt_info[pEntryLen].rssi);
			pEntryLen += 1;
		}
	}

	air_mnt_len = (unsigned int) (MAX_NUM_OF_MONITOR_STA * sizeof(wapp_mnt_info));
	...
	IN struct _RX_BLK	*pRxBlk)
{
	UCHAR FrameBuf[512];
	AIR_RAW AirRaw;
	union _HTTRANSMIT_SETTING HTSetting;
	...
	RxPath = min(RxPath, (USHORT)(sizeof(pMntEntry->RssiSample.AvgRssi) / sizeof(CHAR)));
	for (i = 0; i < RxPath; i++) {
	...
	IN RTMP_STRING * arg)
{
	...
	if (arg) {
		do {
			i4Recv = sscanf(arg, "%d-%d", &(band_idx), &(pp_enable));
			if (i4Recv != 2) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PP, DBG_LVL_ERROR,
					"Wrong parameters!(format should be like: 0-1 or 0-0)\n");
				status = NDIS_STATUS_FAILURE;
				goto error;
			} else {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PP, DBG_LVL_WARN,
					"band_idx(%d), pp_enable(%d)\n", band_idx, pp_enable);
			}
		} while (0);

		if (band_idx >= PP_BL_BAND_MAX_NUM) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PP, DBG_LVL_ERROR,
				"Error!band_idx(%d) is out of range!\n", band_idx);
			status = NDIS_STATUS_FAILURE;
		} else {
			if (pp_enable == 1)
				status = set_pp_on_off_ctrl(pAd, band_idx, PP_ENABLE);
			else if (pp_enable == 2)
				status = set_pp_on_off_ctrl(pAd, band_idx, PP_ENABLE_FBW);
			else
				status = set_pp_on_off_ctrl(pAd, band_idx, PP_DISABLE);

			if (status == NDIS_STATUS_SUCCESS) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PP, DBG_LVL_WARN,
					"set pp_enable(%d) to band(%d) success!\n", pp_enable, band_idx);
			} else {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_PP, DBG_LVL_WARN,
					"set pp_enable(%d) to band(%d) failed!\n", pp_enable, band_idx);
			}
			return status;
		}
	}
...
#ifdef RT_CFG80211_SUPPORT
INT mtk_cfg80211_set_pp_bitmap(RTMP_ADAPTER *pAd, USHORT punctured_bitmap)
{
	...
	if (punctured_bitmap) {
		...
		ret = snprintf(buf, sizeof(buf), "%d-0-0-0-1-0", band_idx);
		if (os_snprintf_error(sizeof(buf), ret)) {
			MTWF_PRINT("%s: snprintf error\n", __func__);
			return -EINVAL;
		}
	...
	status = set_pp_cap_ctrl(pAd, buf);
	if (status == TRUE) {
		pAd->CommonCfg.punctured_bitmap = punctured_bitmap;
	} else {
	...
	IN	RTMP_STRING *arg)
{
	...
	MTWF_PRINT("wcid 1 configured for vlan id %d\n", vlan_id);
	return TRUE;
}
#endif
...
INT Set_Ft_Param(RTMP_ADAPTER *pAd, RT_CMD_AP_11R_PARAM *ap_11r_param)
{
	...
	if (pFtCfg->FtCapFlag.Dot11rFtEnable) {
		...
		if (ap_11r_param->nas_id_len > ARRAY_SIZE(pFtCfg->FtR0khId))
			ap_11r_param->nas_id_len = ARRAY_SIZE(pFtCfg->FtR0khId);
	...
	char *arg)
{
	...
	if (pAd->MAPMode && pAd->bMapR3Enable == enable) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO, "Disable SCS\n");

		UNI_Set_SCSEnable_Proc(pAd, "0");
		...
		if (pAd->CommonCfg.SRMode == 1) {
			...
			if (IS_MAP_TURNKEY_ENABLE(pAd)) {
				MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_INFO,
					"Set SRMeshUlMode[%u]:%u\n", BandIdx, pAd->CommonCfg.SRMeshUlMode);
	...
	char *arg)
{
	...
	struct wifi_dev *wdev = NULL;
	int i = 0;
	int max_sta_num = (MAX_APCLI_NUM <= MAX_MULTI_STA)?MAX_APCLI_NUM:MAX_MULTI_STA;

	for (i = BSS0; (i < pAd->ApCfg.BssidNum) && VALID_MBSS(pAd, i); i++) {
		wdev = &pAd->ApCfg.MBSSID[i].wdev;
		if(wdev != NULL)
			NdisZeroMemory(&(wdev->MAPCfg.scan_bh_ssids), sizeof(struct scan_BH_ssids));
	}

	for (i = BSS0; (i < max_sta_num); i++) {
	...
	* since upper layer should configure interface roles */
	...
	if (!IS_MAP_ENABLE(pAd)) {
		...
		for (ifIndex = 0; (ifIndex < MAX_MBSSID_NUM(pAd)) && (ifIndex < MAX_BEACON_NUM); ifIndex++) {
		...
		for (ifIndex = 0; ifIndex < MAX_MULTI_STA; ifIndex++) {
			pApCliEntry = &pAd->StaCfg[ifIndex];
	...
	char *arg)
{
	...
	while ((this_char = strsep((char **)&arg, ";")) != NULL) {
		...
		for (idx = 0, value = rstrtok(this_char, ":"); value && (idx < ARRAY_SIZE(sta_mac)); value = rstrtok(NULL, ":")) {
			if ((strlen(value) != 2) || (!isxdigit(*value)) || (!isxdigit(*(value + 1)))) {
				MTWF_DBG(pAd, DBG_CAT_AP, CATAP_ACL, DBG_LVL_ERROR,
					"illegal MAC address format or octet!\n");
				break;
	...
	MTWF_DBG(pAd, DBG_CAT_AP, CATAP_ACL, DBG_LVL_INFO, "sta mac:"MACSTR"\n", MAC2STR(sta_mac));
...
VOID ch_switch_monitor_cfg_reset(IN PRTMP_ADAPTER pAd, struct ch_switch_cfg *cfg)
{
	...
	if (!cfg) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "error! cfg is null!\n");
		return;
	}
	cfg->channel = 0;
	cfg->duration = 0;
...
INT ch_switch_monitor_cancel(IN PRTMP_ADAPTER pAd, struct wifi_dev *pwdev)
{
	...
	if ((!pAd) || (!pwdev)) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
			"error! pAd or pwdev is null!\n");
		return -EFAULT;
	}
	RTMPCancelTimer(&pAd->ch_sw_cfg.ch_sw_timer, &cancelled);
#ifdef MAP_R3
	if (IS_MAP_ENABLE(pAd) && IS_MAP_R3_ENABLE(pAd))
		RTMP_OS_INIT_COMPLETION(&pAd->ch_sw_cfg.chan_switch_done_2);
#endif /* MAP_R3 */
	ret = MlmeEnqueueWithWdev(pAd, CH_SWITCH_MONITOR_STATE_MACHINE,
		CH_SWITCH_MSG_CANCLE, 0, NULL, 0, pwdev, FALSE, NULL);
	if (ret)
		RTMP_MLME_HANDLER(pAd);
	else
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "enqueue MLME failed!\n");

#ifdef MAP_R3
	if (IS_MAP_ENABLE(pAd) && IS_MAP_R3_ENABLE(pAd)) {
		pAd->ch_sw_cfg.wait_chan_switch_done_2 = 1;
		ret_timeout = RTMP_OS_WAIT_FOR_COMPLETION_TIMEOUT(&pAd->ch_sw_cfg.chan_switch_done_2,
	...
	IN PVOID system_specific3)
{
	...
	ret = MlmeEnqueueWithWdev(pAd, CH_SWITCH_MONITOR_STATE_MACHINE,
		CH_SWITCH_MSG_TIMEOUT, 0, NULL, 0, wdev, FALSE, NULL);
	if (ret)
		RTMP_MLME_HANDLER(pAd);
	else
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "enqueue MLME failed!\n");
...
static VOID ch_switch_monitor_listen_exit(RTMP_ADAPTER *pAd, struct wifi_dev *wdev)
{
	...
	if (IS_MAP_ENABLE(pAd) && IS_MAP_R3_ENABLE(pAd)) {
		if (ch_sw_info->wait_chan_switch_done) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "from normal\n");
			RTMP_OS_COMPLETE(&ch_sw_info->chan_switch_done);
			ch_sw_info->wait_chan_switch_done = 0;
		}
		if (ch_sw_info->wait_chan_switch_done_2) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "from cancel timer\n");
...
static VOID ch_switch_monitor_enter_listen(RTMP_ADAPTER *pAd, MLME_QUEUE_ELEM *pElem)
{
	...
	if (ret != 0) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR, "fail by switch channel\n");
#ifdef MAP_R3
		if (IS_MAP_ENABLE(pAd) && IS_MAP_R3_ENABLE(pAd)) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_INFO, "from ch change\n");
			RTMP_OS_COMPLETE(&ch_sw_info->chan_switch_done);
			ch_sw_info->wait_chan_switch_done = 0;
		}
#endif /* MAP_R3 */
...
#endif /* MAP_R3 */
	ret = MlmeEnqueueWithWdev(pAd, CH_SWITCH_MONITOR_STATE_MACHINE,
		CH_SWITCH_MSG_LISTEN, 0, NULL, wdev->func_idx, wdev, FALSE, NULL);
	if (ret)
		RTMP_MLME_HANDLER(pAd);
	else {
...
VOID ch_switch_monitor_state_machine_init(struct _RTMP_ADAPTER *pAd)
{
	...
	ch_sw_cfg->ch_sw_timer_func_contex.BandIdx = hc_get_hw_band_idx(pAd);
	...
	RTMP_STRING *arg)
{
	...
	if (arg) {
		...
		if ((i4Recv != 2) || (target_ch == 0) || (time == 0)) {
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
				"Wrong parameters!\n");
			return -1;
		} else
	...
	ret = os_alloc_mem(pAd, (UCHAR **)&ch_sw_cfg, sizeof(struct ch_switch_cfg));
	if (ret != NDIS_STATUS_SUCCESS) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR, "alloc mem fail!\n");
		return FALSE;
	}
...
#endif
#ifdef CFG_SUPPORT_CSI
/*show csi info by this function*/
static INT show_csi_info(RTMP_ADAPTER *pAd, struct CSI_INFO_T *prCSIInfo, UCHAR band_idx)
{
	UCHAR csi_mode;
	struct wifi_dev *pwdev;
	...
	MTWF_PRINT("csi_band%d_status: %s\n", band_idx, (pwdev)?"ON" : "OFF");
	...
	if (csi_mode)
		MTWF_PRINT("csi_report: %s\n", (csi_mode == CSI_PROC)?"PROC" : "NETLINK");
	else
		MTWF_PRINT("csi_report: %s\n", "DISABLE");

	MTWF_PRINT("csi_fw_version: %03d\n", prCSIInfo->FWVer);

	if (prCSIInfo->ucValue2[CSI_CONFIG_FRAME_TYPE])
		MTWF_PRINT("csi_frame_type(Subtype+Type): %d\n", prCSIInfo->ucValue2[CSI_CONFIG_FRAME_TYPE]);

	if (prCSIInfo->ucValue1[CSI_CONFIG_OUTPUT_FORMAT])
		MTWF_PRINT("csi_tone_process: %s\n",
		(prCSIInfo->ucValue1[CSI_CONFIG_OUTPUT_FORMAT] == CSI_OUTPUT_TONE_MASKED)?"tone_mask" : "tone_mask_reorder");
	else
		MTWF_PRINT("csi_tone_process: %s\n", "raw_tone");

	MTWF_PRINT("csi_chain_fix: %d-%d\n", prCSIInfo->ucValue1[CSI_CONFIG_CHAIN_NUMBER],
	prCSIInfo->ucValue2[CSI_CONFIG_CHAIN_NUMBER]);

	MTWF_PRINT("csi_band%d_protocol: %03d\n", band_idx, prCSIInfo->protocol_filter);

	MTWF_PRINT("csi_buffer_cnt: used(%d)-total(%d)\n", prCSIInfo->u4CSIBufferUsed, CSI_RING_SIZE);

	return TRUE;
}

static int csi_prepare_config_para(RTMP_ADAPTER *pAd, RTMP_STRING *arg,
	struct wifi_dev *pwdev, struct CMD_CSI_CONTROL_T *prCSICtrl)
{
	UINT_8 ArgNum = 0;
	INT_32 ret = 0;
	CHAR *par_value = NULL;
	...
	prCSICtrl->BandIdx = HcGetBandByWdev(pwdev);
	...
	for (ArgNum = 0, par_value = rstrtok(arg, "-"); par_value;
		...
		case 4:
			...
			/*macstr to hex*/
			for (idx = 0, tmp = rstrtok(mac_str, ":"); tmp && (idx < ARRAY_SIZE(prCSICtrl->mac_addr)); tmp = rstrtok(NULL, ":")) {
...
INT Set_CSI_Ctrl_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_DEBUG, "Command\n");
	...
	if (!arg || !strlen(arg)) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR, "arg string error!\n");
		ret = -1;
		goto out;
	}

	if (csi_prepare_config_para(pAd, arg, pwdev, prCSICtrl) < 0) {
		ret = -1;
		goto out;
	}
	...
	if (prCSICtrl->ucMode == CSI_CONTROL_MODE_STOP ||
		...
		if (prCSICtrl->ucMode == CSI_CONTROL_MODE_STOP) {
			/*reset csi wdev*/
			prCSIInfo->csi_wdev = NULL;
			/*reset report mode*/
			prCSIInfo->CSI_report_mode = CSI_IDLE;
			/*clear the list*/
		...
		if (prCSICtrl->ucMode == CSI_CONTROL_MODE_START) {
			...
			if (prCSICtrl->ucCfgItem == CSI_NETLINK) {
				...
				MTWF_PRINT("%s: CSI start with proc mode!\n", __func__);
			} else {
				prCSIInfo->CSI_report_mode = CSI_PROC;
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_WARN,
					"no CSI report mode input, use default(proc)!\n");
			}

			prCSIInfo->csi_wdev = pwdev;
	...
	/*show csi current status*/
	if (prCSICtrl->ucCfgItem == CSI_CONFIG_INFO) {
		show_csi_info(pAd, prCSIInfo, prCSICtrl->BandIdx);
		ret = 0;
		goto out;
	}
	...
	if ((prCSICtrl->ucCfgItem == CSI_CONFIG_FILTER_MODE) &&
		...
		if (prCSICtrl->ucValue2 == CSI_STA_MAC_ADD) {
			if (MAC_ADDR_EQUAL(prCSICtrl->mac_addr, ZERO_MAC_ADDR)) {
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
			...
			pCSISta->band_idx = prCSICtrl->BandIdx;
			NdisAcquireSpinLock(&prCSIInfo->CSIStaListLock);
			...
			NdisReleaseSpinLock(&prCSIInfo->CSIStaListLock);
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
				"Not find in CSI list.\n");
			ret = -1;
			goto out;
		} else if (prCSICtrl->ucValue2 == CSI_STA_MAC_SHOW) {
			/*search sta list*/
			NdisAcquireSpinLock(&prCSIInfo->CSIStaListLock);
			MTWF_PRINT("=>Show csi sta mac:\n");
			DlListForEach(pCSISta, &prCSIInfo->CSIStaList, CSI_STA, List) {
				MTWF_PRINT("band%d-%02x:%02x:%02x:%02x:%02x:%02x\n",
					pCSISta->band_idx, PRINT_MAC(pCSISta->Addr));
			}
			NdisReleaseSpinLock(&prCSIInfo->CSIStaListLock);
			goto out;
		}
	...
	if ((prCSICtrl->ucCfgItem == CSI_CONFIG_FILTER_MODE) &&
		...
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR, "invalid pkt length!\n");
		goto out;
	}
	...
	if ((prCSICtrl->ucCfgItem == CSI_CONFIG_FILTER_MODE) &&
		(prCSICtrl->ucValue1 == CSI_PROTOCOL_FILTER)) {
		MTWF_PRINT("%s:set protocal filter (%u)!\n", __func__, prCSICtrl->ucValue2);
		if (prCSICtrl->ucValue2 >= 0xf) /*bit0 ~ bit3: legacy-11n-11ac-11ax*/
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
			"protocal filter para error (at most 0xf)!\n");
		else
			prCSIInfo->protocol_filter = prCSICtrl->ucValue2;
		goto out;
	}

	if (prCSICtrl->ucCfgItem == CSI_CONFIG_ACTIVE_MODE) {
		if (!MAC_ADDR_EQUAL(prCSICtrl->mac_addr, ZERO_MAC_ADDR)) {
			MAC_TABLE_ENTRY  *pEntry;

			pEntry = MacTableLookup(pAd, prCSICtrl->mac_addr);

			if (!pEntry) {
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
				"csi active mode not supprot the dis-assoc sta(%pM)!\n", prCSICtrl->mac_addr);
				goto out;
			}

			if (pEntry->wcid > MAX_CSI_ACTIVE_STA_NUM) {
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
				"csi active mode: invalid wcid(%d)!\n", pEntry->wcid);
				goto out;
			}

			if (prCSICtrl->ucValue2 == CSI_ACTIVE_MODE_ADD) {
				prCSIInfo->wcid_bitmap |= BIT(pEntry->wcid);
				MTWF_PRINT("%s:csi active mode: put in (%pM)!\n", __func__, prCSICtrl->mac_addr);
			} else if (prCSICtrl->ucValue2 == CSI_ACTIVE_MODE_REMOVE) {
				prCSIInfo->wcid_bitmap &= ~(BIT(pEntry->wcid));
				MTWF_PRINT("%s:csi active mode: put out (%pM)!\n", __func__, prCSICtrl->mac_addr);
			} else
				MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR,
				"csi active mode: invalid input parameter!\n");

			goto out;
		} else {
			prCSICtrl->wcid_bitmap = prCSIInfo->wcid_bitmap;
			prCSIInfo->active_interval = prCSICtrl->ucValue2;
			HW_CSI_CTRL(pAd, (void *)prCSICtrl);	/*send fw cmd*/
		}
		goto out;
	}

	/*prCSICtrl => prCSIInfo for show usr config*/
	prCSIInfo->ucValue1[prCSICtrl->ucCfgItem] = prCSICtrl->ucValue1;
	prCSIInfo->ucValue2[prCSICtrl->ucCfgItem] = prCSICtrl->ucValue2;

	if (prCSICtrl->ucCfgItem >= ARRAY_SIZE(prCSIInfo->ucValue1) || prCSICtrl->ucCfgItem >= ARRAY_SIZE(prCSIInfo->ucValue2)) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CSI, DBG_LVL_ERROR, "invalid index!\n");
		goto out;
	}
	HW_CSI_CTRL(pAd, (void *)prCSICtrl);		/*send fw cmd*/
out:
...
#ifdef CONFIG_6G_SUPPORT
BOOLEAN in_band_discovery_update_conf(struct wifi_dev *wdev,
		UCHAR type, UCHAR interval, UCHAR tx_mode, UCHAR by_cfg)
{
	...
	in_band_discovery_update_oper(wdev, type, interval, tx_mode);

	return TRUE;
}

BOOLEAN in_band_discovery_update_oper(struct wifi_dev *wdev,
		UCHAR type, UCHAR interval, UCHAR tx_mode)
{
	BOOLEAN is_mode_updated = (wlan_operate_get_unsolicit_tx_mode(wdev) != tx_mode) ? TRUE : FALSE;

	wlan_operate_set_unsolicit_tx_type(wdev, type);
	wlan_operate_set_unsolicit_tx_tu(wdev, interval);
	wlan_operate_set_unsolicit_tx_mode(wdev, tx_mode);

	MTWF_DBG(wdev->sys_handle, DBG_CAT_AP, CATAP_DISC, DBG_LVL_INFO,
					"[%02d] [wdev state] %d\n",
					wdev->wdev_idx, WDEV_BSS_STATE(wdev));

	if (WDEV_BSS_STATE(wdev) == BSS_READY) {
		/* sync to bss manager */
		/* TODO: notify bss manager and update RNR - UPR flag if needed */

		MTWF_DBG(wdev->sys_handle, DBG_CAT_AP, CATAP_DISC, DBG_LVL_INFO,
					"[%02d] iob type=%d, interval=%d, mode=%d%s\n",
					wdev->wdev_idx, type, interval, tx_mode,
					is_mode_updated ? "(updated)" : "");

		if (is_mode_updated) {
			/* sync bcn & discovery frames' TXD */
			UpdateBeaconHandler(wdev->sys_handle, wdev, BCN_REASON(BCN_UPDATE_ENABLE_TX));
		} else {
			/* rebuild frames for sync TxType change */
			ap_6g_build_discovery_frame(wdev->sys_handle, wdev);
			ap_6g_set_frame_offload(wdev->sys_handle, wdev);
		}
	}
...
BOOLEAN out_band_discovery_update(struct wifi_dev *wdev, UCHAR rnr_6g_in_probe)
{
	wlan_config_set_rnr_in_probe_rsp(wdev, rnr_6g_in_probe);

	if (WDEV_BSS_STATE(wdev) == BSS_READY) {
		/* sync to bss manager */
		bss_mngr_update_oob_6g_disc(wdev, wlan_config_get_rnr_in_probe_rsp(wdev));
	}
	...
	IN	RTMP_STRING		*arg)
{
	...
	if (arg) {
		...
		if (i4Recv == 3 && type <= UNSOLICIT_TX_FILS_DISC) {
			...
			fgStatus = in_band_discovery_update_conf(wdev, type, interval, txmode, TRUE);
		}
	}
	...
	IN	RTMP_STRING		*arg)
{
	...
	if (arg) {
		i4Recv = sscanf(arg, "%d", &(rnr_6g_in_probe));
		if (i4Recv == 1) {
			MTWF_PRINT("RNR=(%d)\n", rnr_6g_in_probe);
			fgStatus = out_band_discovery_update(wdev, rnr_6g_in_probe);
		}
	}

	if (fgStatus == FALSE) {
		MTWF_PRINT("iwpriv ra0 set 6goob=[RNR6G]\n");
		MTWF_PRINT("[RNR6G] 0:Off, 1:All 6G BSSs\n");
	}
	...
	RTMP_STRING *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_INFO, "enter\n");
	...
	RTMP_STRING *arg)
{
	...
	if ((cur_gi > FIXED_GI_32_US) || (cur_gi >= ARRAY_SIZE(gi_ltf_info))) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR,
			"Error!!!(cur_gi(%d) is invalid!\n", cur_gi);
		return -EFAULT;
	}
...
INT show_bss_mngr_info(PRTMP_ADAPTER pAd, char *arg)
{
	...
	MTWF_DBG(pAd, DBG_CAT_MLO, CATMLO_BMGR, DBG_LVL_ERROR, "type=%d\n", type);

	bss_mngr_show_info(type);
...
INT Set_Unregister_Mbss(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (apIndex != 0) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"need to be called by main device ra0 rai0 rax0\n");
		return 0;
	}
	if (hwifi_get_inf_num(pAd) > 0) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"not all interface down\n");
		return 0;
	}
	...
	for (IdBss = FIRST_MBSSID; IdBss < MaxNumBss; IdBss++) {
		mwdev = &pAd->ApCfg.MBSSID[IdBss].wdev;
		pMbss = &pAd->ApCfg.MBSSID[IdBss];

		if (pMbss)
			bcn_buf_deinit(pAd, mwdev);

		if (mwdev->if_dev) {
			RtmpOSNetDevDetach(mwdev->if_dev);
			wdev_deinit(pAd, mwdev);
#ifdef RT_CFG80211_SUPPORT
			os_free_mem(mwdev->if_dev->ieee80211_ptr);
			mwdev->if_dev->ieee80211_ptr = NULL;
#endif /* RT_CFG80211_SUPPORT */
		}
	}
	pAd->FlgMbssunregister = TRUE;
...
INT Set_Free_Mbss(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (pAd->FlgMbssunregister != TRUE) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"need to be call unregistermbss first\n");
		return 0;
	}
	...
	for (IdBss = FIRST_MBSSID; IdBss < MaxNumBss; IdBss++) {
		mwdev = &pAd->ApCfg.MBSSID[IdBss].wdev;
#ifndef RT_CFG80211_SUPPORT
		RtmpOSNetDevFree(mwdev->if_dev);
#endif /* !RT_CFG80211_SUPPORT */
		mwdev->if_dev = NULL;
	}

	pAd->FlgMbssInit = FALSE;
	pAd->FlgMbssunregister = FALSE;

	return 0;
}

#ifdef CONFIG_6G_SUPPORT
/* low power indoor indicate to fw */
INT Set_Lpi_en(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (value <= 1) {
		if (wdev && WMODE_CAP_6G(wdev->PhyMode))
			TxPowerLimitTypeInit(pAd, value);
		else
			MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_WARN,
				"wdev is not 6G cap\n");
	} else {
		MTWF_DBG(pAd, DBG_CAT_AP, CATCFG_DBGLOG, DBG_LVL_WARN,
		"wrong config value:%d, current:%d\n", value, pAd->CommonCfg.LpiEn);
	}
...
/* set the max probe cnt per second */
...
#ifdef CONFIG_FAST_NAT_SUPPORT
INT set_force_swpath(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	UINT16 wcid = 0, mode = 0;
	RTMP_STRING *pWcidDest = NULL;
	MAC_TABLE_ENTRY	*pEntry = NULL;
	...
	if (!VALID_UCAST_ENTRY_WCID(pAd, wcid) || (wcid >= WTBL_MAX_NUM(pAd))) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_DBGLOG, DBG_LVL_ERROR, "Wcid not found\n");
		return FALSE;
	}

	pEntry = entry_get(pAd, wcid);
	if (pEntry->Sst == SST_ASSOC) {
		if (mode <= FORCE_SW_PATH_ALL) {
			pEntry->ForceSwPath = mode;
			ppe_del_entry_by_mac(pEntry->Addr);
		} else
			pEntry->ForceSwPath = FORCE_SW_PATH_NONE;

		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"%02X:%02X:%02X:%02X:%02X:%02X (SW PATH %d)\n",
			PRINT_MAC(pEntry->Addr), pEntry->ForceSwPath);
	}
	return TRUE;
}

INT set_whnat_en_proc(
	...
	RTMP_STRING *arg)
{
	...
	ucEnable = os_str_toul(arg, 0, 10);
	PD_SET_WHNAT_ENABLE(pAd->physical_dev, ucEnable);
...
enum rro_bypass_type {
	...
	if (mac_cap_info == NULL) {
		MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_ERROR,
			"mac_cap_info is NULL\n");
		return FALSE;
	}
	...
	if (ucEnable)
		mac_cap_info->rro_bypass_type = ALL_BYPASS;
	else
		mac_cap_info->rro_bypass_type = ALL_NOT_BYPASS;

	ret = uni_cmd_rro_bypass_mode(pAd, mac_cap_info->rro_bypass_type);
	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"ret=0x%x, rro_bypass_type = %d\n", ret, mac_cap_info->rro_bypass_type);

	return TRUE;
}

#ifdef SW_CONNECT_SUPPORT
INT set_sw_fr_tbl_idx_bw(
	IN	PRTMP_ADAPTER	pAd,
	IN	RTMP_STRING *arg)
{
	BOOLEAN fgStatus = TRUE;
	INT32 i4Recv = 0;
	UINT32 u4FrIdx = FR_OFDM_6M, u4Bw = BW_20;

	if (arg) {
		do {
			i4Recv = sscanf(arg, "%d-%d", &(u4FrIdx), &(u4Bw));
			MTWF_DBG(pAd, DBG_CAT_RA, CATRA_CFG, DBG_LVL_NOTICE,
				"fr_tbl_idx = %d, bw=%d, bFixedRateSet=%d\n", u4FrIdx, u4Bw, pAd->dummy_obj.bFixedRateSet);

			if (i4Recv != 2) {
				MTWF_DBG(pAd, DBG_CAT_RA, CATRA_CFG, DBG_LVL_ERROR,
					"Format Error!\n");
				fgStatus = FALSE;
				break;
			}

			pAd->dummy_obj.fr_tbl_idx = (UINT8)u4FrIdx;
			pAd->dummy_obj.fr_bw = (UINT8)u4Bw;
...
INT set_dfs_slave_en_proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	pAd->slave_ctrl.enable = value > 0 ? TRUE : FALSE;

	slave_bcn_ctrl(pAd, value);
...
INT set_slave_sta_disc_skip_proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	pAd->slave_ctrl.disconnect_sta = value > 0 ? FALSE : TRUE;
...
INT show_slave_info_proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (SLAVE_MODE_EN(pAd)) {
		MTWF_DBG(NULL, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_ERROR,
			"*Enabled* disable_beacon[%d] disconnect_sta[%d]\n",
			pAd->slave_ctrl.disable_beacon,
			pAd->slave_ctrl.disconnect_sta);

		for (bss_idx = 0; bss_idx < pAd->ApCfg.BssidNum; bss_idx++) {
			wdev = &pAd->ApCfg.MBSSID[bss_idx].wdev;
			MTWF_DBG(NULL, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_ERROR,
				"AP[%02x:%02x:%02x:%02x:%02x:%02x] wdev_idx:%d AllowBeacon:%d\n",
				PRINT_MAC(wdev->if_addr), wdev->wdev_idx, wdev->bAllowBeaconing);
		}
	} else {
		MTWF_DBG(NULL, DBG_CAT_CHN, CATCHN_DFS, DBG_LVL_ERROR, "*Disabled*\n");
	}
	...
	RTMP_STRING *arg)
{
	...
	ucEnable = os_str_toul(arg, 0, 10);
	PD_SET_ASSOC_RECORD_EN(pAd->physical_dev, ucEnable);

	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"assoc_record_en = %d\n", PD_GET_ASSOC_RECORD_EN(pAd->physical_dev));

	return TRUE;
}

INT Set_StationKeepAlive(
	struct _RTMP_ADAPTER *pAd,
	RTMP_STRING *arg)
{
	UINT16 value = 0;
	...
	value = os_str_toul(arg, 0, 10);
	pAd->ApCfg.MBSSID[apidx].StationKeepAliveTime = value;

	MTWF_DBG(pAd, DBG_CAT_CFG, CATCFG_CMD, DBG_LVL_NOTICE,
			"StationKeepAliveTime = %u\n", value);

	return TRUE;
}

INT Show_StationKeepAlive(
	struct _RTMP_ADAPTER *pAd,
	RTMP_STRING *arg)
{
	POS_COOKIE pObj = (POS_COOKIE) pAd->OS_Cookie;
	...
	MTWF_PRINT("StationKeepAliveTime = %u!\n\n",
