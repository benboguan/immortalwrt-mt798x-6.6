...
get_dat_file() {
    band="$1"
    dat_path="/etc/wireless/mediatek/mt7992.1.dat"
    
    if [ "$band" = "2g" ]; then
        dat_file=`cat "$dat_path" | grep "BN0" | awk -F'=' '{print \$2}'`
    else
        dat_file=`cat "$dat_path" | grep "BN1" | awk -F'=' '{print \$2}'`
    fi
    echo "$dat_file"
}
...
set_dat_params() {
    ...
    if grep -q "^${param}=${value}" "$dat_file"; then
        return 0
    else
        return 1
    fi
...
set_dat_htmode() {
    ...
    case "$band" in
        "2g")
            configure_2g_htmode "$htmode" "$dat_file"
            ;;
        "5g")
            configure_5g_htmode "$htmode" "$dat_file"
            ;;
        *)
            return 1
            ;;
...
configure_2g_htmode() {
    ...
    case "$htmode" in
        "HT20")
            configure_2g_base "$dat_file" "0;0" "0;0" "9;9" "9;9"
            ;;
        "HT40")
            configure_2g_base "$dat_file" "1;1" "0;0" "9;9" "9;9"
            ;;
        "HE20")
            configure_2g_base "$dat_file" "0;0" "0;0" "16;16" "16;16"
            ;;
        "HE40")
            configure_2g_base "$dat_file" "1;1" "0;0" "16;16" "16;16"
            ;;
        "EHT20")
            configure_2g_base "$dat_file" "0;0" "0;0" "22;22" "22;22"
            ;;
        "EHT40")
            configure_2g_base "$dat_file" "1;1" "0;0" "22;22" "22;22"
            ;;
        *)
            return 1
            ;;
...
configure_2g_base() {
    ...
    set_dat_params "HT_BW" "$ht_bw" "$dat_file"
    set_dat_params "VHT_BW" "$vht_bw" "$dat_file"
    set_dat_params "EHT_ApBw" "$eht_apbw" "$dat_file"
    set_dat_params "WirelessMode" "$wireless_mode" "$dat_file"
}
...
configure_5g_htmode() {
    ...
    case "$htmode" in
        "HT20")
            configure_5g_base "$dat_file" "0" "0" "0" "8"
            ;;
        "HT40")
            configure_5g_base "$dat_file" "1" "0" "1" "8"
            ;;
        "VHT20")
            configure_5g_base "$dat_file" "0" "0" "0" "14"
            ;;
        "VHT40")
            configure_5g_base "$dat_file" "1" "0" "1" "14"
            ;;
        "VHT80")
            configure_5g_base "$dat_file" "1" "1" "2" "14"
            ;;
        "VHT80_80")
            configure_5g_base "$dat_file" "" "" "" "14"
            ;;
        "VHT160")
            configure_5g_base "$dat_file" "1" "2" "3" "14"
            ;;
        "HE20")
            configure_5g_base "$dat_file" "0" "0" "0" "17"
            ;;
        "HE40")
            configure_5g_base "$dat_file" "1" "0" "1" "17"
            ;;
        "HE80")
            configure_5g_base "$dat_file" "1" "1" "2" "17"
            ;;
        "HE160")
            configure_5g_base "$dat_file" "1" "2" "3" "17"
            ;;
        "HE320")
            configure_5g_base "$dat_file" "" "" "" "17"
            ;;
        "EHT20")
            configure_5g_base "$dat_file" "0" "0" "0" "23"
            ;;
        "EHT40")
            configure_5g_base "$dat_file" "1" "0" "1" "23"
            ;;
        "EHT80")
            configure_5g_base "$dat_file" "1" "1" "2" "23"
            ;;
        "EHT160")
            configure_5g_base "$dat_file" "1" "2" "3" "23"
            ;;
        "EHT320")
            configure_5g_base "$dat_file" "" "" "" "23"
            ;;
        *)
            return 1
            ;;
